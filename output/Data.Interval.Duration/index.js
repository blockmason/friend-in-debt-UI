...
var showDurationComponent = new Data_Show.Show(function (v) {
    ...
    throw new Error("Failed pattern match at Data.Interval.Duration line 40, column 3 - line 41, column 3: " + [ v.constructor.name ]);
});
...
var ordDurationComponent = new Data_Ord.Ord(function () {
    ...
    return function (y) {
        ...
        throw new Error("Failed pattern match at Data.Interval.Duration line 37, column 1 - line 37, column 62: " + [ x.constructor.name, y.constructor.name ]);
    };
});
