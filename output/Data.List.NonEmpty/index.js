...
var updateAt = function (i) {
    return function (a) {
        return function (v) {
            ...
            throw new Error("Failed pattern match at Data.List.NonEmpty line 188, column 1 - line 190, column 70: " + [ i.constructor.name, a.constructor.name, v.constructor.name ]);
        };
    };
};
...
var modifyAt = function (i) {
    return function (f) {
        return function (v) {
            ...
            throw new Error("Failed pattern match at Data.List.NonEmpty line 193, column 1 - line 195, column 70: " + [ i.constructor.name, f.constructor.name, v.constructor.name ]);
        };
    };
};
...
var insertAt = function (i) {
    return function (a) {
        return function (v) {
            ...
            throw new Error("Failed pattern match at Data.List.NonEmpty line 183, column 1 - line 185, column 70: " + [ i.constructor.name, a.constructor.name, v.constructor.name ]);
        };
    };
};
var init = function (v) {
...
var index = function (v) {
    return function (i) {
        ...
        throw new Error("Failed pattern match at Data.List.NonEmpty line 157, column 1 - line 159, column 35: " + [ v.constructor.name, i.constructor.name ]);
    };
};
var head = function (v) {
    return v.value0;
...
var fromList = function (v) {
    ...
    throw new Error("Failed pattern match at Data.List.NonEmpty line 118, column 1 - line 118, column 25: " + [ v.constructor.name ]);
};
...
var findIndex = function (f) {
    return function (v) {
        ...
        throw new Error("Failed pattern match at Data.List.NonEmpty line 170, column 1 - line 172, column 45: " + [ f.constructor.name, v.constructor.name ]);
    };
};
