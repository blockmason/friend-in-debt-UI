...
var showParity = new Data_Show.Show(function (v) {
    ...
    throw new Error("Failed pattern match at Data.Int line 89, column 3 - line 90, column 3: " + [ v.constructor.name ]);
});
var radix = function (n) {
    ...
    throw new Error("Failed pattern match at Data.Int line 149, column 1 - line 150, column 38: " + [ n.constructor.name ]);
};
var odd = function (x) {
    return (x & 1) !== 0;
};
...
var ordParity = new Data_Ord.Ord(function () {
    ...
    return function (y) {
        ...
        throw new Error("Failed pattern match at Data.Int line 86, column 1 - line 86, column 40: " + [ x.constructor.name, y.constructor.name ]);
    };
});
var decimal = 10;
