        ...
        return function (ys) {
            var go = function (v) {
                return function (v1) {
                    ...
                    throw new Error("Failed pattern match at Data.List.Lazy line 692, column 3 - line 692, column 17: " + [ v.constructor.name, v1.constructor.name ]);
                };
            };
...
var take = function (n) {
    var go = function (v) {
        return function (v1) {
            ...
            throw new Error("Failed pattern match at Data.List.Lazy line 515, column 3 - line 515, column 24: " + [ v.constructor.name, v1.constructor.name ]);
        };
    };
    return function ($245) {
...
var replicateM = function (dictMonad) {
    return function (n) {
        return function (m) {
            ...
            throw new Error("Failed pattern match at Data.List.Lazy line 161, column 1 - line 166, column 23: " + [ n.constructor.name, m.constructor.name ]);
        };
    };
};
...
var range = function (start) {
    return function (end) {
        ...
        throw new Error("Failed pattern match at Data.List.Lazy line 145, column 1 - line 153, column 30: " + [ start.constructor.name, end.constructor.name ]);
    };
};
...
var mapMaybe = function (f) {
    var go = function ($copy_v) {
        ...
        function $tco_loop(v) {
            ...
            throw new Error("Failed pattern match at Data.List.Lazy line 455, column 14 - line 461, column 39: " + [ v.constructor.name ]);
        };
        while (!$tco_done) {
    ...
    var go = function ($copy_v) {
        return function ($copy_v1) {
            ...
            function $tco_loop(v, v1) {
                ...
                throw new Error("Failed pattern match at Data.List.Lazy line 296, column 12 - line 300, column 42: " + [ v.constructor.name, v1.constructor.name ]);
            };
            while (!$tco_done) {
...
var filter = function (p) {
    var go = function ($copy_v) {
        ...
        function $tco_loop(v) {
            ...
            throw new Error("Failed pattern match at Data.List.Lazy line 425, column 12 - line 430, column 31: " + [ v.constructor.name ]);
        };
        while (!$tco_done) {
            $tco_result = $tco_loop($copy_v);
        };
    ...
    var go = function ($copy_v) {
        return function ($copy_v1) {
            ...
            function $tco_loop(v, v1) {
                ...
                throw new Error("Failed pattern match at Data.List.Lazy line 532, column 10 - line 536, column 44: " + [ v.constructor.name, v1.constructor.name ]);
            };
            while (!$tco_done) {
                $tco_result = $tco_loop($tco_var_v, $copy_v1);
            };
