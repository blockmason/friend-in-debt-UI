...
var showInterval = function (dictShow) {
    return function (dictShow1) {
        return new Data_Show.Show(function (v) {
            ...
            throw new Error("Failed pattern match at Data.Interval line 67, column 3 - line 68, column 3: " + [ v.constructor.name ]);
        });
    };
};
...
var bifunctorInterval = new Data_Bifunctor.Bifunctor(function (v) {
    return function (v1) {
        return function (v2) {
            ...
            throw new Error("Failed pattern match at Data.Interval line 76, column 3 - line 76, column 50: " + [ v.constructor.name, v1.constructor.name, v2.constructor.name ]);
        };
    };
});
...
var extendInterval = new Control_Extend.Extend(function () {
    ...
    return function (v) {
        ...
        throw new Error("Failed pattern match at Data.Interval line 112, column 3 - line 112, column 51: " + [ f.constructor.name, v.constructor.name ]);
    };
});
...
var traversableInterval = new Data_Traversable.Traversable(function () {
    ...
    return function (v) {
        return function (v1) {
            ...
            throw new Error("Failed pattern match at Data.Interval line 98, column 3 - line 98, column 56: " + [ v.constructor.name, v1.constructor.name ]);
        };
    };
});
    ...
    return function (v1) {
        return function (z) {
            return function (v2) {
                ...
                throw new Error("Failed pattern match at Data.Interval line 90, column 3 - line 90, column 49: " + [ v.constructor.name, v1.constructor.name, z.constructor.name, v2.constructor.name ]);
            };
        };
    };
}, function (x) {
    ...
    return function (v) {
        return function (v1) {
            return function (v2) {
                ...
                throw new Error("Failed pattern match at Data.Interval line 105, column 3 - line 105, column 59: " + [ v.constructor.name, v1.constructor.name, v2.constructor.name ]);
            };
        };
    };
});
