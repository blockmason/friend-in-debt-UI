...
var size = function (v) {
    ...
    throw new Error("Failed pattern match at Data.Map line 581, column 1 - line 582, column 1: " + [ v.constructor.name ]);
};
    ...
    return function (m) {
        var go = function ($copy_v) {
            ...
            function $tco_loop(v) {
                ...
                throw new Error("Failed pattern match at Data.Map line 533, column 21 - line 544, column 71: " + [ v.constructor.name ]);
            };
            while (!$tco_done) {
...
var showTree = function (dictShow) {
    return function (dictShow1) {
        return function (v) {
            ...
            throw new Error("Failed pattern match at Data.Map line 116, column 1 - line 117, column 1: " + [ v.constructor.name ]);
        };
    };
};
...
var mapWithKey = function (v) {
    return function (v1) {
        ...
        throw new Error("Failed pattern match at Data.Map line 587, column 1 - line 587, column 25: " + [ v.constructor.name, v1.constructor.name ]);
    };
};
var lookupLE = function (dictOrd) {
    return function (k) {
        ...
        var go = function (v) {
            ...
            throw new Error("Failed pattern match at Data.Map line 181, column 14 - line 194, column 36: " + [ v.constructor.name ]);
        };
        return go;
    };
};
var lookupGE = function (dictOrd) {
    return function (k) {
        ...
        var go = function (v) {
            ...
            throw new Error("Failed pattern match at Data.Map line 215, column 14 - line 228, column 37: " + [ v.constructor.name ]);
        };
        return go;
    };
};
...
var traversableMap = new Data_Traversable.Traversable(function () {
    ...
    return function (f) {
        return function (v) {
            ...
            throw new Error("Failed pattern match at Data.Map line 98, column 3 - line 98, column 30: " + [ f.constructor.name, v.constructor.name ]);
        };
    };
});
...
var findMin = function (v) {
    ...
    throw new Error("Failed pattern match at Data.Map line 255, column 1 - line 255, column 23: " + [ v.constructor.name ]);
};
var lookupGT = function (dictOrd) {
    return function (k) {
        ...
        var go = function (v) {
            ...
            throw new Error("Failed pattern match at Data.Map line 232, column 14 - line 245, column 37: " + [ v.constructor.name ]);
        };
        return go;
    };
};
var findMax = function (v) {
    ...
    throw new Error("Failed pattern match at Data.Map line 249, column 1 - line 249, column 23: " + [ v.constructor.name ]);
};
var lookupLT = function (dictOrd) {
    return function (k) {
        ...
        var go = function (v) {
            ...
            throw new Error("Failed pattern match at Data.Map line 198, column 14 - line 211, column 36: " + [ v.constructor.name ]);
        };
        return go;
    };
};
...
var checkValid = function (tree) {
    var allHeights = function (v) {
        ...
        throw new Error("Failed pattern match at Data.Map line 151, column 3 - line 151, column 30: " + [ v.constructor.name ]);
    };
