...
var withKeys_ = function (ctor) {
    return function (children) {
        ...
        if (v instanceof Halogen_VDom_Types.Elem) {
            return new Halogen_VDom_Types.Keyed(v.value0, Unsafe_Coerce.unsafeCoerce(children));
        };
        return v;
    };
};
...
var keyedNS = function ($8) {
    return Unsafe_Coerce.unsafeCoerce(Halogen_HTML_Core.keyed(Control_Applicative.pure(Data_Maybe.applicativeMaybe)($8)));
};
var keyed = Unsafe_Coerce.unsafeCoerce(Halogen_HTML_Core.keyed(Data_Maybe.Nothing.value));
var elementNS = function ($9) {
    return Unsafe_Coerce.unsafeCoerce(Halogen_HTML_Core.element(Control_Applicative.pure(Data_Maybe.applicativeMaybe)($9)));
};
