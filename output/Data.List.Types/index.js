...
var extendList = new Control_Extend.Extend(function () {
    ...
    return function (v) {
        ...
        throw new Error("Failed pattern match at Data.List.Types line 120, column 3 - line 120, column 21: " + [ f.constructor.name, v.constructor.name ]);
    };
});
            ...
            var go = function ($copy_v) {
                return function ($copy_v1) {
                    ...
                    function $tco_loop(v, v1) {
                        ...
                        throw new Error("Failed pattern match at Data.List.Types line 51, column 20 - line 59, column 23: " + [ v.constructor.name, v1.constructor.name ]);
                    };
                    while (!$tco_done) {
