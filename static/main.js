...
(function(exports) {
  ...
  var showMoney = new Data_Show.Show(function (v) {
      return (function () {
          var $37 = v.amount < Data_Int.toNumber(0);
          if ($37) {
              return "-";
          };
          return "";
      ...
      return function (rb) {
          var debtorCreditor = function (myId) {
              return function (cpId) {
                  return function (val) {
                      var $56 = val >= Data_Int.toNumber(0);
                      if ($56) {
          ...
          return {
              amount: mkMoney($$Math.abs(rb.amount))(rb.currency), 
              debtor: v.value0, 
              creditor: v.value1
          };
      };
...
(function(exports) {
  ...
  var idSpan = function (me) {
      return function (idToDisplay) {
          ...
          throw new Error("Failed pattern match at Debts line 327, column 6 - line 329, column 125: " + [ isItMe.constructor.name ]);
      };
  };
                      ...
                      return function (fidAffCall) {
                          ...
                          if (errorBus instanceof Data_Maybe.Just) {
                              return Control_Bind.bind(dictBind)(Control_Monad_Aff_Class.liftAff(dictMonadAff)(Network_Eth_FriendInDebt.runMonadF(fidAffCall)))(function (v) {
                                  ...
                                  throw new Error("Failed pattern match at Debts line 432, column 7 - line 435, column 30: " + [ v.constructor.name ]);
                              });
                          };
                          throw new Error("Failed pattern match at Debts line 426, column 3 - line 435, column 30: " + [ errorBus.constructor.name ]);
                      };
                  };
              };
          };
  ...
  var addFriendWidget = function (state) {
      ...
      })) ]), Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(AddFriend.create(state.newFriend))), Halogen_HTML_Properties.class_("col-2") ])([ Halogen_HTML_Core.text("Add Friend by Address") ]) ]);
  };
  var component = (function () {
      ...
      var $$eval = function (v) {
          ...
          throw new Error("Failed pattern match at Debts line 146, column 10 - line 206, column 16: " + [ v.constructor.name ]);
      };
      ...
      var $$eval = function (v) {
          ...
          if (v instanceof ShowPreviousScreen) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                  ...
                  $75.currentScreen = state.previousScreen;
                  return $75;
              }))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
              });
