...
(function(exports) {
  ...
  var createFriendship = function (v) {
      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Aff.monadAff))(checkAndInit)(function () {
          return Control_Monad_Eff_Class.liftEff(Control_Monad_Except_Trans.monadEffExceptT(Control_Monad_Aff.monadEffAff))($foreign.createFriendshipImpl(v));
      });
  };
...
(function(exports) {
  ...
  var moneySpan = function (v) {
      ...
      var compRes = (function () {
          ...
          throw new Error("Failed pattern match at Debts line 254, column 17 - line 258, column 5: " + [ debtCompare.constructor.name ]);
      })();
  ...
  var moneyClass = function (fd) {
      ...
      throw new Error("Failed pattern match at Debts line 262, column 17 - line 267, column 1: " + [ v.constructor.name ]);
  };
                      ...
                      return function (fidAffCall) {
                          ...
                          if (errorBus instanceof Data_Maybe.Just) {
                              return Control_Bind.bind(dictBind)(Control_Monad_Aff_Class.liftAff(dictMonadAff)(Network_Eth_FriendInDebt.runMonadF(fidAffCall)))(function (v) {
                                  ...
                                  throw new Error("Failed pattern match at Debts line 354, column 7 - line 357, column 27: " + [ v.constructor.name ]);
                              });
                          };
                          throw new Error("Failed pattern match at Debts line 348, column 3 - line 357, column 27: " + [ errorBus.constructor.name ]);
                      };
                  };
              };
          };
  ...
  var displayDebt = function (nm) {
      return function (v) {
          ...
          throw new Error("Failed pattern match at Debts line 237, column 6 - line 240, column 126: " + [ compRes.constructor.name ]);
      };
  };
  ...
  var displayAllDebt = function (nm) {
      return function (v) {
          ...
          throw new Error("Failed pattern match at Debts line 224, column 6 - line 229, column 108: " + [ compRes.constructor.name ]);
      };
  };
  ...
  var addFriendWidget = function (state) {
      var inputVal = Data_Either.either(Control_Category.id(Control_Category.categoryFn))(Network_Eth_FriendInDebt_Types.getUa);
      ...
      var $$eval = function (v) {
          ...
          if (v instanceof InputFriend) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                  var $105 = Data_String.length(v.value0) === 42;
                  if ($105) {
                          ...
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(Control_Monad_Aff.delay(Data_Int.toNumber(1500))))(function () {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                                  ...
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(refreshMetamask)(function () {
                                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(Network_Eth_FriendInDebt.runMonadF(Network_Eth_FriendInDebt.confirmedFriends)))(FriendInDebt_Prelude.hLog(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Data_Either.showEither(Network_Eth_FriendInDebt_Types.showError)(Data_Show.showArray(Network_Eth_Foundation.showFoundationId)))))(function () {
