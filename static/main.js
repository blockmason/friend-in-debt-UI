...
(function(exports) {
  ...
  exports["formatDollar"] = $foreign.formatDollar;
})(PS["Data.Format.Money"] = PS["Data.Format.Money"] || {});
(function(exports) {
...
(function(exports) {
  ...
  exports["setDebtAmount"] = setDebtAmount;
...
(function(exports) {
  ...
  var verboseMoneySpan = function (v) {
      return Halogen_HTML_Elements.span([  ])([ Halogen_HTML_Core.text(Data_Show.show(Network_Eth_FriendInDebt_Types.showCurrency)(v.currency) + (" " + Data_Show.show(Data_Show.showNumber)(v.amount))) ]);
  };
  ...
  var mockDebt = function (fid) {
      return Network_Eth_FriendInDebt_Types.mkDebt(mockFoundationId)(fid)(fid)(Network_Eth_FriendInDebt_Types.mkMoney(2.0)(Network_Eth_FriendInDebt_Types.cUSD))(Network_Eth_FriendInDebt_Types.NoDebtId.value)("Fictional Cat Poop");
  };
                  ...
                  return function (maybeDebt) {
                      var counterparty = function (debt) {
                          return function (debtType1) {
                              return function (v) {
                                  ...
                                  throw new Error("Failed pattern match at Debts line 495, column 44 - line 497, column 59: " + [ debtType1.constructor.name ]);
                              };
                          };
                      };
                      var amount = function (debt) {
                          return function (v) {
                              return Network_Eth_FriendInDebt_Types.setDebtAmount(debt)(Data_Maybe.fromMaybe(0.0)(Data_Number.fromString(v)));
                          };
                      };
                      ...
                      if (v instanceof Data_Maybe.Just) {
                          var handler = (function () {
                              ...
                              throw new Error("Failed pattern match at Debts line 469, column 21 - line 470, column 58: " + [ debtType.constructor.name ]);
                          })();
                          var d = (function () {
                              if (debtType instanceof Debt) {
                              ...
                              throw new Error("Failed pattern match at Debts line 466, column 15 - line 468, column 81: " + [ debtType.constructor.name ]);
                          })();
                          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("createDebt col row") ])([ Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputNumber.value), Halogen_HTML_Properties.class_("debt-amount col-2"), Halogen_HTML_Properties.value(Data_Show.show(Data_Show.showNumber)(Network_Eth_FriendInDebt_Types.numAmount(Network_Eth_FriendInDebt_Types.debtMoney(d)))), Halogen_HTML_Events.onValueInput(Halogen_HTML_Events.input(function (val) {
                              return handler(amount(d)(val));
                      ...
                      throw new Error("Failed pattern match at Debts line 463, column 3 - line 493, column 11: " + [ v.constructor.name ]);
                  };
              };
          };
      };
  ...
  var idSpan = function (me) {
      return function (idToDisplay) {
          ...
          throw new Error("Failed pattern match at Debts line 382, column 6 - line 384, column 125: " + [ isItMe.constructor.name ]);
      };
  };
                      ...
                      return function (fidAffCall) {
                          ...
                          if (errorBus instanceof Data_Maybe.Just) {
                              return Control_Bind.bind(dictBind)(Control_Monad_Aff_Class.liftAff(dictMonadAff)(Network_Eth_FriendInDebt.runMonadF(fidAffCall)))(function (v) {
                                  ...
                                  throw new Error("Failed pattern match at Debts line 515, column 7 - line 518, column 30: " + [ v.constructor.name ]);
                              });
                          };
                          throw new Error("Failed pattern match at Debts line 509, column 3 - line 518, column 30: " + [ errorBus.constructor.name ]);
                      };
                  };
              };
          };
                                      ...
                                      return Control_Bind.bind(dictBind)(handleFIDCall(dictBind)(dictMonadEff)(dictMonadAff)(errorBus)(Network_Eth_FriendInDebt_Types.blankPendingDebts)(Network_Eth_FriendInDebt.pendingDebts))(function (v3) {
                                          return Control_Bind.bind(dictBind)(handleFIDCall(dictBind)(dictMonadEff)(dictMonadAff)(errorBus)([  ])(Network_Eth_FriendInDebt.debtBalances))(function (v4) {
                                              return Control_Monad_State_Class.modify(dictMonadState)(function (v5) {
                                                  var $65 = {};
                                                  for (var $66 in v5) {
                                                      if ({}.hasOwnProperty.call(v5, $66)) {
                                                          $65[$66] = v5[$66];
                                                      };
                                                  };
                                                  $65.myId = v;
                                                  $65.friends = v1;
                                                  $65.pendingFriendsSent = Network_Eth_FriendInDebt_Types.pfGetSents(v2);
                                                  $65.pendingFriendsTodo = Network_Eth_FriendInDebt_Types.pfGetTodos(v2);
                                                  $65.pendingSent = Network_Eth_FriendInDebt_Types.pdGetSents(v3);
                                                  $65.pendingTodo = Network_Eth_FriendInDebt_Types.pdGetTodos(v3);
                                                  $65.balances = v4;
                                                  $65.loading = false;
                                                  $65.names = Data_Map.empty;
                                                  return $65;
                                              });
                                          });
                                      });
  ...
  var component = (function () {
      ...
      var $$eval = function (v) {
          ...
          throw new Error("Failed pattern match at Debts line 159, column 10 - line 212, column 16: " + [ v.constructor.name ]);
      };
