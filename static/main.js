...
(function(exports) {
  ...
  var showMoney = new Data_Show.Show(function (v) {
      return (function () {
          var $29 = v.amount < Data_Int.toNumber(0);
          if ($29) {
              return "-";
          };
          return "";
  ...
  var strCurrency = function (v) {
      return Data_Show.show(showCurrency)(v.currency);
  };
  ...
  var posNegZero = function (v) {
      ...
      throw new Error("Failed pattern match at Network.Eth.FriendInDebt.Types line 117, column 1 - line 119, column 57: " + [ v.constructor.name ]);
  };
  ...
  var rawToBalance = function (fi) {
      return function (rb) {
          var debtorCreditor = function (fi1) {
              return function (cpId) {
                  return function (val) {
                      var $42 = val >= Data_Int.toNumber(0);
                      if ($42) {
                          return new Data_Tuple.Tuple(fi1, cpId);
                      };
                      return new Data_Tuple.Tuple(cpId, fi1);
                  };
              };
          };
  ...
  var addDebt = function (fd) {
      return function (money) {
          return setDebt(fd)(numAmount(getDebt(fd)) + numAmount(money))(strCurrency(money));
      };
  };
  exports["USD"] = USD;
  exports["EUR"] = EUR;
  ...
  exports["strCurrency"] = strCurrency;
...
(function(exports) {
  ...
  var pendingFriends = function (comparisonFn) {
      var g = function (myId) {
          return function (pending) {
              var $46 = comparisonFn(pending.confirmerId)(myId);
              if ($46) {
...
(function(exports) {
  ...
  var nonZero = function (fd) {
      return Network_Eth_FriendInDebt_Types.numAmount(Network_Eth_FriendInDebt_Types.getDebt(fd)) !== Data_Int.toNumber(0);
  };
  var nameChangeWidget = function (inputName) {
      return function (userName) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("nameChange") ])([ Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputText.value), Halogen_HTML_Properties.value(inputName), Halogen_HTML_Events.onValueInput(Halogen_HTML_Events.input(function (val) {
              ...
              var $39 = Data_String.length(inputName) > 0;
              if ($39) {
                  return " to " + inputName;
              };
              return "";
  ...
  var moneySpan = function (v) {
      ...
      var compRes = (function () {
          ...
          throw new Error("Failed pattern match at Debts line 258, column 17 - line 262, column 5: " + [ debtCompare.constructor.name ]);
      })();
      return Halogen_HTML_Elements.span([ Halogen_HTML_Properties.class_(Halogen_HTML_Core.ClassName(compRes)) ])([ Halogen_HTML_Core.text(Data_Show.show(Network_Eth_FriendInDebt_Types.showMoney)(v.debt)) ]);
  };
  var moneyClass = function (fd) {
      ...
      throw new Error("Failed pattern match at Debts line 266, column 17 - line 271, column 1: " + [ v.constructor.name ]);
  };
                      ...
                      return function (fidAffCall) {
                          ...
                          if (errorBus instanceof Data_Maybe.Just) {
                              return Control_Bind.bind(dictBind)(Control_Monad_Aff_Class.liftAff(dictMonadAff)(Network_Eth_FriendInDebt.runMonadF(fidAffCall)))(function (v) {
                                  ...
                                  throw new Error("Failed pattern match at Debts line 353, column 7 - line 356, column 27: " + [ v.constructor.name ]);
                              });
                          };
                          throw new Error("Failed pattern match at Debts line 347, column 3 - line 356, column 27: " + [ errorBus.constructor.name ]);
                      };
                  };
              };
          };
  ...
  var displayDebt = function (nm) {
      return function (v) {
          ...
          throw new Error("Failed pattern match at Debts line 241, column 6 - line 244, column 126: " + [ compRes.constructor.name ]);
      };
  };
  ...
  var displayAllDebt = function (nm) {
      return function (v) {
          ...
          throw new Error("Failed pattern match at Debts line 228, column 6 - line 233, column 108: " + [ compRes.constructor.name ]);
      };
  };
  ...
  var component = (function () {
      ...
      var $$eval = function (v) {
          ...
          if (v instanceof CreateDebt) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                      ...
                      $123.creating = Data_Map.insert(Network_Eth_FriendInDebt_Types.ordEthAddress)(Network_Eth_FriendInDebt_Types.getFriendAddr(v.value0))(v.value0)(v1);
                      return $123;
                  }))(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                  });
          ...
          throw new Error("Failed pattern match at Debts line 124, column 10 - line 178, column 16: " + [ v.constructor.name ]);
      };
  ...
  var ui = (function () {
      var render = function (state) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.id_("container"), Halogen_HTML_Properties.class_(Halogen_HTML_Core.ClassName("container-fluid " + state.currentScreen)) ])([ promptMetamask(state.loggedIn), loadingOverlay(state.loading), Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href("#"), Halogen_HTML_Properties.class_("close-pop-button"), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(SetScreen.create("show-debts"))) ])([ Halogen_HTML_Core.text("\u2573") ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.id_("header"), Halogen_HTML_Properties.class_("row") ])([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href("#"), Halogen_HTML_Properties.class_(Halogen_HTML_Core.ClassName("col-3 " + (function () {
              var $39 = state.currentScreen === "show-friends";
              if ($39) {
                  return "active";
              };
              return "";
              ...
              var $40 = state.currentScreen === "show-debts";
              if ($40) {
                  return "active";
              };
              return "";
              ...
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(Control_Monad_Aff_Bus.make))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.subscribe(Halogen_Component_Utils.busEventSource(Control_Monad_Aff_Class.monadAffAff)(Data_Function.flip(HandleMsg.create)(Halogen_Query_EventSource.Listening.value))(v1)))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                          ...
                          $43.loggedIn = true;
                          $43.loading = true;
                          $43.errorBus = new Data_Maybe.Just(v1);
                          return $43;
                      }))(function () {
