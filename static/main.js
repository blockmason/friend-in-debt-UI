...
(function(exports) {
  ...
  var showTX = new Data_Show.Show(function (v) {
      return "Transaction: " + Data_Show.show(Data_Show.showString)(v.value0);
  });
...
(function(exports) {
  ...
  var showDebtType = new Data_Show.Show(function (debtType) {
      ...
      throw new Error("Failed pattern match at Debts line 595, column 3 - line 599, column 1: " + [ debtType.constructor.name ]);
  });
                                      ...
                                      return Control_Bind.bind(dictBind)(FriendInDebt_Blockchain.handleCall(dictBind)(dictMonadEff)(dictMonadAff)(errorBus)(Network_Eth_FriendInDebt_Types.blankPendingDebts)(Network_Eth_FriendInDebt.pendingDebts))(function (v3) {
                                          return Control_Bind.bind(dictBind)(FriendInDebt_Blockchain.handleCall(dictBind)(dictMonadEff)(dictMonadAff)(errorBus)([  ])(Network_Eth_FriendInDebt.debtBalances))(function (v4) {
                                              return Control_Monad_State_Class.modify(dictMonadState)(function (v5) {
                                                  ...
                                                  $67.myId = v;
                                                  $67.friends = v1;
                                                  $67.pendingFriendsSent = Network_Eth_FriendInDebt_Types.pfGetSents(v2);
                                                  $67.pendingFriendsTodo = Network_Eth_FriendInDebt_Types.pfGetTodos(v2);
                                                  $67.pendingSent = Network_Eth_FriendInDebt_Types.pdGetSents(v3);
                                                  $67.pendingTodo = Network_Eth_FriendInDebt_Types.pdGetTodos(v3);
                                                  $67.balances = v4;
                                                  $67.loading = false;
                                                  return $67;
                                              });
              ...
              return function (myId) {
                  return function (friends) {
                      return function (maybeDebt) {
                          var whole = function ($186) {
                              return Network_Eth_FriendInDebt_Types.moneyWhole(Network_Eth_FriendInDebt_Types.debtMoney($186));
                          };
                          var decs = function ($187) {
                              return Network_Eth_FriendInDebt_Types.moneyDecimals(Network_Eth_FriendInDebt_Types.debtMoney($187));
                          };
                          var counterparty = function (debt) {
                              return function (dType) {
                                  return function (v1) {
                                      ...
                                      throw new Error("Failed pattern match at Debts line 659, column 41 - line 661, column 59: " + [ dType.constructor.name ]);
                                  };
                              };
                          };
                          ...
                          if (v1 instanceof Data_Maybe.Just) {
                              ...
                              var sendMsg = (function () {
                                  ...
                                  throw new Error("Failed pattern match at Debts line 610, column 22 - line 612, column 11: " + [ debtType.constructor.name ]);
                              })();
                              var d = (function () {
                                  if (debtType instanceof Debt) {
                                  ...
                                  throw new Error("Failed pattern match at Debts line 607, column 15 - line 609, column 81: " + [ debtType.constructor.name ]);
                              })();
                          ...
                          throw new Error("Failed pattern match at Debts line 604, column 3 - line 654, column 11: " + [ v1.constructor.name ]);
                      };
                  };
              };
          };
  ...
  var idSpan = function (me) {
      return function (idToDisplay) {
          ...
          throw new Error("Failed pattern match at Debts line 525, column 6 - line 527, column 167: " + [ isItMe.constructor.name ]);
      };
  };
  ...
  var displayItemizedDebtTimeline = function (friendToShow) {
      return function (debtsMap) {
          return function (curFriend) {
              ...
              throw new Error("Failed pattern match at Debts line 287, column 3 - line 297, column 37: " + [ friendToShow.constructor.name ]);
          };
      };
  };
  ...
  var component = (function () {
      var render = function (state) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("page-container col-12") ])([ page(FriendInDebt_Routes.FriendsScreen.value)(Halogen_HTML_Elements.ul([ Halogen_HTML_Properties.class_("col") ])(groupFriendLiByInitial(state.defaultCurrency)(prepareFriendBundles(state)))), page(FriendInDebt_Routes.BalancesScreen.value)(Halogen_HTML_Elements.ul([ Halogen_HTML_Properties.class_("col-12") ])(Data_Functor.map(Data_Functor.functorArray)(displayBalanceLi(state))(state.balances))), page(FriendInDebt_Routes.PendingScreen.value)(pendingPage(state)), page(FriendInDebt_Routes.SettingsScreen.value)(settingsPage(state)), page(FriendInDebt_Routes.AddFriendScreen.value)(Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("add-friend-container") ])([ addFriendWidget(state) ])), page(FriendInDebt_Routes.CreateDebtScreen.value)(createDebtModal(state)) ]);
      };
      ...
      var $$eval = function (v) {
          if (v instanceof ShowItemizedDebtFor) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.raise(new ScreenChange(FriendInDebt_Routes.ItemizedDebtsScreen.value)))(function () {
                  ...
                  throw new Error("Failed pattern match at Debts line 133, column 7 - line 141, column 20: " + [ v.value0.constructor.name ]);
              });
          };
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(FriendInDebt_Prelude.hLog(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Data_Either.showEither(Data_Show.showString)(Network_Eth_Foundation.showFoundationId))(v.value0))(function () {
                      ...
                      if (v.value0 instanceof Data_Either.Right) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                              ...
                              $125.newFriend = new Data_Either.Left("");
                              return $125;
                          }))(function () {
          ...
          if (v instanceof InputFriend) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                  var $131 = Data_String.length(v.value0) > 3;
                  if ($131) {
                      return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                          ...
                          $132.newFriend = Data_Either.Right.create(v.value0);
                          return $132;
                      });
                  };
                  return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                      ...
                      $135.newFriend = new Data_Either.Left(v.value0);
                      return $135;
                  });
              })())(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                      if (v.value0 instanceof Debt) {
                          return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                              ...
                              $142.newDebt = Data_Maybe.Just.create(Network_Eth_FriendInDebt_Types.setDebtMoney(v.value1.debt)(m));
                              return $142;
                          });
                      };
                      if (v.value0 instanceof Credit) {
                          return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                              ...
                              $145.newCredit = Data_Maybe.Just.create(Network_Eth_FriendInDebt_Types.setDebtMoney(v.value1.debt)(m));
                              return $145;
                          });
                      };
                      ...
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (s) {
                          var $148 = {};
                          for (var $149 in s) {
                              if ({}.hasOwnProperty.call(s, $149)) {
                                  $148[$149] = s[$149];
                              };
                          };
                          $148.inputChanged = !s.inputChanged;
                          return $148;
                      }))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                              if (v.value0 instanceof Debt) {
          ...
          throw new Error("Failed pattern match at Debts line 129, column 10 - line 204, column 16: " + [ v.constructor.name ]);
      };
...
(function(exports) {
  ...
  var topBar = function (state) {
      ...
      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("row top-bar") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("col logo-section") ])([ Halogen_HTML_Elements.img([ Halogen_HTML_Properties.src("http://blockmason.io/assets/img/friends_in_debt_logo.svg") ]), Halogen_HTML_Core.text("Friend in Debt") ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("col go-back-section") ])([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href("#"), Halogen_HTML_Properties.class_("close-pop-button"), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(PreviousScreen.create)) ])([ Halogen_HTML_Elements.i([ Halogen_HTML_Properties.class_("fa fa-chevron-left") ])([  ]), Halogen_HTML_Core.text(" Back") ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(Halogen_HTML_Core.ClassName("col-4 align-self-end current-transactions" + (function () {
          ...
          return "";
      })())) ])([ Halogen_HTML_Elements.i([ Halogen_HTML_Properties.class_("transaction-spinner") ])([  ]), Halogen_HTML_Elements.span_([ Halogen_HTML_Core.text("Immortalizing " + (Data_Show.show(Data_Show.showInt)(Data_Array.length(state.txs)) + " items...")) ]) ]) ]);
  };
              ...
              return function (maybeBus) {
                  return function (mmInterval) {
                      return function (txInterval) {
                          ...
                          throw new Error("Failed pattern match at Container line 210, column 3 - line 215, column 16: " + [ maybeBus.constructor.name ]);
                      };
                  };
              };
          };
  ...
  var menuItem = function (screen) {
      return function (currentScreen) {
          return Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href("#"), Halogen_HTML_Properties.class_(Halogen_HTML_Core.ClassName("col-3 " + (function () {
              var $56 = Data_Eq.eq(FriendInDebt_Routes.eqScreen)(screen)(currentScreen);
              if ($56) {
                  return "active";
              };
              return "";
          })())), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(SetScreen.create(screen))) ])([ Halogen_HTML_Core.text(FriendInDebt_Routes.getMenuNameFor(screen)) ]);
      };
  };
  var menu = function (currentScreen) {
      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("header-menu row") ])([ menuItem(FriendInDebt_Routes.BalancesScreen.value)(currentScreen), menuItem(FriendInDebt_Routes.FriendsScreen.value)(currentScreen), menuItem(FriendInDebt_Routes.PendingScreen.value)(currentScreen), menuItem(FriendInDebt_Routes.SettingsScreen.value)(currentScreen) ]);
  };
  var checkMetamask = function (loggedIn) {
      return function (mmStatus) {
          var $57 = loggedIn && mmStatus;
          if ($57) {
              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
          };
          return refreshMetamask;
      ...
      var $$eval = function (v) {
              ...
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(Control_Monad_Aff_Bus.make))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.subscribe(Halogen_Component_Utils.busEventSource(Control_Monad_Aff_Class.monadAffAff)(Data_Function.flip(HandleMsg.create)(Halogen_Query_EventSource.Listening.value))(v1)))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                          ...
                          $62.loggedIn = true;
                          $62.loading = true;
                          $62.errorBus = new Data_Maybe.Just(v1);
                          return $62;
                      }))(function () {
          ...
          if (v instanceof HandleMsg) {
              ...
              if (v.value0 instanceof FriendInDebt_Types.CheckTxs) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(FriendInDebt_Prelude.hLog(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Data_Show.showString)("checking Tx"))(function () {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                          return v1.txs;
                      }))(function (v1) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(FriendInDebt_Prelude.hLog(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Data_Show.showArray(Network_Eth.showTX))(v1))(function () {
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                                  return v2.errorBus;
                              }))(function (v2) {
                                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(Data_Traversable.sequence(Data_Traversable.traversableArray)(Control_Monad_Aff.applicativeAff)(Data_Functor.map(Data_Functor.functorArray)(Network_Eth_Metamask.checkTxStatus)(v1))))(function (v3) {
                                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                                          var $86 = FriendInDebt_Blockchain.hasNetworkError(v3);
                                          if ($86) {
                                              if (v2 instanceof Data_Maybe.Nothing) {
                                                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                                              };
                                          ...
                                          var $92 = Data_Array.length(pending) !== Data_Array.length(v1);
                                          if ($92) {
                                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v4) {
                                                  var $96 = {};
                                                  for (var $97 in v4) {
                                                  ...
                                                  $96.txs = Data_Functor.map(Data_Functor.functorArray)(function (v5) {
                                                      return v5.value1;
                                                  })(pending);
                                                  return $96;
                                              }))(function () {
              ...
              throw new Error("Failed pattern match at Container line 115, column 9 - line 150, column 22: " + [ v.value0.constructor.name ]);
          };
          ...
          if (v instanceof SetScreen) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                  ...
                  $102.history = Data_Semigroup.append(Data_Semigroup.semigroupArray)([ state.currentScreen ])(state.history);
                  return $102;
              }))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                      var $105 = {};
          ...
          if (v instanceof DebtViewMsg) {
              if (v.value0 instanceof Debts.ScreenChange) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                      ...
                      $111.history = Data_Semigroup.append(Data_Semigroup.semigroupArray)([ state.currentScreen ])(state.history);
                      return $111;
                  }))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                          var $114 = {};
                          ...
                          $114.currentScreen = v.value0.value0;
                          return $114;
                      }))(function () {
                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                      });
              ...
              if (v.value0 instanceof Debts.NewTX) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (s) {
                      ...
                      $118.txs = Data_Semigroup.append(Data_Semigroup.semigroupArray)(s.txs)([ v.value0.value0 ]);
                      return $118;
                  }))(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                  });
              };
              throw new Error("Failed pattern match at Container line 159, column 9 - line 166, column 22: " + [ v.value0.constructor.name ]);
          };
          if (v instanceof PreviousScreen) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                  ...
                  $124.currentScreen = Data_Maybe.fromMaybe(FriendInDebt_Routes.BalancesScreen.value)(Data_Array.head(state.history));
                  $124.history = Data_Maybe.fromMaybe([  ])(Data_Array.tail(state.history));
                  return $124;
              }))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
              });
          };
          throw new Error("Failed pattern match at Container line 103, column 12 - line 169, column 18: " + [ v.constructor.name ]);
      };
