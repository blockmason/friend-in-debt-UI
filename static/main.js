  ...
  var handleDebt = function (handleDebtFn) {
      return function (debt) {
          return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Aff.monadAff))(foundationId)(function (v) {
              ...
              var $47 = Network_Eth_FriendInDebt_Types.isValidDebtId(debtId);
              if ($47) {
  ...
  var pendingDebts = Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Aff.monadAff))(foundationId)(function (v) {
      return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Aff.monadAff))(Control_Monad_Aff_Class.liftAff(Control_Monad_Aff_Class.monadAffExceptT(Control_Monad_Aff_Class.monadAffAff))(Control_Monad_Aff.makeAff(function (err) {
          ...
          var sent = function ($75) {
              ...
              })(Data_Functor.map(Data_Functor.functorArray)(Network_Eth_FriendInDebt_Types.rawToDebt)($75));
          };
          var todo = function ($76) {
              return Data_Array.filter(function (d) {
...
(function(exports) {
                  ...
                  return function (maybeDebt) {
                      ...
                      var counterparty = function (debt) {
                          return function (dType) {
                              return function (v) {
                                  ...
                                  throw new Error("Failed pattern match at Debts line 501, column 41 - line 503, column 59: " + [ dType.constructor.name ]);
                              };
                          };
                      };
                      ...
                      if (v instanceof Data_Maybe.Just) {
                          var handler = (function () {
                              ...
                              throw new Error("Failed pattern match at Debts line 473, column 21 - line 474, column 58: " + [ debtType.constructor.name ]);
                          })();
                          var d = (function () {
                              if (debtType instanceof Debt) {
                              ...
                              throw new Error("Failed pattern match at Debts line 470, column 15 - line 472, column 81: " + [ debtType.constructor.name ]);
                          })();
                      ...
                      throw new Error("Failed pattern match at Debts line 467, column 3 - line 497, column 11: " + [ v.constructor.name ]);
                  };
              };
          };
      };
  ...
  var idSpan = function (me) {
      return function (idToDisplay) {
          ...
          throw new Error("Failed pattern match at Debts line 386, column 6 - line 388, column 125: " + [ isItMe.constructor.name ]);
      };
  };
                      ...
                      return function (fidAffCall) {
                          ...
                          if (errorBus instanceof Data_Maybe.Just) {
                              return Control_Bind.bind(dictBind)(Control_Monad_Aff_Class.liftAff(dictMonadAff)(Network_Eth_FriendInDebt.runMonadF(fidAffCall)))(function (v) {
                                  ...
                                  throw new Error("Failed pattern match at Debts line 521, column 7 - line 524, column 27: " + [ v.constructor.name ]);
                              });
                          };
                          throw new Error("Failed pattern match at Debts line 515, column 3 - line 524, column 27: " + [ errorBus.constructor.name ]);
                      };
                  };
              };
          };
      ...
      return function (curFriend) {
          if (friendToShow instanceof Data_Maybe.Just) {
              return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(Halogen_HTML_Core.ClassName("itemized-debts-for-friend")), Halogen_HTML_Properties.attr("style")((function () {
                  var $73 = Data_Eq.eq(Network_Eth_Foundation.eqFoundationId)(curFriend)(friendToShow.value0);
                  if ($73) {
                      return "display: block";
                  };
                  return "display: none";
              })()) ])([ Halogen_HTML_Elements.h5_([ Halogen_HTML_Core.text("History with " + (Data_Show.show(Network_Eth_Foundation.showFoundationId)(friendToShow.value0) + ":")) ]), Halogen_HTML_Elements.ul_(Data_Functor.map(Data_Functor.functorArray)(itemizedDebtLi)([  ])) ]);
          };
          if (friendToShow instanceof Data_Maybe.Nothing) {
              return Halogen_HTML_Elements.div_([ Halogen_HTML_Core.text("") ]);
          };
          throw new Error("Failed pattern match at Debts line 239, column 3 - line 245, column 37: " + [ friendToShow.constructor.name ]);
      };
  };
  ...
  var component = (function () {
      ...
      var $$eval = function (v) {
          if (v instanceof ShowItemizedDebtFor) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(FriendInDebt_Prelude.hLog(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Data_Maybe.showMaybe(Network_Eth_Foundation.showFoundationId))(v.value0))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                      ...
                      $79.showItemizedDebtFor = v.value0;
                      return $79;
                  }))(function () {
          ...
          if (v instanceof AddFriend) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(FriendInDebt_Prelude.hLog(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Data_Either.showEither(Data_Show.showString)(Network_Eth_Foundation.showFoundationId))(v.value0))(function () {
                      ...
                      throw new Error("Failed pattern match at Debts line 170, column 7 - line 175, column 20: " + [ v.value0.constructor.name ]);
                  });
              });
          };
          ...
          if (v instanceof InputDebt) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(FriendInDebt_Prelude.hLog(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Network_Eth_FriendInDebt_Types.showDebt)(v.value0))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                      ...
                      $118.newDebt = new Data_Maybe.Just(v.value0);
                      return $118;
                  }))(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                  });
          ...
          if (v instanceof InputCredit) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  $123.newCredit = new Data_Maybe.Just(v.value0);
                  return $123;
              }))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
              });
                  ...
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(handleFIDCall(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(v1.errorBus)(Data_Unit.unit)(Network_Eth_FriendInDebt.newPendingDebt(v.value0)))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                              ...
                              $129.newDebt = Data_Maybe.Nothing.value;
                              $129.newCredit = Data_Maybe.Nothing.value;
                              return $129;
                          }))(function () {
                              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                          });
          ...
          throw new Error("Failed pattern match at Debts line 158, column 10 - line 213, column 16: " + [ v.constructor.name ]);
      };
