...
(function(exports) {
              ...
              return function (myId) {
                  return function (friends) {
                      return function (maybeDebt) {
                          var whole = function ($183) {
                              return Network_Eth_FriendInDebt_Types.moneyWhole(Network_Eth_FriendInDebt_Types.debtMoney($183));
                          };
                          var decs = function ($184) {
                              return Network_Eth_FriendInDebt_Types.moneyDecimals(Network_Eth_FriendInDebt_Types.debtMoney($184));
                          };
                          var counterparty = function (debt) {
                              return function (dType) {
                                  return function (v1) {
                                      ...
                                      throw new Error("Failed pattern match at Debts line 644, column 41 - line 646, column 59: " + [ dType.constructor.name ]);
                                  };
                              };
                          };
                          ...
                          if (v1 instanceof Data_Maybe.Just) {
                              var sendMsg = (function () {
                                  ...
                                  throw new Error("Failed pattern match at Debts line 603, column 22 - line 605, column 7: " + [ debtType.constructor.name ]);
                              })();
                              var d = (function () {
                                  if (debtType instanceof Debt) {
                              ...
                              return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("create-debt col") ])([ Halogen_HTML_Elements.label_([ Halogen_HTML_Core.text("Enter " + Data_Show.show(showDebtType)(debtType)) ]), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputNumber.value), Halogen_HTML_Properties.class_("debt-amount"), Halogen_HTML_Properties.value(Data_Show.show(Data_Show.showInt)(whole(d))), Halogen_HTML_Events.onValueInput(Halogen_HTML_Events.input(function (v2) {
                                  return InputDebtAmount.create(debtType)({
                                      whole: Data_Maybe.fromMaybe(0)(Data_Int.fromString(v2)), 
                                      decs: decs(d), 
                                      debt: d
                                  });
                              })) ]), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputNumber.value), Halogen_HTML_Properties.class_("debt-amount"), Halogen_HTML_Properties.value(Data_Show.show(Data_Show.showInt)(decs(d))), Halogen_HTML_Events.onValueInput(Halogen_HTML_Events.input(function (v2) {
                                  return InputDebtAmount.create(debtType)({
                                      whole: whole(d), 
                                      decs: Data_Maybe.fromMaybe(0)(Data_Int.fromString(Data_String.take(2)(v2))), 
                                      debt: d
                                  });
                              })) ]), Halogen_HTML_Elements.select([ Halogen_HTML_Events.onValueChange(Halogen_HTML_Events.input(function (v2) {
                          ...
                          throw new Error("Failed pattern match at Debts line 597, column 3 - line 639, column 11: " + [ v1.constructor.name ]);
                      };
                  };
              };
          };
  ...
  var displayBalanceLi = function (state) {
      return function (v) {
          var status = (function () {
              var $95 = Data_Eq.eq(Network_Eth_Foundation.eqFoundationId)(v.creditor)(state.myId);
              if ($95) {
          ...
          var curFriend = (function () {
              var $96 = Data_Eq.eq(Network_Eth_Foundation.eqFoundationId)(v.creditor)(state.myId);
              if ($96) {
                  return v.debtor;
              };
              return v.creditor;
