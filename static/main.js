...
(function(exports) {
  ...
  var showDebtType = new Data_Show.Show(function (debtType) {
      ...
      throw new Error("Failed pattern match at Debts line 588, column 3 - line 592, column 1: " + [ debtType.constructor.name ]);
  });
              ...
              return function (myId) {
                  return function (friends) {
                      return function (maybeDebt) {
                          var whole = function ($185) {
                              return Network_Eth_FriendInDebt_Types.moneyWhole(Network_Eth_FriendInDebt_Types.debtMoney($185));
                          };
                          var decs = function ($186) {
                              return Network_Eth_FriendInDebt_Types.moneyDecimals(Network_Eth_FriendInDebt_Types.debtMoney($186));
                          };
                          ...
                          if (v1 instanceof Data_Maybe.Just) {
                              ...
                              var sendMsg = (function () {
                                  ...
                                  throw new Error("Failed pattern match at Debts line 603, column 22 - line 605, column 11: " + [ debtType.constructor.name ]);
                              })();
                              var d = (function () {
                                  if (debtType instanceof Debt) {
                                  ...
                                  throw new Error("Failed pattern match at Debts line 600, column 15 - line 602, column 81: " + [ debtType.constructor.name ]);
                              })();
                          ...
                          throw new Error("Failed pattern match at Debts line 597, column 3 - line 647, column 11: " + [ v1.constructor.name ]);
                      };
                  };
              };
          };
  ...
  var idSpan = function (me) {
      return function (idToDisplay) {
          ...
          throw new Error("Failed pattern match at Debts line 518, column 6 - line 520, column 167: " + [ isItMe.constructor.name ]);
      };
  };
  ...
  var displayBalanceLi = function (state) {
      return function (v) {
          var status = (function () {
              var $97 = Data_Eq.eq(Network_Eth_Foundation.eqFoundationId)(v.creditor)(state.myId);
              if ($97) {
          ...
          var curFriend = (function () {
              var $98 = Data_Eq.eq(Network_Eth_Foundation.eqFoundationId)(v.creditor)(state.myId);
              if ($98) {
                  return v.debtor;
              };
              return v.creditor;
                  ...
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(FriendInDebt_Blockchain.handleTx(Control_Monad_Aff.monadEffAff)(Control_Monad_Aff_Class.monadAffAff)(NewTX.create)(v1)(Network_Eth_FriendInDebt.newPendingDebt(v.value0)))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                              ...
                              $172.newDebt = Data_Maybe.Nothing.value;
                              $172.newCredit = Data_Maybe.Nothing.value;
                              return $172;
                          }))(function () {
                              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                          });
