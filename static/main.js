...
(function(exports) {
  ...
  var mockMe = "me";                          
  var mockFriendNames = [ "bob", "tim", "kevin" ];
  var mockFoundationId = "snoopy";
  var mockDebt = function (fid) {
      return Network_Eth_FriendInDebt_Types.mkDebt(mockFoundationId)(fid)(fid)(Network_Eth_FriendInDebt_Types.moneyFromDecString("2.0")(Network_Eth_FriendInDebt_Types.cUSD))(Network_Eth_FriendInDebt_Types.NoDebtId.value)("Fictional Cat Poop");
  };
                  ...
                  return function (maybeDebt) {
                      ...
                      var counterparty = function (debt) {
                          return function (debtType1) {
                              return function (v) {
                                  ...
                                  throw new Error("Failed pattern match at Debts line 498, column 44 - line 500, column 59: " + [ debtType1.constructor.name ]);
                              };
                          };
                      };
                      var amount = function (debt) {
                          return function (v) {
                              return function (cur1) {
                                  return Network_Eth_FriendInDebt_Types.setDebtMoney(debt)(Network_Eth_FriendInDebt_Types.moneyFromDecString(noDecimals(v))(cur1));
                              };
                          };
                      };
                      ...
                      if (v instanceof Data_Maybe.Just) {
                          var handler = (function () {
                              ...
                              throw new Error("Failed pattern match at Debts line 470, column 21 - line 471, column 58: " + [ debtType.constructor.name ]);
                          })();
                          var d = (function () {
                              if (debtType instanceof Debt) {
                              ...
                              throw new Error("Failed pattern match at Debts line 467, column 15 - line 469, column 81: " + [ debtType.constructor.name ]);
                          })();
                      ...
                      throw new Error("Failed pattern match at Debts line 464, column 3 - line 494, column 11: " + [ v.constructor.name ]);
                  };
              };
          };
      };
  ...
  var idSpan = function (me) {
      return function (idToDisplay) {
          ...
          throw new Error("Failed pattern match at Debts line 383, column 6 - line 385, column 125: " + [ isItMe.constructor.name ]);
      };
  };
                      ...
                      return function (fidAffCall) {
                          ...
                          if (errorBus instanceof Data_Maybe.Just) {
                              return Control_Bind.bind(dictBind)(Control_Monad_Aff_Class.liftAff(dictMonadAff)(Network_Eth_FriendInDebt.runMonadF(fidAffCall)))(function (v) {
                                  ...
                                  throw new Error("Failed pattern match at Debts line 518, column 7 - line 521, column 30: " + [ v.constructor.name ]);
                              });
                          };
                          throw new Error("Failed pattern match at Debts line 512, column 3 - line 521, column 30: " + [ errorBus.constructor.name ]);
                      };
                  };
              };
          };
  ...
  var displayFriendLi = function (n) {
      return Halogen_HTML_Elements.li([ Halogen_HTML_Properties.class_("friend-row row") ])([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href("#"), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(ShowItemizedDebtFor.create(n))) ])([ Halogen_HTML_Core.text(n) ]) ]);
  };
  ...
  var itemizedDebtsForFriendContainer = function (friendToShow) {
      return function (nm) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(Halogen_HTML_Core.ClassName("itemized-debts-for-friend")), Halogen_HTML_Properties.attr("style")((function () {
              var $72 = nm === friendToShow;
              if ($72) {
                  return "display: block";
              };
              return "display: none";
          })()) ])([ Halogen_HTML_Elements.h5_([ Halogen_HTML_Core.text("History with " + (friendToShow + ":")) ]), Halogen_HTML_Elements.ul_(Data_Functor.map(Data_Functor.functorArray)(itemizedDebtLi)([ fakeDebt, fakeDebt ])) ]);
      };
  };
      ...
      var $$eval = function (v) {
          if (v instanceof ShowItemizedDebtFor) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  $77.showItemizedDebtFor = v.value0;
                  return $77;
              }))(function () {
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(FriendInDebt_Prelude.hLog(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Data_Either.showEither(Data_Show.showString)(Network_Eth_Foundation.showFoundationId))(v.value0))(function () {
                      ...
                      if (v.value0 instanceof Data_Either.Right) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                              ...
                              $90.newFriend = new Data_Either.Left("");
                              return $90;
                          }))(function () {
          ...
          if (v instanceof InputFriend) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                  var $96 = Data_String.length(v.value0) > 3;
                  if ($96) {
                      return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                          ...
                          $97.newFriend = Data_Either.Right.create(v.value0);
                          return $97;
                      });
                  };
                  return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                      ...
                      $100.newFriend = new Data_Either.Left(v.value0);
                      return $100;
                  });
              })())(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
          ...
          if (v instanceof InputDebt) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(FriendInDebt_Prelude.hLog(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Network_Eth_FriendInDebt_Types.showDebt)(v.value0))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                      ...
                      $116.newDebt = new Data_Maybe.Just(v.value0);
                      return $116;
                  }))(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                  });
          ...
          if (v instanceof InputCredit) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  $121.newCredit = new Data_Maybe.Just(v.value0);
                  return $121;
              }))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
              });
                  ...
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(handleFIDCall(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(v1.errorBus)(Data_Unit.unit)(Network_Eth_FriendInDebt.newPendingDebt(v.value0)))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                              ...
                              $127.newDebt = Data_Maybe.Nothing.value;
                              $127.newCredit = Data_Maybe.Nothing.value;
                              return $127;
                          }))(function () {
                              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                          });
          ...
          throw new Error("Failed pattern match at Debts line 159, column 10 - line 213, column 16: " + [ v.constructor.name ]);
      };
  ...
  exports["mockFriendNames"] = mockFriendNames;
