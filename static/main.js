...
(function(exports) {
  ...
  var showDebtType = new Data_Show.Show(function (debtType) {
      ...
      throw new Error("Failed pattern match at Debts line 656, column 3 - line 660, column 1: " + [ debtType.constructor.name ]);
  });
                          ...
                          return function (strAmount) {
                              ...
                              var counterparty = function (debt) {
                                  return function (dType) {
                                      return function (v1) {
                                          ...
                                          throw new Error("Failed pattern match at Debts line 706, column 41 - line 708, column 59: " + [ dType.constructor.name ]);
                                      };
                                  };
                              };
                              ...
                              if (v1 instanceof Data_Maybe.Just) {
                                  ...
                                  var sendMsg = (function () {
                                      ...
                                      throw new Error("Failed pattern match at Debts line 671, column 22 - line 673, column 11: " + [ debtType.constructor.name ]);
                                  })();
                                  var d = (function () {
                                      if (debtType instanceof Debt) {
                                      ...
                                      throw new Error("Failed pattern match at Debts line 668, column 15 - line 670, column 81: " + [ debtType.constructor.name ]);
                                  })();
                              ...
                              throw new Error("Failed pattern match at Debts line 665, column 3 - line 703, column 11: " + [ v1.constructor.name ]);
                          };
                      };
                  };
              };
  ...
  var idSpan = function (me) {
      return function (idToDisplay) {
          ...
          throw new Error("Failed pattern match at Debts line 581, column 6 - line 583, column 167: " + [ isItMe.constructor.name ]);
      };
  };
  ...
  var displayItemizedDebtTimeline = function (friendToShow) {
      return function (debtsMap) {
          return function (curFriend) {
              ...
              throw new Error("Failed pattern match at Debts line 319, column 3 - line 329, column 37: " + [ friendToShow.constructor.name ]);
          };
      };
  };
  ...
  var cancelFriendshipButton = function (friend) {
      return Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(CancelFriend.create(friend))), Halogen_HTML_Properties.class_("") ])([ Halogen_HTML_Elements.i([ Halogen_HTML_Properties.class_("fa fa-close") ])([  ]) ]);
  };
      ...
      var $$eval = function (v) {
                  ...
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                      ...
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(FriendInDebt_Prelude.hLog(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Data_Maybe.showMaybe(Network_Eth_FriendInDebt_Types.showMoney))(Network_Eth_FriendInDebt_Types.moneyFromDecString(v1)(v.value1)))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                              ...
                              throw new Error("Failed pattern match at Debts line 195, column 7 - line 197, column 61: " + [ v.value0.constructor.name ]);
                          })())(function () {
          ...
          if (v instanceof InputDebtDetails) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                  ...
                  throw new Error("Failed pattern match at Debts line 200, column 7 - line 202, column 56: " + [ v.value0.constructor.name ]);
              })())(function () {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
          ...
          if (v instanceof AddDebt) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(FriendInDebt_Prelude.hLog(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Data_Maybe.showMaybe(Network_Eth_FriendInDebt_Types.showDebt))(v.value0))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                      ...
                      throw new Error("Failed pattern match at Debts line 209, column 7 - line 217, column 30: " + [ v.value0.constructor.name ]);
                  })())(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                  });
              });
          ...
          throw new Error("Failed pattern match at Debts line 139, column 10 - line 237, column 16: " + [ v.constructor.name ]);
      };
      ...
      return function (numTriesLeft) {
          ...
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v) {
              ...
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                  ...
                  throw new Error("Failed pattern match at Container line 365, column 7 - line 367, column 58: " + [ v.constructor.name ]);
              })())(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
              });
          });
  ...
  var ui = (function () {
      var render = function (state) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.id_("container"), Halogen_HTML_Properties.class_(Halogen_HTML_Core.ClassName("container " + (FriendInDebt_Routes.getRouteNameFor(state.currentScreen) + (function () {
              var $102 = state.loggedIn && Data_Maybe.isJust(state.myId);
              if ($102) {
                  return "";
              };
      ...
      var $$eval = function (v) {
                  ...
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(Control_Monad_Aff_Bus.make))(function (v1) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.subscribe(Halogen_Component_Utils.busEventSource(Control_Monad_Aff_Class.monadAffAff)(Data_Function.flip(HandleMsg.create)(Halogen_Query_EventSource.Listening.value))(v1)))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                              ...
                              $108.loggedIn = true;
                              $108.loading = true;
                              $108.errorBus = new Data_Maybe.Just(v1);
                              return $108;
                          }))(function () {
          ...
          if (v instanceof HandleMsg) {
              ...
              if (v.value0 instanceof FriendInDebt_Types.FIDError) {
                  if (v.value0.value0 instanceof Network_Eth_FriendInDebt_Types.NoFoundationId) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                          ...
                          $117.myId = Data_Maybe.Nothing.value;
                          return $117;
                      }))(function () {
                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                      });
                  ...
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                      ...
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                          ...
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(Data_Traversable.sequence(Data_Traversable.traversableArray)(Control_Monad_Aff.applicativeAff)(Data_Functor.map(Data_Functor.functorArray)(Network_Eth_Metamask.checkTxStatus)(v1))))(function (v3) {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                                  var $132 = FriendInDebt_Blockchain.hasNetworkError(v3);
                                  if ($132) {
                                      if (v2 instanceof Data_Maybe.Nothing) {
                                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                                      };
                                      ...
                                      throw new Error("Failed pattern match at Container line 151, column 20 - line 153, column 63: " + [ v2.constructor.name ]);
                                  };
                                  var pending = Data_Array.filter(function (v4) {
                                      return Network_Eth.notDone(v4.value0);
                                  })(Data_Array.zip(v3)(v1));
                                  var $138 = Data_Array.length(pending) !== Data_Array.length(v1);
                                  if ($138) {
                                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v4) {
                                          var $142 = {};
                                          for (var $143 in v4) {
                                          ...
                                          $142.txs = Data_Functor.map(Data_Functor.functorArray)(function (v5) {
                                              return v5.value1;
                                          })(pending);
                                          return $142;
                                      }))(function () {
              ...
              throw new Error("Failed pattern match at Container line 124, column 9 - line 161, column 22: " + [ v.value0.constructor.name ]);
          };
          ...
          if (v instanceof SetScreen) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                  var $148 = {};
                  for (var $149 in state) {
                      if ({}.hasOwnProperty.call(state, $149)) {
                          $148[$149] = state[$149];
                      };
                  };
                  $148.history = Data_Semigroup.append(Data_Semigroup.semigroupArray)([ state.currentScreen ])(state.history);
                  return $148;
              }))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                      var $151 = {};
              ...
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                  if (v.value0 instanceof Debts.ScreenChange) {
                      return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (s) {
                          ...
                          $157.history = Data_Semigroup.append(Data_Semigroup.semigroupArray)([ s.currentScreen ])(s.history);
                          $157.currentScreen = v.value0.value0;
                          return $157;
                      });
                  };
                  if (v.value0 instanceof Debts.NewTX) {
                      return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (s) {
                          ...
                          $161.txs = Data_Semigroup.append(Data_Semigroup.semigroupArray)(s.txs)([ v.value0.value0 ]);
                          return $161;
                      });
                  };
                  if (v.value0 instanceof Debts.NumPendingTodo) {
                      return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                          ...
                          $165.numPendingTodo = v.value0.value0;
                          return $165;
                      });
                  };
                  if (v.value0 instanceof Debts.NumPendingFriends) {
                      return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                          ...
                          $169.numPendingFriends = v.value0.value0;
                          return $169;
                      });
                  };
                  if (v.value0 instanceof Debts.LoadId) {
                      return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                          ...
                          $173.myId = new Data_Maybe.Just(v.value0.value0);
                          return $173;
                      });
                  };
                  throw new Error("Failed pattern match at Container line 170, column 9 - line 181, column 45: " + [ v.value0.constructor.name ]);
              })())(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
              });
          };
          if (v instanceof PreviousScreen) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                  var $179 = {};
                  for (var $180 in state) {
                      if ({}.hasOwnProperty.call(state, $180)) {
                          $179[$180] = state[$180];
                      };
                  };
                  $179.currentScreen = Data_Maybe.fromMaybe(FriendInDebt_Routes.BalancesScreen.value)(Data_Array.head(state.history));
                  $179.history = Data_Maybe.fromMaybe([  ])(Data_Array.tail(state.history));
                  return $179;
              }))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
              });
          };
          throw new Error("Failed pattern match at Container line 114, column 12 - line 185, column 18: " + [ v.constructor.name ]);
      };
