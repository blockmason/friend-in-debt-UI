...
(function(exports) {
  ...
  var showDebtType = new Data_Show.Show(function (debtType) {
      ...
      throw new Error("Failed pattern match at Debts line 650, column 3 - line 654, column 1: " + [ debtType.constructor.name ]);
  });
                          ...
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(FriendInDebt_Blockchain.handleCall(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.monadEffHalogenM(dictMonadEff))(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(errorBus)(Network_Eth_FriendInDebt_Types.blankPendingDebts)(Network_Eth_FriendInDebt.pendingDebts))(function (v3) {
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(FriendInDebt_Blockchain.handleCall(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.monadEffHalogenM(dictMonadEff))(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(errorBus)([  ])(Network_Eth_FriendInDebt.debtBalances))(function (v4) {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v5) {
                                      var $57 = {};
                                      for (var $58 in v5) {
                                          if ({}.hasOwnProperty.call(v5, $58)) {
                                              $57[$58] = v5[$58];
                                          };
                                      };
                                      $57.myId = v;
                                      $57.friends = v1;
                                      $57.pendingFriendsSent = Network_Eth_FriendInDebt_Types.pfGetSents(v2);
                                      $57.pendingFriendsTodo = Network_Eth_FriendInDebt_Types.pfGetTodos(v2);
                                      $57.pendingSent = Network_Eth_FriendInDebt_Types.pdGetSents(v3);
                                      $57.pendingTodo = Network_Eth_FriendInDebt_Types.pdGetTodos(v3);
                                      $57.balances = v4;
                                      return $57;
                                  }))(function () {
              ...
              return function (friends) {
                  return function (debtInfo) {
                      ...
                      var getDebtor = function (debtType1) {
                          return function (me) {
                              return function (friend) {
                                  ...
                                  throw new Error("Failed pattern match at Debts line 702, column 40 - line 704, column 26: " + [ debtType1.constructor.name ]);
                              };
                          };
                      };
                      var getCreditor = function (debtType1) {
                          return function (me) {
                              return function (friend) {
                                  ...
                                  throw new Error("Failed pattern match at Debts line 705, column 42 - line 707, column 22: " + [ debtType1.constructor.name ]);
                              };
                          };
                      };
                      ...
                      var sendMsg = (function () {
                          ...
                          throw new Error("Failed pattern match at Debts line 659, column 18 - line 661, column 3: " + [ debtType.constructor.name ]);
                      })();
                      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(Halogen_HTML_Core.ClassName("create-debt col ")) ])([ Halogen_HTML_Elements.label_([ Halogen_HTML_Core.text("Enter " + Data_Show.show(showDebtType)(debtType)) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("row amount-row") ])([ Halogen_HTML_Elements.span_([ Halogen_HTML_Core.text(Network_Eth_FriendInDebt_Types.cSymbol(cur)) ]), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputNumber.value), Halogen_HTML_Properties.class_("debt-amount"), Halogen_HTML_Properties.value(debtInfo.amount), Halogen_HTML_Properties.step(new DOM_HTML_Indexed_StepValue.Step(1.0e-2)), Halogen_HTML_Events.onValueInput(Halogen_HTML_Events.input(function (v) {
                          return InputDebtDetails.create(debtType)((function () {
                              var $63 = {};
                              for (var $64 in debtInfo) {
                                  if ({}.hasOwnProperty.call(debtInfo, $64)) {
                                      $63[$64] = debtInfo[$64];
                                  };
                              };
                              $63.amount = v;
                          ...
                          var $66 = v === "Select a Friend";
                          if ($66) {
                              return NoOp.create;
                          };
                          return InputDebtDetails.create(debtType)((function () {
                              var $67 = {};
                              for (var $68 in debtInfo) {
                                  if ({}.hasOwnProperty.call(debtInfo, $68)) {
                                      $67[$68] = debtInfo[$68];
                                  };
                              };
                              $67.counterParty = v;
                      ...
                      })) ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Halogen_HTML_Elements.option_([ Halogen_HTML_Core.text("Select a Friend") ]) ])(Data_Functor.map(Data_Functor.functorArray)(function (f) {
                          ...
                          return InputDebtDetails.create(debtType)((function () {
                              var $70 = {};
                              for (var $71 in debtInfo) {
                                  if ({}.hasOwnProperty.call(debtInfo, $71)) {
                                      $70[$71] = debtInfo[$71];
                                  };
                              };
                              $70.desc = Data_String.take(32)(val);
                              return $70;
                          })());
  ...
  var idSpan = function (me) {
      return function (idToDisplay) {
          ...
          throw new Error("Failed pattern match at Debts line 575, column 6 - line 577, column 167: " + [ isItMe.constructor.name ]);
      };
  };
  ...
  var debtRelationshipSpan = function (me) {
      return function (fd) {
          var relationship = (function () {
              var $86 = Data_Eq.eq(Network_Eth_Foundation.eqFoundationId)(Network_Eth_FriendInDebt_Types.debtDebtor(fd))(me);
              if ($86) {
                  return "owe";
              };
              return "owes";
  ...
  var displayItemizedDebtTimeline = function (friendToShow) {
      return function (debtsMap) {
          return function (curFriend) {
              ...
              throw new Error("Failed pattern match at Debts line 313, column 3 - line 323, column 37: " + [ friendToShow.constructor.name ]);
          };
      };
  };
  var displayBalanceLi = function (state) {
      return function (bal) {
          ...
          var curFriend = (function () {
              var $93 = Data_Eq.eq(Network_Eth_Foundation.eqFoundationId)(creditor)(state.myId);
              if ($93) {
                  return debtor;
              };
              return creditor;
          ...
          var expandClass = Data_Functor.map(Data_Maybe.functorMaybe)(function (f) {
              var $94 = Data_Eq.eq(Network_Eth_Foundation.eqFoundationId)(f)(curFriend);
              if ($94) {
      ...
      var $$eval = function (v) {
                  ...
                  if (v.value0 instanceof Data_Maybe.Just) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                              ...
                              $101.showItemizedDebtFor = v.value0;
                              return $101;
                          }))(function () {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(UI_UIStatesKit.toggleLoading(".itemized-debts")))(function () {
                                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(FriendInDebt_Blockchain.handleCall(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(v1.errorBus)([  ])(Network_Eth_FriendInDebt.itemizedDebts(v.value0.value0)))(function (v2) {
                                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                                          var $105 = {};
                                          for (var $106 in v3) {
                                              if ({}.hasOwnProperty.call(v3, $106)) {
                                                  $105[$106] = v3[$106];
                                              };
                                          };
                                          $105.itemizedDebts = Data_Map.insert(Network_Eth_Foundation.ordFoundationId)(v.value0.value0)(v2)(v1.itemizedDebts);
                                          return $105;
                                      }))(function () {
                                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(UI_UIStatesKit.toggleLoading(".itemized-debts")))(function () {
                                              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
          ...
          if (v instanceof InputFriend) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  $139.nameNoExist = false;
                  return $139;
              }))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                      var $142 = Network_Eth_Foundation.fiStrValidId(Data_String.toLower(v.value0)) || Data_String.length(v.value0) < 4;
                      if ($142) {
                          return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                              ...
                              $143.newFriend = Data_String.toLower(v.value0);
                              return $143;
                          });
                      };
                      return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(FriendInDebt_Blockchain.handleTx(Control_Monad_Aff.monadEffAff)(Control_Monad_Aff_Class.monadAffAff)(NewTX.create)(v1)(new ScreenChange(FriendInDebt_Routes.BalancesScreen.value))(Network_Eth_FriendInDebt.newPendingDebt(v.value1)))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                              ...
                              $162.newDebtInput = blankDebtInfo;
                              $162.newCreditInput = blankDebtInfo;
                              return $162;
                          }))(function () {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(UI_UIStatesKit.toggleLoading(".create-debt-button")))(function () {
                                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value2);
          ...
          throw new Error("Failed pattern match at Debts line 137, column 10 - line 231, column 16: " + [ v.constructor.name ]);
      };
