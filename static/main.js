...
(function(exports) {
  ...
  var showPendingFriendships = new Data_Show.Show(function (v) {
      return "{todo: " + (Data_Show.show(Data_Show.showArray(Network_Eth_Foundation.showFoundationId))(v.todo) + (", sent: " + (Data_Show.show(Data_Show.showArray(Network_Eth_Foundation.showFoundationId))(v.sent) + "}")));
  });
  ...
  var debtAmount = function ($138) {
      return numAmount(debtMoney($138));
  };
      ...
      return function (rb) {
          var debtorCreditor = function (myId) {
              return function (cpId) {
                  return function (val) {
                      var $126 = val >= Data_Int.toNumber(0);
                      if ($126) {
          ...
          return {
              ...
              mostRecent: Data_Functor.map(Data_Maybe.functorMaybe)(Data_DateTime_Instant.toDateTime)(Data_DateTime_Instant.instant(rb.mostRecent))
          };
      };
  };
  ...
  var conversionFactor = function ($139) {
      return $$Math.pow(10.0)(Data_Int.toNumber(cDecimals($139)));
  };
  ...
  var showBalance = new Data_Show.Show(function (v) {
      return Data_Show.show(Network_Eth_Foundation.showFoundationId)(v.debtor) + (", " + (Data_Show.show(Network_Eth_Foundation.showFoundationId)(v.creditor) + (": " + Data_Show.show(showMoney)(v.amount))));
  });
  ...
  var showPendingDebts = new Data_Show.Show(function (v) {
      return "{todo: " + (Data_Show.show(Data_Show.showArray(showDebt))(v.todo) + (", sent: " + (Data_Show.show(Data_Show.showArray(showDebt))(v.sent) + "}")));
  });
  ...
  exports["showPendingFriendships"] = showPendingFriendships;
  exports["showPendingDebts"] = showPendingDebts;
                      ...
                      return function (affCall) {
                          ...
                          if (errorBus instanceof Data_Maybe.Just) {
                              return Control_Bind.bind(dictBind)(Control_Monad_Aff_Class.liftAff(dictMonadAff)(Network_Eth_FriendInDebt.runMonadF(affCall)))(function (v) {
                                  ...
                                  throw new Error("Failed pattern match at FriendInDebt.Blockchain line 21, column 7 - line 24, column 30: " + [ v.constructor.name ]);
                              });
                          };
                          throw new Error("Failed pattern match at FriendInDebt.Blockchain line 15, column 3 - line 24, column 30: " + [ errorBus.constructor.name ]);
                      };
                  };
              };
          };
...
(function(exports) {
  ...
  var InputDebtAmount = (function () {
      function InputDebtAmount(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      InputDebtAmount.create = function (value0) {
          return function (value1) {
              return new InputDebtAmount(value0, value1);
          };
      };
      return InputDebtAmount;
  })();
  var InputCreditAmount = (function () {
      function InputCreditAmount(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      InputCreditAmount.create = function (value0) {
          return function (value1) {
              return new InputCreditAmount(value0, value1);
          };
      };
      return InputCreditAmount;
  })();
  var InputDebtDetails = (function () {
      function InputDebtDetails(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      InputDebtDetails.create = function (value0) {
          return function (value1) {
              return new InputDebtDetails(value0, value1);
          };
      };
      return InputDebtDetails;
  })();
  var InputCreditDetails = (function () {
      function InputCreditDetails(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      InputCreditDetails.create = function (value0) {
          return function (value1) {
              return new InputCreditDetails(value0, value1);
          };
      };
      return InputCreditDetails;
  })();
  ...
  var showDebtType = new Data_Show.Show(function (debtType) {
      ...
      throw new Error("Failed pattern match at Debts line 582, column 3 - line 586, column 1: " + [ debtType.constructor.name ]);
  });
                                      ...
                                      return Control_Bind.bind(dictBind)(FriendInDebt_Blockchain.handleCall(dictBind)(dictMonadEff)(dictMonadAff)(errorBus)(Network_Eth_FriendInDebt_Types.blankPendingDebts)(Network_Eth_FriendInDebt.pendingDebts))(function (v3) {
                                          return Control_Bind.bind(dictBind)(FriendInDebt_Blockchain.handleCall(dictBind)(dictMonadEff)(dictMonadAff)(errorBus)([  ])(Network_Eth_FriendInDebt.debtBalances))(function (v4) {
                                              return Control_Monad_State_Class.modify(dictMonadState)(function (v5) {
                                                  var $56 = {};
                                                  for (var $57 in v5) {
                                                      if ({}.hasOwnProperty.call(v5, $57)) {
                                                          $56[$57] = v5[$57];
                                                      };
                                                  };
                                                  $56.myId = v;
                                                  $56.friends = v1;
                                                  $56.pendingFriendsSent = Network_Eth_FriendInDebt_Types.pfGetSents(v2);
                                                  $56.pendingFriendsTodo = Network_Eth_FriendInDebt_Types.pfGetTodos(v2);
                                                  $56.pendingSent = Network_Eth_FriendInDebt_Types.pdGetSents(v3);
                                                  $56.pendingTodo = Network_Eth_FriendInDebt_Types.pdGetTodos(v3);
                                                  $56.balances = v4;
                                                  $56.loading = false;
                                                  return $56;
                                              });
          ...
          return function (myId) {
              return function (friends) {
                  return function (maybeDebt) {
                      var whole = function ($157) {
                          return Network_Eth_FriendInDebt_Types.moneyWhole(Network_Eth_FriendInDebt_Types.debtMoney($157));
                      };
                      var decs = function ($158) {
                          return Network_Eth_FriendInDebt_Types.moneyDecimals(Network_Eth_FriendInDebt_Types.debtMoney($158));
                      };
                      var counterparty = function (debt) {
                          return function (dType) {
                              return function (v) {
                                  if (dType instanceof Debt) {
                                      return Network_Eth_FriendInDebt_Types.debtSetCreditor(debt)(Network_Eth_Foundation.fiMkId(v));
                                  };
                                  if (dType instanceof Credit) {
                                      return Network_Eth_FriendInDebt_Types.debtSetDebtor(debt)(Network_Eth_Foundation.fiMkId(v));
                                  };
                                  throw new Error("Failed pattern match at Debts line 637, column 41 - line 639, column 59: " + [ dType.constructor.name ]);
                              };
                          };
                      };
                      var v = Data_Array.head(friends);
                      if (v instanceof Data_Maybe.Nothing) {
                      ...
                      if (v instanceof Data_Maybe.Just) {
                          var handler$prime = (function () {
                              if (debtType instanceof Debt) {
                                  return InputDebtDetails.create;
                              };
                              if (debtType instanceof Credit) {
                                  return InputCreditDetails.create;
                              };
                              throw new Error("Failed pattern match at Debts line 598, column 22 - line 599, column 66: " + [ debtType.constructor.name ]);
                          })();
                          var handler = (function () {
                              if (debtType instanceof Debt) {
                                  return InputDebtAmount.create;
                              };
                              if (debtType instanceof Credit) {
                                  return InputCreditAmount.create;
                              };
                              throw new Error("Failed pattern match at Debts line 596, column 21 - line 597, column 64: " + [ debtType.constructor.name ]);
                          })();
                          var d = (function () {
                              if (debtType instanceof Debt) {
                                  return Data_Maybe.fromMaybe(Network_Eth_FriendInDebt_Types.zeroDebt(cur)(myId)(v.value0)(v.value0))(maybeDebt);
                              };
                              if (debtType instanceof Credit) {
                                  return Data_Maybe.fromMaybe(Network_Eth_FriendInDebt_Types.zeroDebt(cur)(v.value0)(myId)(v.value0))(maybeDebt);
                              };
                              throw new Error("Failed pattern match at Debts line 593, column 15 - line 595, column 81: " + [ debtType.constructor.name ]);
                          })();
                          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("create-debt col") ])([ Halogen_HTML_Elements.label_([ Halogen_HTML_Core.text("Enter " + Data_Show.show(showDebtType)(debtType)) ]), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputText.value), Halogen_HTML_Properties.class_("debt-amount"), Halogen_HTML_Properties.value(Data_Show.show(Data_Show.showInt)(whole(d))), Halogen_HTML_Events.onValueInput(Halogen_HTML_Events.input(function (v1) {
                              return handler({
                                  whole: Data_Maybe.fromMaybe(0)(Data_Int.fromString(v1)), 
                                  decs: decs(d), 
                                  debt: d
                              });
                          })) ]), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputText.value), Halogen_HTML_Properties.class_("debt-amount"), Halogen_HTML_Properties.value(Data_Show.show(Data_Show.showInt)(decs(d))), Halogen_HTML_Events.onValueInput(Halogen_HTML_Events.input(function (v1) {
                              return handler({
                                  whole: whole(d), 
                                  decs: Data_Maybe.fromMaybe(0)(Data_Int.fromString(Data_String.take(2)(v1))), 
                                  debt: d
                              });
                          })) ]), Halogen_HTML_Elements.select([ Halogen_HTML_Events.onValueChange(Halogen_HTML_Events.input(function (v1) {
                              return handler$prime(counterparty(d)(debtType)(v1));
  ...
  var idSpan = function (me) {
      return function (idToDisplay) {
          ...
          throw new Error("Failed pattern match at Debts line 512, column 6 - line 514, column 167: " + [ isItMe.constructor.name ]);
      };
  };
  ...
  var displayItemizedDebtTimeline = function (friendToShow) {
      return function (debtsMap) {
          return function (curFriend) {
              ...
              throw new Error("Failed pattern match at Debts line 280, column 3 - line 290, column 37: " + [ friendToShow.constructor.name ]);
          };
      };
  };
  var displayBalanceLi = function (state) {
      return function (v) {
          var status = (function () {
              var $86 = Data_Eq.eq(Network_Eth_Foundation.eqFoundationId)(v.creditor)(state.myId);
              if ($86) {
          ...
          var curFriend = (function () {
              var $87 = Data_Eq.eq(Network_Eth_Foundation.eqFoundationId)(v.creditor)(state.myId);
              if ($87) {
                  return v.debtor;
              };
              return v.creditor;
      ...
      var $$eval = function (v) {
                  ...
                  if (v.value0 instanceof Data_Maybe.Just) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                              ...
                              $92.loading = true;
                              $92.showItemizedDebtFor = v.value0;
                              return $92;
                          }))(function () {
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(FriendInDebt_Blockchain.handleCall(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(v1.errorBus)([  ])(Network_Eth_FriendInDebt.itemizedDebts(v.value0.value0)))(function (v2) {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                                      ...
                                      $96.loading = false;
                                      $96.itemizedDebts = Data_Map.insert(Network_Eth_Foundation.ordFoundationId)(v.value0.value0)(v2)(v1.itemizedDebts);
                                      return $96;
                                  }))(function () {
                                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                                  });
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(FriendInDebt_Prelude.hLog(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Data_Either.showEither(Data_Show.showString)(Network_Eth_Foundation.showFoundationId))(v.value0))(function () {
                      ...
                      if (v.value0 instanceof Data_Either.Right) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                              ...
                              $116.newFriend = new Data_Either.Left("");
                              return $116;
                          }))(function () {
          ...
          if (v instanceof InputFriend) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                  var $122 = Data_String.length(v.value0) > 3;
                  if ($122) {
                      return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                          ...
                          $123.newFriend = Data_Either.Right.create(v.value0);
                          return $123;
                      });
                  };
                  return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                      ...
                      $126.newFriend = new Data_Either.Left(v.value0);
                      return $126;
                  });
              })())(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
          ...
          if (v instanceof InputDebtAmount) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  var m = Network_Eth_FriendInDebt_Types.moneyFromDecString(v1)(Data_Show.show(Data_Show.showInt)(v.value0.whole) + ("." + Data_Show.show(Data_Show.showInt)(v.value0.decs)));
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                      var $132 = {};
                      for (var $133 in v2) {
                      ...
                      $132.newDebt = Data_Maybe.Just.create(Network_Eth_FriendInDebt_Types.setDebtMoney(v.value0.debt)(m));
                      return $132;
                  }))(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                  });
          ...
          if (v instanceof InputCreditAmount) {
              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
          };
          ...
          if (v instanceof InputCreditDetails) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(FriendInDebt_Prelude.hLog(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Network_Eth_FriendInDebt_Types.showDebt)(v.value0))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
              });
          };
                  ...
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(FriendInDebt_Blockchain.handleTx(Control_Monad_Aff.monadEffAff)(Control_Monad_Aff_Class.monadAffAff)(NewTX.create)(v1)(Network_Eth_FriendInDebt.newPendingDebt(v.value0)))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                              ...
                              $144.newDebt = Data_Maybe.Nothing.value;
                              $144.newCredit = Data_Maybe.Nothing.value;
                              return $144;
                          }))(function () {
                              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                          });
          ...
          throw new Error("Failed pattern match at Debts line 129, column 10 - line 197, column 16: " + [ v.constructor.name ]);
      };
  ...
  exports["InputCreditAmount"] = InputCreditAmount;
  exports["InputDebtDetails"] = InputDebtDetails;
  exports["InputCreditDetails"] = InputCreditDetails;
...
(function(exports) {
      ...
      return function (dictMonadAff) {
          return Control_Bind.discard(Control_Bind.discardUnit)(dictBind)(Control_Bind.bind(dictBind)(Control_Monad_Aff_Class.liftAff(dictMonadAff)(Network_Eth_FriendInDebt.runMonadF(Network_Eth_FriendInDebt.foundationId)))(FriendInDebt_Prelude.hLog(dictMonadAff.MonadEff0())(Data_Either.showEither(Network_Eth_FriendInDebt_Types.showError)(Network_Eth_Foundation.showFoundationId))))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(dictBind)(Control_Bind.bind(dictBind)(Control_Monad_Aff_Class.liftAff(dictMonadAff)(Network_Eth_FriendInDebt.runMonadF(Network_Eth_FriendInDebt.confirmedFriends)))(FriendInDebt_Prelude.hLog(dictMonadAff.MonadEff0())(Data_Either.showEither(Network_Eth_FriendInDebt_Types.showError)(Data_Show.showArray(Network_Eth_Foundation.showFoundationId)))))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(dictBind)(Control_Bind.bind(dictBind)(Control_Monad_Aff_Class.liftAff(dictMonadAff)(Network_Eth_FriendInDebt.runMonadF(Network_Eth_FriendInDebt.pendingFriends)))(FriendInDebt_Prelude.hLog(dictMonadAff.MonadEff0())(Data_Either.showEither(Network_Eth_FriendInDebt_Types.showError)(Network_Eth_FriendInDebt_Types.showPendingFriendships))))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(dictBind)(Control_Bind.bind(dictBind)(Control_Monad_Aff_Class.liftAff(dictMonadAff)(Network_Eth_FriendInDebt.runMonadF(Network_Eth_FriendInDebt.pendingDebts)))(FriendInDebt_Prelude.hLog(dictMonadAff.MonadEff0())(Data_Either.showEither(Network_Eth_FriendInDebt_Types.showError)(Network_Eth_FriendInDebt_Types.showPendingDebts))))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(dictBind)(Control_Bind.bind(dictBind)(Control_Monad_Aff_Class.liftAff(dictMonadAff)(Network_Eth_FriendInDebt.runMonadF(Network_Eth_FriendInDebt.debtBalances)))(FriendInDebt_Prelude.hLog(dictMonadAff.MonadEff0())(Data_Either.showEither(Network_Eth_FriendInDebt_Types.showError)(Data_Show.showArray(Network_Eth_FriendInDebt_Types.showBalance)))))(function () {
  ...
  var menuItem = function (screen) {
      return function (currentScreen) {
          return Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href("#"), Halogen_HTML_Properties.class_(Halogen_HTML_Core.ClassName("col-3 " + (function () {
              var $43 = Data_Eq.eq(FriendInDebt_Routes.eqScreen)(screen)(currentScreen);
              if ($43) {
                  return "active";
              };
              return "";
  ...
  var ui = (function () {
      var render = function (state) {
          ...
          })())))) ])([ promptMetamask(state.loggedIn), loadingOverlay(state.loading), topBar(state), menu(state.currentScreen), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("create-debt-bar") ])([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href("#"), Halogen_HTML_Properties.class_(""), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(SetScreen.create(FriendInDebt_Routes.CreateDebtScreen.value))) ])([ Halogen_HTML_Elements.i([ Halogen_HTML_Properties.class_("fa fa-plus") ])([  ]) ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("add-friend-bar") ])([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href("#"), Halogen_HTML_Properties.class_(""), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(SetScreen.create(FriendInDebt_Routes.AddFriendScreen.value))) ])([ Halogen_HTML_Elements.i([ Halogen_HTML_Properties.class_("fa fa-plus") ])([  ]) ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("row") ])([ Halogen_HTML["slot'"](Halogen_Component_ChildPath.cp1)(Data_Unit.unit)(Debts.component)(state.errorBus)(Halogen_HTML_Events.input(DebtViewMsg.create)) ]) ]);
      };
      var initialState = {
          loggedIn: true, 
          loading: true, 
      ...
      var $$eval = function (v) {
              ...
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(Control_Monad_Aff_Bus.make))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.subscribe(Halogen_Component_Utils.busEventSource(Control_Monad_Aff_Class.monadAffAff)(Data_Function.flip(HandleMsg.create)(Halogen_Query_EventSource.Listening.value))(v1)))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                          ...
                          $50.loggedIn = true;
                          $50.loading = true;
                          $50.errorBus = new Data_Maybe.Just(v1);
                          return $50;
                      }))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(Control_Monad_Aff.delay(Data_Int.toNumber(1500))))(function () {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                                  ...
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(refreshMetamask)(function () {
                                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(runTests(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff)))(function () {
          ...
          if (v instanceof HandleMsg) {
              ...
              throw new Error("Failed pattern match at Container line 110, column 9 - line 118, column 22: " + [ v.value0.constructor.name ]);
          };
          ...
          if (v instanceof SetScreen) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                  ...
                  $67.history = Data_Semigroup.append(Data_Semigroup.semigroupArray)([ state.currentScreen ])(state.history);
                  return $67;
              }))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                      var $70 = {};
          ...
          if (v instanceof DebtViewMsg) {
              if (v.value0 instanceof Debts.ScreenChange) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                      ...
                      $76.history = Data_Semigroup.append(Data_Semigroup.semigroupArray)([ state.currentScreen ])(state.history);
                      return $76;
                  }))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                          var $79 = {};
                          ...
                          $79.currentScreen = v.value0.value0;
                          return $79;
                      }))(function () {
                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                      });
              ...
              if (v.value0 instanceof Debts.NewTX) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (s) {
                      ...
                      $83.txs = Data_Semigroup.append(Data_Semigroup.semigroupArray)(s.txs)([ v.value0.value0 ]);
                      return $83;
                  }))(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                  });
              };
              throw new Error("Failed pattern match at Container line 127, column 9 - line 134, column 22: " + [ v.value0.constructor.name ]);
          };
          if (v instanceof PreviousScreen) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                  ...
                  $89.currentScreen = Data_Maybe.fromMaybe(FriendInDebt_Routes.BalancesScreen.value)(Data_Array.head(state.history));
                  $89.history = Data_Maybe.fromMaybe([  ])(Data_Array.tail(state.history));
                  return $89;
              }))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
              });
          };
          throw new Error("Failed pattern match at Container line 98, column 12 - line 137, column 18: " + [ v.constructor.name ]);
      };
