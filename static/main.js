...
(function(exports) {
  ...
  var showMoney = new Data_Show.Show(function (v) {
      return (function () {
          var $48 = v.amount < Data_Int.toNumber(0);
          if ($48) {
              return "-";
          };
          return "";
  ...
  var setDebtAmount = function (v) {
      return function (val) {
          return Debt((function () {
              ...
              $108.debt = mkMoney(val)(moneyCurrency(debtMoney(v)));
              return $108;
          })());
      };
  };
  var debtCounterparty = function (myId) {
      return function (v) {
          var $113 = Data_Eq.eq(Network_Eth_Foundation.eqFoundationId)(v.debtor)(myId);
          if ($113) {
              return v.creditor;
          };
          return v.debtor;
  ...
  var pendingDebts = Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Aff.monadAff))(foundationId)(function (v) {
      return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Aff.monadAff))(Control_Monad_Aff_Class.liftAff(Control_Monad_Aff_Class.monadAffExceptT(Control_Monad_Aff_Class.monadAffAff))(Control_Monad_Aff.makeAff(function (err) {
          ...
          var sent = function ($85) {
              ...
              })(Data_Functor.map(Data_Functor.functorArray)(Network_Eth_FriendInDebt_Types.rawToDebt)($85));
          };
          var todo = function ($86) {
              return Data_Array.filter(function (d) {
...
(function(exports) {
                  ...
                  return function (maybeDebt) {
                      var counterparty = function (debt) {
                          return function (debtType1) {
                              return function (v) {
                                  ...
                                  throw new Error("Failed pattern match at Debts line 493, column 44 - line 495, column 59: " + [ debtType1.constructor.name ]);
                              };
                          };
                      };
                      ...
                      if (v instanceof Data_Maybe.Just) {
                          var handler = (function () {
                              ...
                              throw new Error("Failed pattern match at Debts line 468, column 21 - line 469, column 58: " + [ debtType.constructor.name ]);
                          })();
                          var d = (function () {
                              if (debtType instanceof Debt) {
                              ...
                              throw new Error("Failed pattern match at Debts line 465, column 15 - line 467, column 81: " + [ debtType.constructor.name ]);
                          })();
                          ...
                          })(friends)), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputText.value), Halogen_HTML_Properties.placeholder("debt description"), Halogen_HTML_Events.onValueInput(Halogen_HTML_Events.input(function (val) {
                              return handler(Network_Eth_FriendInDebt_Types.setDesc(d)(Data_String.take(32)(val)));
                          })), Halogen_HTML_Properties.value(Network_Eth_FriendInDebt_Types.getDesc(d)) ]), Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(AddDebt.create(d))), Halogen_HTML_Properties.class_("create-debt-button col-2") ])([ Halogen_HTML_Core.text("Debt " + Data_Show.show(Data_Maybe.showMaybe(Network_Eth_Foundation.showFoundationId))(Data_Functor.map(Data_Maybe.functorMaybe)(Network_Eth_FriendInDebt_Types.debtCounterparty(myId))(maybeDebt))) ]) ]);
                      };
                      throw new Error("Failed pattern match at Debts line 462, column 3 - line 491, column 11: " + [ v.constructor.name ]);
                  };
              };
          };
      };
  ...
  var idSpan = function (me) {
      return function (idToDisplay) {
          ...
          throw new Error("Failed pattern match at Debts line 381, column 6 - line 383, column 125: " + [ isItMe.constructor.name ]);
      };
  };
                      ...
                      return function (fidAffCall) {
                          ...
                          if (errorBus instanceof Data_Maybe.Just) {
                              return Control_Bind.bind(dictBind)(Control_Monad_Aff_Class.liftAff(dictMonadAff)(Network_Eth_FriendInDebt.runMonadF(fidAffCall)))(function (v) {
                                  ...
                                  throw new Error("Failed pattern match at Debts line 513, column 7 - line 516, column 30: " + [ v.constructor.name ]);
                              });
                          };
                          throw new Error("Failed pattern match at Debts line 507, column 3 - line 516, column 30: " + [ errorBus.constructor.name ]);
                      };
                  };
              };
          };
  ...
  var component = (function () {
      ...
      var $$eval = function (v) {
          ...
          throw new Error("Failed pattern match at Debts line 159, column 10 - line 210, column 16: " + [ v.constructor.name ]);
      };
      ...
      var $$eval = function (v) {
          ...
          if (v instanceof ShowPreviousScreen) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                  ...
                  $76.currentScreen = state.previousScreen;
                  return $76;
              }))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
              });
