...
(function(exports) {
  ...
  var showDebtType = new Data_Show.Show(function (debtType) {
      ...
      throw new Error("Failed pattern match at Debts line 659, column 3 - line 663, column 1: " + [ debtType.constructor.name ]);
  });
              ...
              return function (friends) {
                  return function (debtInfo) {
                      ...
                      var getDebtor = function (debtType1) {
                          return function (me) {
                              return function (friend) {
                                  ...
                                  throw new Error("Failed pattern match at Debts line 712, column 40 - line 714, column 26: " + [ debtType1.constructor.name ]);
                              };
                          };
                      };
                      var getCreditor = function (debtType1) {
                          return function (me) {
                              return function (friend) {
                                  ...
                                  throw new Error("Failed pattern match at Debts line 715, column 42 - line 717, column 22: " + [ debtType1.constructor.name ]);
                              };
                          };
                      };
                      ...
                      var sendMsg = (function () {
                          ...
                          throw new Error("Failed pattern match at Debts line 668, column 18 - line 670, column 3: " + [ debtType.constructor.name ]);
                      })();
  ...
  var idSpan = function (me) {
      return function (idToDisplay) {
          ...
          throw new Error("Failed pattern match at Debts line 584, column 6 - line 586, column 167: " + [ isItMe.constructor.name ]);
      };
  };
  ...
  var itemizedDebtLi = function (amIcreditor) {
      return function (fd) {
