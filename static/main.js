...
(function(exports) {
  ...
  var mockMe = "lukezhang";
  var mockFriends = [ "jaredbowie", "TimTime", "chinmich", "tom", "aki", "brad" ];
  var mockFoundationId = "snoopy";
  var mockDebt = function (fid) {
      return Network_Eth_FriendInDebt_Types.mkDebt(mockFoundationId)(fid)(fid)(Network_Eth_FriendInDebt_Types.moneyFromDecString("2.0")(Network_Eth_FriendInDebt_Types.cUSD))(Network_Eth_FriendInDebt_Types.NoDebtId.value)("Dinner @ KRBB");
  };
                  ...
                  return function (maybeDebt) {
                      ...
                      var counterparty = function (debt) {
                          return function (dType) {
                              return function (v) {
                                  ...
                                  throw new Error("Failed pattern match at Debts line 588, column 41 - line 590, column 59: " + [ dType.constructor.name ]);
                              };
                          };
                      };
                      ...
                      if (v instanceof Data_Maybe.Just) {
                          var handler = (function () {
                              ...
                              throw new Error("Failed pattern match at Debts line 560, column 21 - line 561, column 58: " + [ debtType.constructor.name ]);
                          })();
                          var d = (function () {
                              if (debtType instanceof Debt) {
                              ...
                              throw new Error("Failed pattern match at Debts line 557, column 15 - line 559, column 81: " + [ debtType.constructor.name ]);
                          })();
                      ...
                      throw new Error("Failed pattern match at Debts line 554, column 3 - line 584, column 11: " + [ v.constructor.name ]);
                  };
              };
          };
      };
  ...
  var idSpan = function (me) {
      return function (idToDisplay) {
          ...
          throw new Error("Failed pattern match at Debts line 483, column 6 - line 485, column 167: " + [ isItMe.constructor.name ]);
      };
  };
  ...
  var fakeFriend2 = "timtime";
  var mockBalance2 = {
      debtor: mockMe, 
      creditor: fakeFriend2, 
      amount: {
          amount: 15.0, 
          currency: Network_Eth_FriendInDebt_Types.cUSD
      }, 
      totalDebts: 13, 
      mostRecent: Data_Maybe.Nothing.value
  };
  var fakeFriend = "jaredbowie";
  var mockBalance = {
      debtor: mockMe, 
      creditor: fakeFriend, 
      amount: {
  ...
  var fakeDebt = mockDebt("bob");
  var fakeDebts = [ fakeDebt, fakeDebt ];
  var displayTodoFriend = function (friend) {
      return [ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("row friend-details row align-items-center") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("col") ])([ Halogen_HTML_Core.text("Friend Request From:" + Data_Show.show(Network_Eth_Foundation.showFoundationId)(friend)) ]) ]) ];
  };
  var displaySentFriend = function (friend) {
      return [ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("row friend-details align-items-center") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("col") ])([ Halogen_HTML_Core.text("Sent Friend Request to:" + Data_Show.show(Network_Eth_Foundation.showFoundationId)(friend)) ]) ]) ];
  };
  ...
  var displaySentFriendLi = function (friend) {
      return Halogen_HTML_Elements.li([ Halogen_HTML_Properties.class_("sent-friend-row row align-items-center") ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)(cardHeader("Waiting for response:"))(displaySentFriend(friend)));
  };
  var displaySentFriendsList = function (friends) {
      return Halogen_HTML_Elements.ul_(Data_Functor.map(Data_Functor.functorArray)(displaySentFriendLi)(friends));
  };
  var displayTodoFriendLi = function (friend) {
      return Halogen_HTML_Elements.li([ Halogen_HTML_Properties.class_("todo-friend-row row align-items-center") ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Semigroup.append(Data_Semigroup.semigroupArray)(cardHeader("Respond to Request:"))(displayTodoFriend(friend)))([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("row action-buttons row align-items-center") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("col") ])([ confirmFriendshipButton(friend) ]) ]) ]));
  };
  var displayTodoFriendsList = function (friends) {
      return Halogen_HTML_Elements.ul_(Data_Functor.map(Data_Functor.functorArray)(displayTodoFriendLi)(friends));
  };
  ...
  var component = (function () {
      ...
      var $$eval = function (v) {
          if (v instanceof ShowItemizedDebtFor) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.raise(new ScreenChange("show-itemized-debt")))(function () {
                  ...
                  throw new Error("Failed pattern match at Debts line 170, column 7 - line 178, column 20: " + [ v.value0.constructor.name ]);
              });
          };
          ...
          if (v instanceof AddFriend) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(FriendInDebt_Prelude.hLog(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Data_Either.showEither(Data_Show.showString)(Network_Eth_Foundation.showFoundationId))(v.value0))(function () {
                      ...
                      throw new Error("Failed pattern match at Debts line 196, column 7 - line 201, column 20: " + [ v.value0.constructor.name ]);
                  });
              });
          };
          ...
          throw new Error("Failed pattern match at Debts line 166, column 10 - line 231, column 16: " + [ v.constructor.name ]);
      };
  ...
  exports["fakeDebt"] = fakeDebt;
  exports["fakeDebts"] = fakeDebts;
  exports["fakeFriend"] = fakeFriend;
  exports["fakeFriend2"] = fakeFriend2;
  ...
  exports["mockBalance2"] = mockBalance2;
  exports["mockDebt"] = mockDebt;
  exports["mockFoundationId"] = mockFoundationId;
...
(function(exports) {
  ...
  var ShowPreviousScreen = (function () {
      function ShowPreviousScreen(value0) {
          this.value0 = value0;
      };
      ShowPreviousScreen.create = function (value0) {
          return new ShowPreviousScreen(value0);
      };
          ...
          return function (dictMonadEff) {
              return function (maybeBus) {
                  return function (ms) {
                      ...
                      throw new Error("Failed pattern match at Container line 179, column 3 - line 183, column 16: " + [ maybeBus.constructor.name ]);
                  };
              };
          };
      };
  ...
  var ui = (function () {
      var render = function (state) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.id_("container"), Halogen_HTML_Properties.class_(Halogen_HTML_Core.ClassName("container " + (state.currentScreen + (function () {
              if (state.loading) {
                  return " loading";
              };
              return "";
          })()))) ])([ promptMetamask(state.loggedIn), loadingOverlay(state.loading), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.id_("back-nav-bar"), Halogen_HTML_Properties.class_("row back-nav-bar") ])([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href("#"), Halogen_HTML_Properties.class_("close-pop-button"), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(ShowPreviousScreen.create)) ])([ Halogen_HTML_Elements.i([ Halogen_HTML_Properties.class_("fa fa-chevron-left") ])([  ]), Halogen_HTML_Core.text(" Back") ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.id_("home-bar"), Halogen_HTML_Properties.class_("row home-bar") ])([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href("#"), Halogen_HTML_Properties.class_("col home"), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(SetScreen.create("show-balances"))) ])([ Halogen_HTML_Elements.img([ Halogen_HTML_Properties.src("http://blockmason.io/assets/img/friends_in_debt_logo.svg") ]), Halogen_HTML_Core.text("Friend in Debt") ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.id_("header"), Halogen_HTML_Properties.class_("row") ])([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href("#"), Halogen_HTML_Properties.class_(Halogen_HTML_Core.ClassName("col-3 " + (function () {
              var $45 = state.currentScreen === "show-balances";
              if ($45) {
                  return "active";
              };
              return "";
          })())), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(SetScreen.create("show-balances"))) ])([ Halogen_HTML_Core.text("Balances") ]), Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href("#"), Halogen_HTML_Properties.class_(Halogen_HTML_Core.ClassName("col-3 " + (function () {
              var $46 = state.currentScreen === "show-friends";
              if ($46) {
                  return "active";
              };
              return "";
          })())), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(SetScreen.create("show-friends"))) ])([ Halogen_HTML_Core.text("Friends") ]), Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href("#"), Halogen_HTML_Properties.class_(Halogen_HTML_Core.ClassName("col-3 " + (function () {
              var $47 = state.currentScreen === "show-pending";
              if ($47) {
                  return "active";
              };
              return "";
          })())), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(SetScreen.create("show-pending"))) ])([ Halogen_HTML_Core.text("Pending") ]), Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href("#"), Halogen_HTML_Properties.class_(Halogen_HTML_Core.ClassName("col-3 " + (function () {
              var $48 = state.currentScreen === "show-settings";
              if ($48) {
                  return "active";
              };
              return "";
          })())), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(SetScreen.create("show-settings"))) ])([ Halogen_HTML_Core.text("Settings") ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("row create-debt-bar") ])([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href("#"), Halogen_HTML_Properties.class_(""), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(SetScreen.create("show-create-debt"))) ])([ Halogen_HTML_Elements.i([ Halogen_HTML_Properties.class_("fa fa-plus-circle") ])([  ]), Halogen_HTML_Core.text(" Create Debt") ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("row add-friend-bar") ])([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href("#"), Halogen_HTML_Properties.class_(""), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(SetScreen.create("show-add-friend"))) ])([ Halogen_HTML_Elements.i([ Halogen_HTML_Properties.class_("fa fa-plus-circle") ])([  ]), Halogen_HTML_Core.text(" Add Friend") ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("row") ])([ Halogen_HTML["slot'"](Halogen_Component_ChildPath.cp1)(Data_Unit.unit)(Debts.component)(state.errorBus)(Halogen_HTML_Events.input(DebtViewMsg.create)) ]) ]);
      };
      var initialState = {
          loggedIn: true, 
          loading: true, 
      ...
      var $$eval = function (v) {
              ...
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(Control_Monad_Aff_Bus.make))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.subscribe(Halogen_Component_Utils.busEventSource(Control_Monad_Aff_Class.monadAffAff)(Data_Function.flip(HandleMsg.create)(Halogen_Query_EventSource.Listening.value))(v1)))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                          ...
                          $51.loggedIn = true;
                          $51.loading = true;
                          $51.errorBus = new Data_Maybe.Just(v1);
                          return $51;
                      }))(function () {
          ...
          if (v instanceof HandleMsg) {
              ...
              throw new Error("Failed pattern match at Container line 117, column 9 - line 125, column 22: " + [ v.value0.constructor.name ]);
          };
          ...
          if (v instanceof SetScreen) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                  ...
                  $68.previousScreen = state.currentScreen;
                  return $68;
              }))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                      var $71 = {};
          ...
          if (v instanceof DebtViewMsg) {
              if (v.value0 instanceof Debts.ScreenChange) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                      ...
                      $77.previousScreen = state.currentScreen;
                      return $77;
                  }))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                          var $80 = {};
                          ...
                          $80.currentScreen = v.value0.value0;
                          return $80;
                      }))(function () {
                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                      });
              ...
              if (v.value0 instanceof Debts.NewTX) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (s) {
                      ...
                      $84.txs = Data_Semigroup.append(Data_Semigroup.semigroupArray)(s.txs)([ v.value0.value0 ]);
                      return $84;
                  }))(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                  });
              };
              throw new Error("Failed pattern match at Container line 134, column 9 - line 141, column 22: " + [ v.value0.constructor.name ]);
          };
          if (v instanceof ShowPreviousScreen) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                  var $90 = {};
                  for (var $91 in state) {
                  ...
                  $90.currentScreen = state.previousScreen;
                  return $90;
              }))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
              });
          };
          throw new Error("Failed pattern match at Container line 105, column 12 - line 144, column 18: " + [ v.constructor.name ]);
      };
  ...
  exports["ShowPreviousScreen"] = ShowPreviousScreen;
