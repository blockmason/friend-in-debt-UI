              ...
              return function (maybeBus) {
                  return function (mmInterval) {
                      return function (txInterval) {
                          ...
                          throw new Error("Failed pattern match at Container line 208, column 3 - line 213, column 16: " + [ maybeBus.constructor.name ]);
                      };
                  };
              };
          };
  ...
  var ui = (function () {
      ...
      var $$eval = function (v) {
          ...
          if (v instanceof HandleMsg) {
                          ...
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(Data_Traversable.sequence(Data_Traversable.traversableArray)(Control_Monad_Aff.applicativeAff)(Data_Functor.map(Data_Functor.functorArray)(Network_Eth_Metamask.checkTxStatus)(v1))))(function (v3) {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                                  ...
                                  if ($88) {
                                      ...
                                      throw new Error("Failed pattern match at Container line 138, column 20 - line 140, column 63: " + [ v2.constructor.name ]);
                                  };
              ...
              throw new Error("Failed pattern match at Container line 115, column 9 - line 148, column 22: " + [ v.value0.constructor.name ]);
          };
          ...
          if (v instanceof DebtViewMsg) {
              ...
              throw new Error("Failed pattern match at Container line 157, column 9 - line 164, column 22: " + [ v.value0.constructor.name ]);
          };
          ...
          throw new Error("Failed pattern match at Container line 103, column 12 - line 167, column 18: " + [ v.constructor.name ]);
      };
