...
(function(exports) {
                  ...
                  return function (maybeDebt) {
                      var counterparty = function (debt) {
                          return function (debtType1) {
                              return function (v) {
                                  ...
                                  throw new Error("Failed pattern match at Debts line 482, column 44 - line 484, column 59: " + [ debtType1.constructor.name ]);
                              };
                          };
                      };
                      ...
                      if (v instanceof Data_Maybe.Just) {
                          var d = (function () {
                              ...
                              throw new Error("Failed pattern match at Debts line 458, column 15 - line 460, column 81: " + [ debtType.constructor.name ]);
                          })();
                          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("createDebt col row") ])([ Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputNumber.value), Halogen_HTML_Properties.class_("debt-amount col-2"), Halogen_HTML_Properties.value(Data_Show.show(Data_Show.showNumber)(Network_Eth_FriendInDebt_Types.numAmount(Network_Eth_FriendInDebt_Types.debtMoney(d)))), Halogen_HTML_Events.onValueInput(Halogen_HTML_Events.input(function (val) {
                              return InputDebt.create(amount(d)(val));
                          })), Halogen_HTML_Properties.min(Data_Int.toNumber(-1000000 | 0)), Halogen_HTML_Properties.max(Data_Int.toNumber(1000000)) ]), Halogen_HTML_Elements.select_(Data_Functor.map(Data_Functor.functorArray)(function (f) {
                              ...
                              return InputDebt.create(Network_Eth_FriendInDebt_Types.setDesc(d)(Data_String.take(32)(val)));
                      ...
                      throw new Error("Failed pattern match at Debts line 455, column 3 - line 480, column 11: " + [ v.constructor.name ]);
                  };
              };
          };
      };
  ...
  var idSpan = function (me) {
      return function (idToDisplay) {
          ...
          throw new Error("Failed pattern match at Debts line 374, column 6 - line 376, column 125: " + [ isItMe.constructor.name ]);
      };
  };
                      ...
                      return function (fidAffCall) {
                          ...
                          if (errorBus instanceof Data_Maybe.Just) {
                              return Control_Bind.bind(dictBind)(Control_Monad_Aff_Class.liftAff(dictMonadAff)(Network_Eth_FriendInDebt.runMonadF(fidAffCall)))(function (v) {
                                  ...
                                  throw new Error("Failed pattern match at Debts line 502, column 7 - line 505, column 30: " + [ v.constructor.name ]);
                              });
                          };
                          throw new Error("Failed pattern match at Debts line 496, column 3 - line 505, column 30: " + [ errorBus.constructor.name ]);
                      };
                  };
              };
          };
  ...
  var component = (function () {
      ...
      var $$eval = function (v) {
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(FriendInDebt_Prelude.hLog(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Data_Either.showEither(Data_Show.showString)(Network_Eth_Foundation.showFoundationId))(v.value0))(function () {
                      ...
                      if (v.value0 instanceof Data_Either.Right) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                              ...
                              $86.newFriend = new Data_Either.Left("");
                              return $86;
                          }))(function () {
                      ...
                      throw new Error("Failed pattern match at Debts line 169, column 7 - line 174, column 20: " + [ v.value0.constructor.name ]);
                  });
              });
          };
          if (v instanceof InputFriend) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                  var $92 = Data_String.length(v.value0) > 3;
                  if ($92) {
                      return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                          ...
                          $93.newFriend = Data_Either.Right.create(v.value0);
                          return $93;
                      });
                  };
                  return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                      ...
                      $96.newFriend = new Data_Either.Left(v.value0);
                      return $96;
                  });
              })())(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
          ...
          throw new Error("Failed pattern match at Debts line 158, column 10 - line 203, column 16: " + [ v.constructor.name ]);
      };
