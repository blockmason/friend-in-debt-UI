...
(function(exports) {
  ...
  var printShortMonth = function (v) {
      ...
      throw new Error("Failed pattern match at Data.Formatter.DateTime line 440, column 19 - line 452, column 16: " + [ v.constructor.name ]);
  };                                                                                                                        
  var placeholderContent = Data_Functor.mapFlipped(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Data_Array.some(Text_Parsing_Parser.alternativeParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser.lazyParserT)(Text_Parsing_Parser_String.noneOf(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)(Data_String.toCharArray("YMDEHhamsS"))))(Data_String.fromCharArray);
  var padSingleDigit = function (i) {
      ...
      throw new Error("Failed pattern match at Data.Formatter.DateTime line 184, column 1 - line 186, column 23: " + [ i.constructor.name ]);
  };
  var padQuadrupleDigit = function (i) {
      ...
      throw new Error("Failed pattern match at Data.Formatter.DateTime line 195, column 1 - line 199, column 23: " + [ i.constructor.name ]);
  };
  var padDoubleDigit = function (i) {
      ...
      throw new Error("Failed pattern match at Data.Formatter.DateTime line 189, column 1 - line 192, column 23: " + [ i.constructor.name ]);
  };                        
  var formatterCommandParser = Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Data_Formatter_Parser_Utils.oneOfAs(Data_Functor.functorArray)(Data_Foldable.foldableArray)(Data_Identity.monadIdentity)(function ($439) {
      return Text_Parsing_Parser_Combinators["try"](Data_Identity.monadIdentity)(Text_Parsing_Parser_String.string(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)($439));
  })([ new Data_Tuple.Tuple("YYYY", YearFull.value), new Data_Tuple.Tuple("YY", YearTwoDigits.value), new Data_Tuple.Tuple("Y", YearAbsolute.value), new Data_Tuple.Tuple("MMMM", MonthFull.value), new Data_Tuple.Tuple("MMM", MonthShort.value), new Data_Tuple.Tuple("MM", MonthTwoDigits.value), new Data_Tuple.Tuple("DD", DayOfMonthTwoDigits.value), new Data_Tuple.Tuple("D", DayOfMonth.value), new Data_Tuple.Tuple("E", DayOfWeek.value), new Data_Tuple.Tuple("HH", Hours24.value), new Data_Tuple.Tuple("hh", Hours12.value), new Data_Tuple.Tuple("a", Meridiem.value), new Data_Tuple.Tuple("mm", MinutesTwoDigits.value), new Data_Tuple.Tuple("m", Minutes.value), new Data_Tuple.Tuple("ss", SecondsTwoDigits.value), new Data_Tuple.Tuple("s", Seconds.value), new Data_Tuple.Tuple("SSS", Milliseconds.value), new Data_Tuple.Tuple("SS", MillisecondsTwoDigits.value), new Data_Tuple.Tuple("S", MillisecondsShort.value) ]))(Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Placeholder.create)(placeholderContent));
  ...
  var formatCommand = function (v) {
      return function (v1) {
          ...
          if (v1 instanceof Meridiem) {
              var $345 = Data_Enum.fromEnum(Data_Time_Component.boundedEnumHour)(Data_Time.hour(v.value1)) >= 12;
              if ($345) {
                  return "PM";
              };
              return "AM";
          ...
          throw new Error("Failed pattern match at Data.Formatter.DateTime line 158, column 38 - line 179, column 20: " + [ v1.constructor.name ]);
      };
  };
...
(function(exports) {
  ...
  var hLog = function (dictMonadEff) {
      return function (dictShow) {
          return function ($11) {
              return Control_Monad_Eff_Class.liftEff(dictMonadEff)(Control_Monad_Eff_Console.logShow(dictShow)($11));
          };
      };
  };
  exports["hLog"] = hLog;
})(PS["FriendInDebt.Prelude"] = PS["FriendInDebt.Prelude"] || {});
(function(exports) {
    "use strict";
...
(function(exports) {
  ...
  var TX = (function () {
      ...
      TX.create = function (value0) {
          return new TX(value0);
      };
      return TX;
  })();
  ...
  var rawToTX = function (dictMonadError) {
      return function (errorVal) {
          return function (rawTx) {
              if (rawTx.error) {
                  return Control_Monad_Error_Class.throwError(dictMonadError.MonadThrow0())(errorVal);
              };
              return Control_Applicative.pure(((dictMonadError.MonadThrow0()).Monad0()).Applicative0())(TX.create(rawTx.txHash));
          };
      };
  };
  ...
  var eqEthAddress = new Data_Eq.Eq(function (v) {
      return function (v1) {
          return v === v1;
      };
  });
  var eaMkAddr = EthAddress;
  var blankTx = new TX("");
  ...
  exports["BadRaw"] = BadRaw;
  exports["NetworkError"] = NetworkError;
  exports["blankTx"] = blankTx;
  exports["eaMkAddr"] = eaMkAddr;
...
(function(exports) {
  ...
  var Prelude = PS["Prelude"];        
  var FoundationId = function (x) {
      return x;
  };
  var showFoundationId = new Data_Show.Show(function (v) {
      return v;
  });
  var initial = function (fid) {
      return Data_String.take(1)(Data_String.toLower(Data_Show.show(showFoundationId)(fid)));
  };
  var idRegex = Data_String_Regex_Unsafe.unsafeRegex("^([a-z]|\\d|-|\\.)+$")(Data_String_Regex_Flags.noFlags);
  var fiStrValidId = function (s) {
      return Data_String.length(s) > 3 && (Data_String.length(s) < 33 && Data_String_Regex.test(idRegex)(s));
  };
  ...
  var fiBlankId = "";
  var eqFoundationId = new Data_Eq.Eq(function (v) {
      return function (v1) {
          return v === v1;
      };
  });
  var ordFoundationId = new Data_Ord.Ord(function () {
      return eqFoundationId;
  }, function (v) {
      return function (v1) {
  ...
  exports["fiGetId"] = fiGetId;
  exports["fiMkId"] = fiMkId;
  exports["fiStrValidId"] = fiStrValidId;
  exports["initial"] = initial;
  exports["showFoundationId"] = showFoundationId;
  exports["eqFoundationId"] = eqFoundationId;
  exports["ordFoundationId"] = ordFoundationId;
...
(function(exports) {
  ...
  var hasWeb3 = $foreign.web3DefinedImpl(Data_Unit.unit);
  var getNetwork = Control_Monad_Aff_Class.liftAff(Control_Monad_Aff_Class.monadAffAff)(Control_Monad_Aff.makeAff(function (v) {
      return function (s) {
          return $foreign.getNetworkImpl(s);
      };
  }));
  var currentUserAddress = Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Aff.makeAff(function (v) {
      return function (s) {
          return $foreign.currentUserImpl(s);
      };
  }))(function (v) {
      return Control_Applicative.pure(Control_Monad_Aff.applicativeAff)(Network_Eth.eaMkAddr(v));
  });
  var checkTxStatus = function (tx) {
      return Data_Functor.map(Control_Monad_Aff.functorAff)(Network_Eth.rawToTxStatus)(Control_Monad_Aff_Class.liftAff(Control_Monad_Aff_Class.monadAffAff)(Control_Monad_Aff.makeAff(function (v) {
          return function (s) {
              return $foreign.checkTxStatusImpl(s)(Network_Eth.txStr(tx));
          };
      })));
  };
  var checkStatus = Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Aff.makeAff(function (v) {
      return function (s) {
          return $foreign.checkStatusImpl(s);
      };
  }))(function (v) {
      if (v) {
          return Control_Applicative.pure(Control_Monad_Aff.applicativeAff)(LoggedIn.value);
      };
      return Control_Applicative.pure(Control_Monad_Aff.applicativeAff)(LoggedOut.value);
  });
  var loggedIn = Control_Bind.bind(Control_Monad_Aff.bindAff)(checkStatus)(function (v) {
      ...
      throw new Error("Failed pattern match at Network.Eth.Metamask line 53, column 3 - line 55, column 26: " + [ v.constructor.name ]);
  });
...
(function(exports) {
  ...
  var DebtId = (function () {
      ...
      DebtId.create = function (value0) {
          return new DebtId(value0);
      };
      return DebtId;
  })();
  var NoDebtId = (function () {
      function NoDebtId() {

      };
      NoDebtId.value = new NoDebtId();
      return NoDebtId;
  })();
  ...
  var pfGetSents = function (v) {
      return v.sent;
  };
  var pdGetTodos = function (v) {
      return v.todo;
  };
  ...
  var moneyCurrency = function (v) {
      return v.currency;
  };
  var mkMoney = function (val) {
  ...
  var mkCurrency = function (isoCode) {
      return function (decimals) {
  ...
  var isValidDebtId = function (v) {
      if (v instanceof NoDebtId) {
          return false;
      };
      return true;
  }; 
  var getDesc = function (v) {
      return v.desc;
  };
  var getDebtId = function (v) {
      if (v instanceof DebtId) {
          return v.value0;
      };
      return -1.0;
  }; 
  var debtToConfirm = function (v) {
      return v.toConfirm;
  };
  var debtTimestamp = function (v) {
      return v.timestamp;
  };
  var debtMoney = function (v) {
      return v.debt;
  };
  var debtGetId = function (v) {
      return v.debtId;
  };
  var debtDebtor = function (v) {
      return v.debtor;
  };
  var debtCreditor = function (v) {
      return v.creditor;
  };
  var debtCounterparty = function (myId) {
      return function (v) {
          var $127 = Data_Eq.eq(Network_Eth_Foundation.eqFoundationId)(v.debtor)(myId);
          if ($127) {
              return v.creditor;
          };
          return v.debtor;
  ...
  var cSymbol = function (v) {
      if (v instanceof Currency) {
          return v.value0.symbol;
      };
      return "INVALID";
  };
  var cIsoCode = function (v) {
      if (v instanceof Currency) {
          return v.value0.isoCode;
      };
      return "INVALID";
  ...
  var fromIsoCode = function (v) {
      ...
      return InvalidCurrency.value;
  };
  var rawConfirmedToDebt = function (rd) {
      return {
          debtId: NoDebtId.value, 
          debtor: Network_Eth_Foundation.fiMkId(rd.debtor), 
          creditor: Network_Eth_Foundation.fiMkId(rd.creditor), 
      ...
      return function (rb) {
          var debtorCreditor = function (myId) {
              return function (cpId) {
                  return function (val) {
                      var $133 = val >= Data_Int.toNumber(0);
                      if ($133) {
          ...
          var v = debtorCreditor(fi)(rb.counterParty)(rb.amount);
          return {
              amount: mkMoney($$Math.abs(rb.amount))(fromIsoCode(rb.currency)), 
              debtor: v.value0, 
              creditor: v.value1, 
  ...
  var rawToDebt = function (rd) {
      return {
          debtId: new DebtId(rd.id), 
          debtor: rd.debtor, 
  ...
  var cDecimals = function (v) {
      if (v instanceof Currency) {
          return v.value0.decimals;
      };
      return 0;
  };
  var conversionFactor = function ($151) {
      return $$Math.pow(10.0)(Data_Int.toNumber(cDecimals($151)));
  };
  var moneyFromDecString = function (c) {
      return function (val) {
          return Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Number.fromString(val))(function (v) {
              var converted = Data_Int.toNumber(Data_Int.floor(conversionFactor(c) * v));
              return Control_Applicative.pure(Data_Maybe.applicativeMaybe)(mkMoney(converted)(c));
          });
      };
  };
  var formatMoney = function (m) {
      var c = moneyCurrency(m);
      var sym = cSymbol(c);
      return sym + Data_Format_Money.formatDecimal(numAmount(m) / conversionFactor(c))(cDecimals(c));
  };
  var showMoney = new Data_Show.Show(function (m) {
      return cIsoCode(moneyCurrency(m)) + (" " + formatMoney(m));
  });
  var showDebt = new Data_Show.Show(function (v) {
      return Data_Show.show(showMoney)(v.debt) + (": " + (Data_Show.show(Network_Eth_Foundation.showFoundationId)(v.debtor) + (" " + (Data_Show.show(Network_Eth_Foundation.showFoundationId)(v.creditor) + (" | " + Data_Show.show(Data_Show.showString)(v.desc))))));
  });
  var blankPendingFriends = {
      sent: [  ], 
      todo: [  ]
  };
  var blankPendingDebts = {
      sent: [  ], 
      todo: [  ]
  };
  var balTotalDebts = function (v) {
      return v.totalDebts;
  };
  var balMostRecent = function (v) {
      return v.mostRecent;
  };
  var balDebtor = function (v) {
      return v.debtor;
  };
  var balCreditor = function (v) {
      return v.creditor;
  };
  var balAmount = function (v) {
      return v.amount;
  };
  exports["Currency"] = Currency;
  exports["InvalidCurrency"] = InvalidCurrency;
  exports["DebtId"] = DebtId;
  exports["NoDebtId"] = NoDebtId;
  ...
  exports["balMostRecent"] = balMostRecent;
  exports["balTotalDebts"] = balTotalDebts;
  exports["blankPendingDebts"] = blankPendingDebts;
  exports["blankPendingFriends"] = blankPendingFriends;
  exports["cDecimals"] = cDecimals;
  exports["cEUR"] = cEUR;
  exports["cIsoCode"] = cIsoCode;
  exports["cSymbol"] = cSymbol;
  exports["cUSD"] = cUSD;
  exports["conversionFactor"] = conversionFactor;
  exports["debtCounterparty"] = debtCounterparty;
  exports["debtCreditor"] = debtCreditor;
  exports["debtDebtor"] = debtDebtor;
  exports["debtGetId"] = debtGetId;
  exports["debtMoney"] = debtMoney;
  exports["debtTimestamp"] = debtTimestamp;
  exports["debtToConfirm"] = debtToConfirm;
  exports["formatMoney"] = formatMoney;
  exports["fromIsoCode"] = fromIsoCode;
  exports["getDebtId"] = getDebtId;
  exports["getDesc"] = getDesc;
  exports["isValidDebtId"] = isValidDebtId;
  exports["mkCurrency"] = mkCurrency;
  exports["mkDebt"] = mkDebt;
  exports["mkMoney"] = mkMoney;
  exports["moneyCurrency"] = moneyCurrency;
  ...
  exports["showCurrency"] = showCurrency;
  exports["showMoney"] = showMoney;
  exports["showDebt"] = showDebt;
})(PS["Network.Eth.FriendInDebt.Types"] = PS["Network.Eth.FriendInDebt.Types"] || {});
(function(exports) {
  // Generated by purs version 0.11.5
  "use strict";
  var $foreign = PS["Network.Eth.FriendInDebt"];
  var Control_Applicative = PS["Control.Applicative"];
  var Control_Bind = PS["Control.Bind"];
  var Control_Monad_Aff = PS["Control.Monad.Aff"];
  var Control_Monad_Aff_Class = PS["Control.Monad.Aff.Class"];
  ...
  var Network_Eth = PS["Network.Eth"];
  var Network_Eth_Foundation = PS["Network.Eth.Foundation"];
  var Network_Eth_FriendInDebt_Types = PS["Network.Eth.FriendInDebt.Types"];
  var Network_Eth_Metamask = PS["Network.Eth.Metamask"];
  var Prelude = PS["Prelude"];        
  var runMonadF = Control_Monad_Except_Trans.runExceptT;
  var newPendingDebt = function (debt) {
      var m = Network_Eth_FriendInDebt_Types.debtMoney(debt);
      var debtor = Network_Eth_Foundation.fiGetId(Network_Eth_FriendInDebt_Types.debtDebtor(debt));
      var creditor = Network_Eth_Foundation.fiGetId(Network_Eth_FriendInDebt_Types.debtCreditor(debt));
      return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Aff.monadAff))(Control_Monad_Aff_Class.liftAff(Control_Monad_Aff_Class.monadAffExceptT(Control_Monad_Aff_Class.monadAffAff))(Control_Monad_Aff.makeAff(function (v) {
          return function (s) {
              return $foreign.newPendingDebtImpl(s)(debtor)(creditor)(Network_Eth_FriendInDebt_Types.numAmount(m))(Data_Show.show(Network_Eth_FriendInDebt_Types.showCurrency)(Network_Eth_FriendInDebt_Types.moneyCurrency(m)))(Network_Eth_FriendInDebt_Types.getDesc(debt));
          };
      })))(function (v) {
  ...
  var checkAndInit = Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Aff.monadAff))(Control_Monad_Aff_Class.liftAff(Control_Monad_Aff_Class.monadAffExceptT(Control_Monad_Aff_Class.monadAffAff))(Network_Eth_Metamask.loggedIn))(function (v) {
      if (v) {
  ...
  var confirmedFriends = Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Aff.monadAff))(foundationId)(function (v) {
      return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Aff.monadAff))(Control_Monad_Aff_Class.liftAff(Control_Monad_Aff_Class.monadAffExceptT(Control_Monad_Aff_Class.monadAffAff))(Control_Monad_Aff.makeAff(function (error) {
          return function (success) {
              return $foreign.friendsImpl(success)(v);
          };
      })))(function (v1) {
          return Control_Applicative.pure(Control_Monad_Except_Trans.applicativeExceptT(Control_Monad_Aff.monadAff))(Data_Functor.map(Data_Functor.functorArray)(Network_Eth_Foundation.FoundationId)(v1));
      });
  });
  var createFriendship = function (v) {
      return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Aff.monadAff))(foundationId)(function (v1) {
          return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Aff.monadAff))(Control_Monad_Aff_Class.liftAff(Control_Monad_Aff_Class.monadAffExceptT(Control_Monad_Aff_Class.monadAffAff))(Control_Monad_Aff.makeAff(function (e) {
              return function (s) {
                  return $foreign.createFriendshipImpl(s)(v1)(v);
              };
          })))(function (v2) {
              return Network_Eth.rawToTX(Control_Monad_Except_Trans.monadErrorExceptT(Control_Monad_Aff.monadAff))(Network_Eth_FriendInDebt_Types.TxError.value)(v2);
          });
      });
  };
  var debtBalances = Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Aff.monadAff))(foundationId)(function (v) {
      return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Aff.monadAff))(Control_Monad_Aff_Class.liftAff(Control_Monad_Aff_Class.monadAffExceptT(Control_Monad_Aff_Class.monadAffAff))(Control_Monad_Aff.makeAff(function (err) {
          return function (succ) {
              return $foreign.debtBalancesImpl(succ)(v);
          };
      })))(function (v1) {
  ...
  var deleteFriendship = function (v) {
      return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Aff.monadAff))(foundationId)(function (v1) {
          return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Aff.monadAff))(Control_Monad_Aff_Class.liftAff(Control_Monad_Aff_Class.monadAffExceptT(Control_Monad_Aff_Class.monadAffAff))(Control_Monad_Aff.makeAff(function (v2) {
              return function (s) {
                  return $foreign.deleteFriendshipImpl(s)(v1)(v);
              };
          })))(function (v2) {
              return Network_Eth.rawToTX(Control_Monad_Except_Trans.monadErrorExceptT(Control_Monad_Aff.monadAff))(Network_Eth_FriendInDebt_Types.TxError.value)(v2);
          });
  ...
  var handleDebt = function (handleDebtFn) {
          ...
          return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Aff.monadAff))(foundationId)(function (v) {
              ...
              if ($56) {
                  return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Aff.monadAff))(Control_Monad_Aff_Class.liftAff(Control_Monad_Aff_Class.monadAffExceptT(Control_Monad_Aff_Class.monadAffAff))(Control_Monad_Aff.makeAff(function (v1) {
                      ...
                      return Network_Eth.rawToTX(Control_Monad_Except_Trans.monadErrorExceptT(Control_Monad_Aff.monadAff))(Network_Eth_FriendInDebt_Types.TxError.value)(v1);
                  });
              };
              return Control_Monad_Error_Class.throwError(Control_Monad_Except_Trans.monadThrowExceptT(Control_Monad_Aff.monadAff))(Network_Eth_FriendInDebt_Types.InvalidDebtId.value);
          });
      };
  };
  var confirmPendingDebt = handleDebt($foreign.confirmDebtImpl);
  var rejectPendingDebt = handleDebt($foreign.rejectDebtImpl);
  var itemizedDebts = function (v) {
      return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Aff.monadAff))(foundationId)(function (v1) {
          return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Aff.monadAff))(Control_Monad_Aff_Class.liftAff(Control_Monad_Aff_Class.monadAffExceptT(Control_Monad_Aff_Class.monadAffAff))(Control_Monad_Aff.makeAff(function (e) {
              return function (s) {
                  return $foreign.itemizedDebtsImpl(s)(v1)(v);
              };
          })))(function (v2) {
              return Control_Applicative.pure(Control_Monad_Except_Trans.applicativeExceptT(Control_Monad_Aff.monadAff))(Data_Functor.map(Data_Functor.functorArray)(Network_Eth_FriendInDebt_Types.rawConfirmedToDebt)(v2));
          });
      });
  };
  ...
  var pendingFriends = Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Aff.monadAff))(foundationId)(function (v) {
      return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Aff.monadAff))(Control_Monad_Aff_Class.liftAff(Control_Monad_Aff_Class.monadAffExceptT(Control_Monad_Aff_Class.monadAffAff))(Control_Monad_Aff.makeAff(function (err) {
          return function (succ) {
              return $foreign.pendingFriendshipsImpl(succ)(v);
          };
      })))(function (v1) {
          var friendList$prime = Data_Functor.map(Data_Functor.functorArray)(function (f) {
              return new Data_Tuple.Tuple(f.confirmerId, f.friendId);
          })(v1);
          var sent = Data_Array.filter(function (v2) {
              return Data_Eq.notEq(Network_Eth_Foundation.eqFoundationId)(v)(v2.value0);
          })(friendList$prime);
          var todo = Data_Array.filter(function (v2) {
              return Data_Eq.eq(Network_Eth_Foundation.eqFoundationId)(v)(v2.value0);
          })(friendList$prime);
          return Control_Applicative.pure(Control_Monad_Except_Trans.applicativeExceptT(Control_Monad_Aff.monadAff))({
              todo: Data_Functor.map(Data_Functor.functorArray)(function (v2) {
                  return v2.value1;
              })(todo), 
              sent: Data_Functor.map(Data_Functor.functorArray)(function (v2) {
                  return v2.value1;
              })(sent)
          });
      });
  });
  var nameInUse = function (foundationName) {
      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Aff.monadAff))(checkAndInit)(function () {
          return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Aff.monadAff))(Control_Monad_Aff_Class.liftAff(Control_Monad_Aff_Class.monadAffExceptT(Control_Monad_Aff_Class.monadAffAff))(Control_Monad_Aff.makeAff(function (v) {
              return function (s) {
                  return $foreign.nameInUseImpl(s)(foundationName);
              };
          })))(function (v) {
  ...
  exports["confirmPendingDebt"] = confirmPendingDebt;
  exports["confirmedFriends"] = confirmedFriends;
  exports["createFriendship"] = createFriendship;
  exports["debtBalances"] = debtBalances;
  exports["deleteFriendship"] = deleteFriendship;
  exports["foundationId"] = foundationId;
  exports["itemizedDebts"] = itemizedDebts;
  exports["nameInUse"] = nameInUse;
  exports["newPendingDebt"] = newPendingDebt;
  exports["pendingDebts"] = pendingDebts;
  exports["pendingFriends"] = pendingFriends;
  exports["rejectPendingDebt"] = rejectPendingDebt;
...
(function(exports) {
  ...
  var CheckTxs = (function () {
      function CheckTxs() {

      };
      CheckTxs.value = new CheckTxs();
      return CheckTxs;
  })();
  var NetworkError = (function () {
      function NetworkError() {
  ...
  var WrongEthNetwork = (function () {
      function WrongEthNetwork() {

      };
      WrongEthNetwork.value = new WrongEthNetwork();
      return WrongEthNetwork;
  })();
  var showContainerMsg = new Data_Show.Show(function (v) {
      if (v instanceof FIDError) {
          return Data_Show.show(Network_Eth_FriendInDebt_Types.showError)(v.value0);
      };
      if (v instanceof CheckMetamask) {
          return "Checking Metamask status.";
      };
      if (v instanceof CheckTxs) {
          return "Checking status of transactions.";
      };
      if (v instanceof NetworkError) {
          return "NetworkError accessing blockchain";
      };
      if (v instanceof WrongEthNetwork) {
          return "WrongEthNetwork";
      };
      throw new Error("Failed pattern match at FriendInDebt.Types line 33, column 3 - line 33, column 31: " + [ v.constructor.name ]);
  });
  exports["FIDError"] = FIDError;
  exports["CheckMetamask"] = CheckMetamask;
  exports["CheckTxs"] = CheckTxs;
  exports["NetworkError"] = NetworkError;
  exports["WrongEthNetwork"] = WrongEthNetwork;
  exports["showContainerMsg"] = showContainerMsg;
})(PS["FriendInDebt.Types"] = PS["FriendInDebt.Types"] || {});
(function(exports) {
  // Generated by purs version 0.11.5
  "use strict";
  var Data_Eq = PS["Data.Eq"];
...
(function(exports) {
  ...
  var Network_Eth = PS["Network.Eth"];
  var Network_Eth_FriendInDebt = PS["Network.Eth.FriendInDebt"];        
  var shortDate = function ($16) {
      return Data_Either.either(Data_Function["const"](""))(Control_Category.id(Control_Category.categoryFn))(Data_Formatter_DateTime.formatDateTime("MMM D")($16));
  };
  var setWatchTx = function (message) {
      return function (tx) {
          var $8 = Network_Eth.isBlank(tx);
          if ($8) {
                  ...
                  return function (blankVal) {
                      return function (affCall) {
                          if (errorBus instanceof Data_Maybe.Nothing) {
                              return Control_Bind.discard(Control_Bind.discardUnit)(dictBind)(FriendInDebt_Prelude.hLog(dictMonadEff)(Data_Show.showString)("No bus initialized"))(function () {
                                  return Control_Applicative.pure((dictMonadEff.Monad0()).Applicative0())(blankVal);
                              });
                          };
                          if (errorBus instanceof Data_Maybe.Just) {
                              return Control_Bind.bind(dictBind)(Control_Monad_Aff_Class.liftAff(dictMonadAff)(Network_Eth_FriendInDebt.runMonadF(affCall)))(function (v) {
                                  if (v instanceof Data_Either.Left) {
                                      return Control_Bind.bind(dictBind)(Control_Monad_Aff_Class.liftAff(dictMonadAff)(Control_Monad_Aff_Bus.write(new FriendInDebt_Types.FIDError(v.value0))(errorBus.value0)))(function (v1) {
                                          return Control_Applicative.pure((dictMonadEff.Monad0()).Applicative0())(blankVal);
                                      });
                                  };
                                  if (v instanceof Data_Either.Right) {
                                  ...
                                  throw new Error("Failed pattern match at FriendInDebt.Blockchain line 25, column 7 - line 28, column 30: " + [ v.constructor.name ]);
                              });
                          };
                          throw new Error("Failed pattern match at FriendInDebt.Blockchain line 19, column 3 - line 28, column 30: " + [ errorBus.constructor.name ]);
                      };
                  };
              };
          };
  ...
  var handleTx = function (dictMonadEff) {
      return function (dictMonadAff) {
          return function (message) {
              return function (state) {
                  return function (homeScreenQuery) {
                      return function (fnToRun) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(handleCall(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.monadEffHalogenM(dictMonadEff))(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(state.errorBus)(Network_Eth.blankTx)(fnToRun))(function (v) {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(setWatchTx(message)(v))(function () {
                                  return Halogen_Query_HalogenM.raise(homeScreenQuery);
                              });
                          });
                      };
                  };
  ...
  exports["hasNetworkError"] = hasNetworkError;
  exports["setWatchTx"] = setWatchTx;
  exports["shortDate"] = shortDate;
})(PS["FriendInDebt.Blockchain"] = PS["FriendInDebt.Blockchain"] || {});
(function(exports) {
  // Generated by purs version 0.11.5
  "use strict";
  var Control_Semigroupoid = PS["Control.Semigroupoid"];
  ...
  var Data_Semigroup = PS["Data.Semigroup"];
  var FriendInDebt_Prelude = PS["FriendInDebt.Prelude"];        
  var BalancesScreen = (function () {
      function BalancesScreen() {

      };
      BalancesScreen.value = new BalancesScreen();
      return BalancesScreen;
  })();
  var FriendsScreen = (function () {
      function FriendsScreen() {

      };
      FriendsScreen.value = new FriendsScreen();
      return FriendsScreen;
  })();
  var PendingScreen = (function () {
      function PendingScreen() {

      };
      PendingScreen.value = new PendingScreen();
  ...
  var SettingsScreen = (function () {
      ...
      SettingsScreen.value = new SettingsScreen();
      return SettingsScreen;
  })();
  var AddFriendScreen = (function () {
      function AddFriendScreen() {

      };
      AddFriendScreen.value = new AddFriendScreen();
      return AddFriendScreen;
  })();
  var CreateDebtScreen = (function () {
      function CreateDebtScreen() {

      };
      CreateDebtScreen.value = new CreateDebtScreen();
      return CreateDebtScreen;
  })();
  var ItemizedDebtsScreen = (function () {
      function ItemizedDebtsScreen() {

      };
      ItemizedDebtsScreen.value = new ItemizedDebtsScreen();
      return ItemizedDebtsScreen;
  })();
  var getMenuNameFor = function (screen) {
      if (screen instanceof BalancesScreen) {
          return "Balances";
      };
      if (screen instanceof FriendsScreen) {
          return "Friends";
      };
      if (screen instanceof PendingScreen) {
          return "Pending";
      };
  ...
  var getBaseName = function (screen) {
      ...
      if (screen instanceof AddFriendScreen) {
          return "add-friend-screen";
      };
      if (screen instanceof CreateDebtScreen) {
          return "create-debt-screen";
      };
      if (screen instanceof ItemizedDebtsScreen) {
          return "itemized-debts-screen";
      };
  ...
  exports["BalancesScreen"] = BalancesScreen;
  exports["FriendsScreen"] = FriendsScreen;
  exports["PendingScreen"] = PendingScreen;
  exports["SettingsScreen"] = SettingsScreen;
  exports["AddFriendScreen"] = AddFriendScreen;
...
})(PS["FriendInDebt.Routes"] = PS["FriendInDebt.Routes"] || {});
(function(exports) {
    "use strict";
...
(function(exports) {var gradients = [
      {
          "name": "Sel",
...
})(PS["UI.IconGenerator"] = PS["UI.IconGenerator"] || {});
(function(exports) {
  // Generated by purs version 0.11.5
  "use strict";
  var $foreign = PS["UI.IconGenerator"];
  var Control_Monad_Eff = PS["Control.Monad.Eff"];
  var Data_Function = PS["Data.Function"];
  var Data_String = PS["Data.String"];
  var Data_Unit = PS["Data.Unit"];
  ...
  var Halogen_HTML_Properties = PS["Halogen.HTML.Properties"];
  var Network_Eth_FriendInDebt = PS["Network.Eth.FriendInDebt"];        
  var randomGradient = $foreign.randomGradientImpl(Data_Unit.unit);
  var generatedIcon = function (name) {
      return function (gradient) {
          var initial = Data_String.take(1)(name);
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("generated-icon"), Halogen_HTML_Properties.attr("style")(gradient) ])([ Halogen_HTML_Core.text(initial) ]);
      };
  };
  exports["generatedIcon"] = generatedIcon;
  exports["randomGradient"] = randomGradient;
})(PS["UI.IconGenerator"] = PS["UI.IconGenerator"] || {});
(function(exports) {exports.toggleLoadingImpl = function(selector) {
    return function() {
      if (selector) {
...
(function(exports) {
  ...
  var Data_Traversable = PS["Data.Traversable"];
  var Data_Tuple = PS["Data.Tuple"];
  var FriendInDebt_Blockchain = PS["FriendInDebt.Blockchain"];
  var FriendInDebt_Prelude = PS["FriendInDebt.Prelude"];
  var FriendInDebt_Routes = PS["FriendInDebt.Routes"];
  var FriendInDebt_Types = PS["FriendInDebt.Types"];
  var Halogen = PS["Halogen"];
  var Halogen_Component = PS["Halogen.Component"];
  var Halogen_HTML = PS["Halogen.HTML"];
  ...
  var Network_Eth_FriendInDebt = PS["Network.Eth.FriendInDebt"];
  var Network_Eth_FriendInDebt_Types = PS["Network.Eth.FriendInDebt.Types"];
  var UI_IconGenerator = PS["UI.IconGenerator"];
  var UI_UIStatesKit = PS["UI.UIStatesKit"];        
  var ScreenChange = (function () {
      function ScreenChange(value0) {
          this.value0 = value0;
      };
      ScreenChange.create = function (value0) {
          return new ScreenChange(value0);
      };
      return ScreenChange;
  })();
  var NewTX = (function () {
      function NewTX(value0) {
          this.value0 = value0;
      };
      NewTX.create = function (value0) {
          return new NewTX(value0);
      };
      return NewTX;
  })();
  var NumPendingTodo = (function () {
      function NumPendingTodo(value0) {
          this.value0 = value0;
      };
      NumPendingTodo.create = function (value0) {
          return new NumPendingTodo(value0);
      };
      return NumPendingTodo;
  })();
  var NumPendingFriends = (function () {
      function NumPendingFriends(value0) {
          this.value0 = value0;
      };
      NumPendingFriends.create = function (value0) {
          return new NumPendingFriends(value0);
      };
      return NumPendingFriends;
  })();
  var LoadId = (function () {
      function LoadId(value0) {
          this.value0 = value0;
      };
      LoadId.create = function (value0) {
          return new LoadId(value0);
      };
      return LoadId;
  })();
  var Debt = (function () {
  ...
  var InputDebtDetails = (function () {
      function InputDebtDetails(value0, value1, value2) {
          this.value0 = value0;
          this.value1 = value1;
          this.value2 = value2;
      };
      InputDebtDetails.create = function (value0) {
          return function (value1) {
              return function (value2) {
                  return new InputDebtDetails(value0, value1, value2);
              };
          };
      };
      return InputDebtDetails;
  })();
  var AddDebt = (function () {
      function AddDebt(value0, value1, value2) {
          this.value0 = value0;
          this.value1 = value1;
          this.value2 = value2;
      };
      AddDebt.create = function (value0) {
          return function (value1) {
              return function (value2) {
                  return new AddDebt(value0, value1, value2);
              };
          };
      };
      return AddDebt;
  ...
  var RejectPending = (function () {
      function RejectPending(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      RejectPending.create = function (value0) {
          return function (value1) {
              return new RejectPending(value0, value1);
          };
      };
  ...
  var ConfirmFriend = (function () {
      function ConfirmFriend(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      ConfirmFriend.create = function (value0) {
          return function (value1) {
              return new ConfirmFriend(value0, value1);
          };
      };
      return ConfirmFriend;
  })();
  var CancelFriend = (function () {
      function CancelFriend(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      CancelFriend.create = function (value0) {
          return function (value1) {
              return new CancelFriend(value0, value1);
          };
      };
      return CancelFriend;
  })();
  ...
  var ShowItemizedDebtFor = (function () {
      function ShowItemizedDebtFor(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      ShowItemizedDebtFor.create = function (value0) {
          return function (value1) {
              return new ShowItemizedDebtFor(value0, value1);
          };
      };
      return ShowItemizedDebtFor;
  })();
  var NoOp = (function () {
  ...
  var showDebtType = new Data_Show.Show(function (debtType) {
      ...
      throw new Error("Failed pattern match at Debts line 667, column 3 - line 671, column 1: " + [ debtType.constructor.name ]);
  });
  ...
  var moneySpan = function (m) {
      return Halogen_HTML_Elements.span([ Halogen_HTML_Properties.class_("money-span") ])([ Halogen_HTML_Core.text(Network_Eth_FriendInDebt_Types.formatMoney(m)) ]);
  };
  var loadFriendsAndDebts = function (dictMonadEff) {
      return function (dictMonadAff) {
          return function (errorBus) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(FriendInDebt_Blockchain.handleCall(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.monadEffHalogenM(dictMonadEff))(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(errorBus)("")(Network_Eth_FriendInDebt.foundationId))(function (v) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(FriendInDebt_Blockchain.handleCall(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.monadEffHalogenM(dictMonadEff))(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(errorBus)([  ])(Network_Eth_FriendInDebt.confirmedFriends))(function (v1) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(FriendInDebt_Blockchain.handleCall(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.monadEffHalogenM(dictMonadEff))(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(errorBus)(Network_Eth_FriendInDebt_Types.blankPendingFriends)(Network_Eth_FriendInDebt.pendingFriends))(function (v2) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(FriendInDebt_Blockchain.handleCall(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.monadEffHalogenM(dictMonadEff))(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(errorBus)(Network_Eth_FriendInDebt_Types.blankPendingDebts)(Network_Eth_FriendInDebt.pendingDebts))(function (v3) {
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(FriendInDebt_Blockchain.handleCall(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.monadEffHalogenM(dictMonadEff))(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(errorBus)([  ])(Network_Eth_FriendInDebt.debtBalances))(function (v4) {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v5) {
                                      ...
                                      $58.myId = v;
                                      $58.friends = v1;
                                      $58.pendingFriendsSent = Network_Eth_FriendInDebt_Types.pfGetSents(v2);
                                      $58.pendingFriendsTodo = Network_Eth_FriendInDebt_Types.pfGetTodos(v2);
                                      $58.pendingSent = Network_Eth_FriendInDebt_Types.pdGetSents(v3);
                                      $58.pendingTodo = Network_Eth_FriendInDebt_Types.pdGetTodos(v3);
                                      $58.balances = v4;
                                      return $58;
                                  }))(function () {
                                      return Halogen_Query_HalogenM.raise(new LoadId(v));
                                  });
                              });
                          });
                      });
  ...
  var inputFDebt = function (debtType) {
      return function (cur) {
          return function (myId) {
              return function (friends) {
                  return function (debtInfo) {
                      var hasBlanks = function (di) {
                          return di.amount === "" || (di.desc === "" || di.counterParty === "");
                      };
                      var getDebtor = function (debtType1) {
                          return function (me) {
                              return function (friend) {
                                  if (debtType1 instanceof Debt) {
                                      return me;
                                  };
                                  if (debtType1 instanceof Credit) {
                                      return friend;
                                  };
                                  throw new Error("Failed pattern match at Debts line 720, column 40 - line 722, column 26: " + [ debtType1.constructor.name ]);
                              };
                          };
                      };
                      var getCreditor = function (debtType1) {
                          return function (me) {
                              return function (friend) {
                                  if (debtType1 instanceof Debt) {
                                      return friend;
                                  ...
                                  throw new Error("Failed pattern match at Debts line 723, column 42 - line 725, column 22: " + [ debtType1.constructor.name ]);
                              };
                          };
                      };
                      var mkDebt = function (debtType1) {
                          return function (currency) {
                              return function (me) {
                                  return function (debtInfo1) {
                                      return Network_Eth_FriendInDebt_Types.mkDebt(getDebtor(debtType1)(me)(Network_Eth_Foundation.fiMkId(debtInfo1.counterParty)))(getCreditor(debtType1)(me)(Network_Eth_Foundation.fiMkId(debtInfo1.counterParty)))(Network_Eth_Foundation.fiMkId(debtInfo1.counterParty))(Data_Maybe.fromMaybe(Network_Eth_FriendInDebt_Types.mkMoney(0.0)(currency))(Network_Eth_FriendInDebt_Types.moneyFromDecString(currency)(debtInfo1.amount)))(Network_Eth_FriendInDebt_Types.NoDebtId.value)(debtInfo1.desc);
                                  };
                              };
                          };
                      };
                      var sendMsg = (function () {
                          ...
                          throw new Error("Failed pattern match at Debts line 676, column 18 - line 678, column 3: " + [ debtType.constructor.name ]);
                      })();
                      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(Halogen_HTML_Core.ClassName("create-debt col ")) ])([ Halogen_HTML_Elements.label_([ Halogen_HTML_Core.text("Enter " + Data_Show.show(showDebtType)(debtType)) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("row amount-row") ])([ Halogen_HTML_Elements.span_([ Halogen_HTML_Core.text(Network_Eth_FriendInDebt_Types.cSymbol(cur)) ]), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputNumber.value), Halogen_HTML_Properties.class_("debt-amount"), Halogen_HTML_Properties.value(debtInfo.amount), Halogen_HTML_Properties.step(new DOM_HTML_Indexed_StepValue.Step(1.0e-2)), Halogen_HTML_Events.onValueInput(Halogen_HTML_Events.input(function (v) {
                          return InputDebtDetails.create(debtType)((function () {
                              var $64 = {};
                              for (var $65 in debtInfo) {
                                  if ({}.hasOwnProperty.call(debtInfo, $65)) {
                                      $64[$65] = debtInfo[$65];
                                  };
                              };
                              $64.amount = v;
                      ...
                      })) ]), Halogen_HTML_Elements.span_([ Halogen_HTML_Core.text(Network_Eth_FriendInDebt_Types.cIsoCode(cur)) ]) ]), Halogen_HTML_Elements.select([ Halogen_HTML_Events.onValueChange(Halogen_HTML_Events.input(function (v) {
                          var $67 = v === "Select a Friend";
                          if ($67) {
                              return InputDebtDetails.create(debtType)((function () {
                                  var $68 = {};
                                  for (var $69 in debtInfo) {
                                      if ({}.hasOwnProperty.call(debtInfo, $69)) {
                                          $68[$69] = debtInfo[$69];
                                      };
                                  };
                                  $68.counterParty = "";
                          ...
                          return InputDebtDetails.create(debtType)((function () {
                              var $71 = {};
                              for (var $72 in debtInfo) {
                                  if ({}.hasOwnProperty.call(debtInfo, $72)) {
                                      $71[$72] = debtInfo[$72];
                                  };
                              };
                              $71.counterParty = v;
                      ...
                      })) ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Halogen_HTML_Elements.option([ Halogen_HTML_Properties.selected(true) ])([ Halogen_HTML_Core.text("Select a Friend") ]) ])(Data_Functor.map(Data_Functor.functorArray)(function (f) {
                          return Halogen_HTML_Elements.option_([ Halogen_HTML_Core.text(Network_Eth_Foundation.fiGetId(f)) ]);
                      })(friends))), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputText.value), Halogen_HTML_Properties.placeholder("Enter debt memo here"), Halogen_HTML_Properties.attr("maxlength")("32"), Halogen_HTML_Events.onValueInput(Halogen_HTML_Events.input(function (val) {
                          return InputDebtDetails.create(debtType)((function () {
                              var $74 = {};
                              for (var $75 in debtInfo) {
                                  if ({}.hasOwnProperty.call(debtInfo, $75)) {
                                      $74[$75] = debtInfo[$75];
                                  };
                              };
                              $74.desc = Data_String.take(32)(val);
                              return $74;
                          })());
                      })), Halogen_HTML_Properties.value(Data_String.take(32)(debtInfo.desc)) ]), Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(AddDebt.create(debtType)(mkDebt(debtType)(cur)(myId)(debtInfo)))), Halogen_HTML_Properties.disabled(Data_Maybe.isNothing(Network_Eth_FriendInDebt_Types.moneyFromDecString(cur)(debtInfo.amount)) || hasBlanks(debtInfo)), Halogen_HTML_Properties.class_("create-debt-button form-control") ])([ Halogen_HTML_Core.text(sendMsg) ]) ]);
                  };
              };
          };
      };
  };
  var inputDebt = inputFDebt(Debt.value);
  var inputCredit = inputFDebt(Credit.value);
  var idSpan = function (me) {
      return function (idToDisplay) {
          ...
          throw new Error("Failed pattern match at Debts line 592, column 6 - line 594, column 167: " + [ isItMe.constructor.name ]);
      };
  };
  var findBalanceFor = function (fid) {
      return function (balances) {
          return Data_Foldable.find(Data_Foldable.foldableArray)(function (v) {
              return Data_Eq.eq(Network_Eth_Foundation.eqFoundationId)(v.debtor)(fid) || Data_Eq.eq(Network_Eth_Foundation.eqFoundationId)(v.creditor)(fid);
          })(balances);
      };
  };
  var prepareFriendBundles = function (state) {
      return Data_Functor.map(Data_Functor.functorArray)(function (v) {
          return {
              id: v.value0, 
              gradient: v.value1, 
              balance: findBalanceFor(v.value0)(state.balances)
          };
      })(Data_Array.zip(state.friends)(state.gradients));
  };
  var emptyBalance = Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("no-balances") ])([ Halogen_HTML_Core.text("No Balances Found, Check Pending for Unconfirmed Debts") ]);
  var displayTodoFriend = function (friend) {
      return [ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("row friend-details") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("request-details") ])([ Halogen_HTML_Elements.span_([ Halogen_HTML_Core.text("Friend Request From") ]), Halogen_HTML_Elements.span_([ Halogen_HTML_Core.text(Data_Show.show(Network_Eth_Foundation.showFoundationId)(friend)) ]) ]) ]) ];
  };
  var displaySentFriend = function (friend) {
      return [ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("row friend-details") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("request-details") ])([ Halogen_HTML_Elements.span_([ Halogen_HTML_Core.text("Friend Request To") ]), Halogen_HTML_Elements.span_([ Halogen_HTML_Core.text(Data_Show.show(Network_Eth_Foundation.showFoundationId)(friend)) ]) ]) ]) ];
  };
  var displayFriendLi = function (me) {
      return function (c) {
          return function (v) {
              var debtor = Data_Maybe.fromMaybe(Network_Eth_Foundation.fiBlankId)(Data_Functor.map(Data_Maybe.functorMaybe)(Network_Eth_FriendInDebt_Types.balDebtor)(v.balance));
              var amount = Data_Maybe.maybe(Network_Eth_FriendInDebt_Types.mkMoney(0.0)(c))(Network_Eth_FriendInDebt_Types.balAmount)(v.balance);
              return Halogen_HTML_Elements.li([ Halogen_HTML_Properties.class_("friend-item row") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("col-3") ])([ UI_IconGenerator.generatedIcon(Data_Show.show(Network_Eth_Foundation.showFoundationId)(v.id))(v.gradient) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("col-9 name-portion") ])([ Halogen_HTML_Core.text(Data_Show.show(Network_Eth_Foundation.showFoundationId)(v.id)), Halogen_HTML_Elements.span([ Halogen_HTML_Properties.class_(Halogen_HTML_Core.ClassName("balance-amount" + (function () {
                  var $85 = Data_Eq.eq(Network_Eth_Foundation.eqFoundationId)(me)(debtor);
                  if ($85) {
                      return " debt";
                  };
                  return " credit";
              })())) ])([ Halogen_HTML_Core.text("Balance: " + Network_Eth_FriendInDebt_Types.formatMoney(amount)) ]) ]) ]);
          };
      };
  };
  var displayFriendGroup = function (me) {
      return function (c) {
          return function (group) {
              var innerArr = Data_NonEmpty.oneOf(Control_Alternative.alternativeArray)(group);
              var initial = Data_Maybe.fromMaybe("")(Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Array.head(innerArr))(function (v) {
                  return Control_Applicative.pure(Data_Maybe.applicativeMaybe)(Network_Eth_Foundation.initial(v.id));
              }));
              return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("row initial-group") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("col-1") ])([ Halogen_HTML_Elements.h6([ Halogen_HTML_Properties.class_("initial-label") ])([ Halogen_HTML_Core.text(initial) ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("col") ])(Data_Functor.map(Data_Functor.functorArray)(displayFriendLi(me)(c))(innerArr)) ]);
          };
      };
  };
  var groupFriendLiByInitial = function (me) {
      return function (c) {
          return function (friendBundles) {
              var orderedFriends = Data_Array.sortBy(function (v) {
                  return function (v1) {
                      return Data_String.localeCompare(Network_Eth_Foundation.initial(v.id))(Network_Eth_Foundation.initial(v1.id));
                  };
              })(friendBundles);
              var friendGroups = Data_Array.groupBy(function (v) {
                  return function (v1) {
                      return Network_Eth_Foundation.initial(v.id) === Network_Eth_Foundation.initial(v1.id);
                  };
              })(orderedFriends);
              return Data_Functor.map(Data_Functor.functorArray)(displayFriendGroup(me)(c))(friendGroups);
          };
      };
  };
  var descSpan = function (v) {
      return Halogen_HTML_Elements.span([  ])([ Halogen_HTML_Core.text(v.desc) ]);
  };
  var debtRelationshipSpan = function (me) {
      return function (fd) {
          var relationship = (function () {
              var $92 = Data_Eq.eq(Network_Eth_Foundation.eqFoundationId)(Network_Eth_FriendInDebt_Types.debtDebtor(fd))(me);
              if ($92) {
                  return "owe";
              };
              return "owes";
          })();
          return Halogen_HTML_Elements.span_([ Halogen_HTML_Core.text(relationship) ]);
      };
  };
  ...
  var debtAmountSpan = function (v) {
      return verboseMoneySpan(v.debt);
  };
  var displaySentDebt = function (me) {
      return function (fd) {
          return [ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("row debt-details align-items-center") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("col-4 debt-relationship") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("debtor") ])([ idSpan(me)(fd.debtor) ]), debtRelationshipSpan(me)(fd), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("creditor") ])([ idSpan(me)(fd.creditor) ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("col-8 debt-desc") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("desc") ])([ descSpan(fd) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("amount") ])([ debtAmountSpan(fd) ]) ]) ]) ];
      };
  };
  ...
  var itemizedDebt = function (fd) {
      return [ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("event-description") ])([ descSpan(fd) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("event-amount") ])([ debtAmountSpan(fd) ]) ];
  };
  var itemizedDebtLi = function (me) {
      return function (fd) {
          var mostRecent = Data_Maybe.maybe("")(FriendInDebt_Blockchain.shortDate)(Network_Eth_FriendInDebt_Types.debtTimestamp(fd));
          var amIcreditor = Data_Eq.eq(Network_Eth_Foundation.eqFoundationId)(Network_Eth_FriendInDebt_Types.debtCreditor(fd))(me);
          return Halogen_HTML_Elements.li([ Halogen_HTML_Properties.class_(Halogen_HTML_Core.ClassName("timeline-event " + (function () {
              if (amIcreditor) {
                  return "positive";
              };
              return "negative";
          })())), Halogen_HTML_Properties.attr("data-timestamp")(mostRecent) ])(itemizedDebt(fd));
      };
  };
  var displayItemizedDebtTimeline = function (friendToShow) {
      return function (debtsMap) {
          return function (me) {
              if (friendToShow instanceof Data_Maybe.Just) {
                  return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(Halogen_HTML_Core.ClassName("col itemized-debts")) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("row") ])([ Halogen_HTML_Core.text("Debt History:") ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("row") ])([ Halogen_HTML_Elements.h6_([ Halogen_HTML_Core.text(Data_Show.show(Network_Eth_Foundation.showFoundationId)(friendToShow.value0)) ]) ]), Halogen_HTML_Elements.ul([ Halogen_HTML_Properties.class_("row debt-timeline") ])(Data_Functor.map(Data_Functor.functorArray)(itemizedDebtLi(me))(Data_Maybe.fromMaybe([  ])(Data_Map.lookup(Network_Eth_Foundation.ordFoundationId)(friendToShow.value0)(debtsMap)))) ]);
              };
              if (friendToShow instanceof Data_Maybe.Nothing) {
                  return Halogen_HTML_Elements.div_([ Halogen_HTML_Core.text("") ]);
              };
              throw new Error("Failed pattern match at Debts line 317, column 3 - line 327, column 37: " + [ friendToShow.constructor.name ]);
          };
      };
  };
  var displayBalanceLi = function (state) {
      return function (bal) {
          var totalDebts = Network_Eth_FriendInDebt_Types.balTotalDebts(bal);
          var mostRecent = Data_Maybe.maybe("")(FriendInDebt_Blockchain.formatDate)(Network_Eth_FriendInDebt_Types.balMostRecent(bal));
          var debtor = Network_Eth_FriendInDebt_Types.balDebtor(bal);
          var debtStr = (function () {
              var $100 = totalDebts === 1;
              if ($100) {
                  return " debt";
              };
              return " debts";
          })();
          var creditor = Network_Eth_FriendInDebt_Types.balCreditor(bal);
          var curFriend = (function () {
              var $101 = Data_Eq.eq(Network_Eth_Foundation.eqFoundationId)(creditor)(state.myId);
              if ($101) {
                  return debtor;
              };
              return creditor;
          })();
          var expandClass = Data_Functor.map(Data_Maybe.functorMaybe)(function (f) {
              var $102 = Data_Eq.eq(Network_Eth_Foundation.eqFoundationId)(f)(curFriend);
              if ($102) {
                  return "expand-itemized";
              };
              return "hide-itemized";
          })(state.showItemizedDebtFor);
          var status = (function () {
              var $103 = Data_Eq.eq(Network_Eth_Foundation.eqFoundationId)(creditor)(state.myId);
              if ($103) {
                  return "Owed to Me";
              };
              return "I Owe";
          })();
          var amount = Network_Eth_FriendInDebt_Types.balAmount(bal);
          return Halogen_HTML_Elements.li([ Halogen_HTML_Properties.class_(Halogen_HTML_Core.ClassName("balance-row row " + Data_Maybe.fromMaybe("")(expandClass))), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(ShowItemizedDebtFor.create(new Data_Maybe.Just(curFriend)))) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("col-4 debt-excerpt") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(Halogen_HTML_Core.ClassName("row debt-amount" + (function () {
              var $104 = Data_Eq.eq(Network_Eth_Foundation.eqFoundationId)(creditor)(state.myId);
              if ($104) {
                  return " credit";
              };
              return " debt";
          })())) ])([ moneySpan(amount) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("row label-row") ])([ Halogen_HTML_Elements.small_([ Halogen_HTML_Core.text("last") ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("row thin-item-row") ])([ Halogen_HTML_Elements.span([ Halogen_HTML_Properties.class_("thin-item") ])([ Halogen_HTML_Core.text(mostRecent) ]) ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("col debt-details") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("col debt-relationship") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("row") ])([ Halogen_HTML_Core.text(Data_Show.show(Network_Eth_Foundation.showFoundationId)(curFriend)) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("row") ])([ Halogen_HTML_Elements.h6_([ Halogen_HTML_Core.text("") ]) ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("row label-row") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("col-6") ])([ Halogen_HTML_Elements.small_([ Halogen_HTML_Core.text("currency") ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("col-6") ])([ Halogen_HTML_Elements.small_([ Halogen_HTML_Core.text("debts") ]) ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("row thin-item-row") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("col thin-item") ])([ currencySpan(amount) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("col thin-item") ])([ Halogen_HTML_Core.text(Data_Show.show(Data_Show.showInt)(totalDebts) + debtStr) ]) ]) ]), displayItemizedDebtTimeline(state.showItemizedDebtFor)(state.itemizedDebts)(state.myId) ]);
      };
  };
  var createDebtModal = function (state) {
      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("create-debt-container") ])([ Halogen_HTML_Elements.h6([ Halogen_HTML_Properties.class_("modal-title") ])([ Halogen_HTML_Core.text("Create Debt") ]), Halogen_HTML_Elements.ul([ Halogen_HTML_Properties.class_("col") ])([ Halogen_HTML_Elements.li([ Halogen_HTML_Properties.class_("row create-debt-card") ])([ inputDebt(state.defaultCurrency)(state.myId)(state.friends)(state.newDebtInput) ]), Halogen_HTML_Elements.li([ Halogen_HTML_Properties.class_("row create-debt-card") ])([ inputCredit(state.defaultCurrency)(state.myId)(state.friends)(state.newCreditInput) ]) ]) ]);
  };
  var confirmFriendshipButton = function (friend) {
      return Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(ConfirmFriend.create(friend))), Halogen_HTML_Properties.class_("confirm-friend-button") ])([ Halogen_HTML_Elements.i([ Halogen_HTML_Properties.class_("fa fa-check") ])([  ]) ]);
  };
  var confirmButton = function (fd) {
      return Halogen_HTML_Elements.button([ Halogen_HTML_Properties.class_("fa fa-check confirm-pending-button"), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(ConfirmPending.create(fd))) ])([  ]);
  };
  ...
  var displaySentFriendLi = function (friend) {
      return Halogen_HTML_Elements.li([ Halogen_HTML_Properties.class_("sent-friend-row row") ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)(cardHeader("Waiting for response:"))(displaySentFriend(friend)));
  };
  var displaySentFriendsList = function (friends) {
      return Halogen_HTML_Elements.ul([ Halogen_HTML_Properties.class_("col") ])(Data_Functor.map(Data_Functor.functorArray)(displaySentFriendLi)(friends));
  };
  var cancelFriendshipButton = function (friend) {
      return Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(CancelFriend.create(friend))), Halogen_HTML_Properties.class_("cancel-friend-button") ])([ Halogen_HTML_Elements.i([ Halogen_HTML_Properties.class_("fa fa-close") ])([  ]) ]);
  };
  var displayTodoFriendLi = function (friend) {
      return Halogen_HTML_Elements.li([ Halogen_HTML_Properties.class_("todo-friend-row row align-items-center") ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Semigroup.append(Data_Semigroup.semigroupArray)(cardHeader("Respond to Request:"))(displayTodoFriend(friend)))([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("row action-buttons row align-items-center") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("") ])([ cancelFriendshipButton(friend) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("") ])([ confirmFriendshipButton(friend) ]) ]) ]));
  };
  var displayTodoFriendsList = function (friends) {
  ...
  var cancelButton = function (fd) {
      return Halogen_HTML_Elements.button([ Halogen_HTML_Properties.class_("fa fa-close reject-pending-button"), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(RejectPending.create(fd))) ])([  ]);
  };
  var displayTodoLi = function (me) {
      return function (fd) {
          return Halogen_HTML_Elements.li([ Halogen_HTML_Properties.class_("todo-debt-row row align-items-center") ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Semigroup.append(Data_Semigroup.semigroupArray)(cardHeader("To Confirm:"))(displayTodo(me)(fd)))([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("row action-buttons align-items-end") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("") ])([ cancelButton(fd) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("") ])([ confirmButton(fd) ]) ]) ]));
      };
  };
  ...
  var component = (function () {
      var render = function (state) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("page-container col-12") ])([ page(FriendInDebt_Routes.FriendsScreen.value)(Halogen_HTML_Elements.ul([ Halogen_HTML_Properties.class_("col") ])(groupFriendLiByInitial(state.myId)(state.defaultCurrency)(prepareFriendBundles(state)))), page(FriendInDebt_Routes.BalancesScreen.value)(Halogen_HTML_Elements.ul([ Halogen_HTML_Properties.class_("col-12") ])((function () {
              var v = Data_Array.length(state.balances);
              if (v === 0) {
                  return [ emptyBalance ];
              };
              return Data_Functor.map(Data_Functor.functorArray)(displayBalanceLi(state))(state.balances);
          })())), page(FriendInDebt_Routes.PendingScreen.value)(pendingPage(state)), page(FriendInDebt_Routes.SettingsScreen.value)(settingsPage(state)), page(FriendInDebt_Routes.AddFriendScreen.value)(Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("add-friend-container") ])([ addFriendWidget(state) ])), page(FriendInDebt_Routes.CreateDebtScreen.value)(createDebtModal(state)) ]);
      };
      var initialState = function (input) {
          return {
              ...
              pendingFriendsSent: [  ], 
              balances: [  ], 
              itemizedDebts: Data_Map.empty, 
              myId: Network_Eth_Foundation.fiBlankId, 
              pendingSent: [  ], 
              pendingTodo: [  ], 
              newFriend: "", 
              ...
              inputName: "", 
              nameNoExist: false, 
              showItemizedDebtFor: Data_Maybe.Nothing.value, 
              defaultCurrency: Network_Eth_FriendInDebt_Types.cUSD, 
              errorBus: input
          };
      };
      var $$eval = function (v) {
          ...
          if (v instanceof ShowItemizedDebtFor) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.raise(new ScreenChange(FriendInDebt_Routes.ItemizedDebtsScreen.value)))(function () {
                  ...
                  if (v.value0 instanceof Data_Maybe.Just) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                              ...
                              $110.showItemizedDebtFor = v.value0;
                              return $110;
                          }))(function () {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(UI_UIStatesKit.toggleLoading(".itemized-debts")))(function () {
                                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(FriendInDebt_Blockchain.handleCall(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(v1.errorBus)([  ])(Network_Eth_FriendInDebt.itemizedDebts(v.value0.value0)))(function (v2) {
                                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                                          ...
                                          $114.itemizedDebts = Data_Map.insert(Network_Eth_Foundation.ordFoundationId)(v.value0.value0)(v2)(v1.itemizedDebts);
                                          return $114;
                                      }))(function () {
                                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(UI_UIStatesKit.toggleLoading(".itemized-debts")))(function () {
                                              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                  ...
                  throw new Error("Failed pattern match at Debts line 142, column 7 - line 153, column 20: " + [ v.value0.constructor.name ]);
              });
          };
          if (v instanceof HandleInput) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  var v2 = Data_Array.length(v1.gradients);
                  if (v2 === 0) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Data_Traversable.sequence(Data_Traversable.traversableArray)(Control_Monad_Eff.applicativeEff)(Data_Functor.map(Data_Functor.functorArray)(Data_Function["const"](UI_IconGenerator.randomGradient))(v1.friends))))(function (v3) {
          ...
          if (v instanceof ConfirmFriend) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(UI_UIStatesKit.toggleLoading(".confirm-friend-button")))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(FriendInDebt_Blockchain.handleTx(Control_Monad_Aff.monadEffAff)(Control_Monad_Aff_Class.monadAffAff)(NewTX.create)(v1)(new ScreenChange(FriendInDebt_Routes.BalancesScreen.value))(Network_Eth_FriendInDebt.createFriendship(v.value0)))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(UI_UIStatesKit.toggleLoading(".confirm-friend-button")))(function () {
                              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                          });
                      });
          ...
          if (v instanceof CancelFriend) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(UI_UIStatesKit.toggleLoading(".cancel-friend-button")))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(FriendInDebt_Blockchain.handleTx(Control_Monad_Aff.monadEffAff)(Control_Monad_Aff_Class.monadAffAff)(NewTX.create)(v1)(new ScreenChange(FriendInDebt_Routes.BalancesScreen.value))(Network_Eth_FriendInDebt.deleteFriendship(v.value0)))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(UI_UIStatesKit.toggleLoading(".cancel-friend-button")))(function () {
                              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                          });
                      });
          ...
          if (v instanceof AddFriend) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(FriendInDebt_Blockchain.handleCall(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(v1.errorBus)(false)(Network_Eth_FriendInDebt.nameInUse(v.value0)))(function (v2) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                          ...
                          if ($139) {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                                  var $140 = {};
                                  for (var $141 in v3) {
                                      if ({}.hasOwnProperty.call(v3, $141)) {
                                          $140[$141] = v3[$141];
                                      };
                                  };
                                  $140.nameNoExist = true;
                                  $140.newFriend = "";
                                  return $140;
                              }))(function () {
                          ...
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(UI_UIStatesKit.toggleLoading(".add-friend-button")))(function () {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(FriendInDebt_Blockchain.handleTx(Control_Monad_Aff.monadEffAff)(Control_Monad_Aff_Class.monadAffAff)(NewTX.create)(v1)(new ScreenChange(FriendInDebt_Routes.BalancesScreen.value))(Network_Eth_FriendInDebt.createFriendship(Network_Eth_Foundation.fiMkId(v.value0))))(function () {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                                      var $143 = {};
                                      for (var $144 in v3) {
                                          if ({}.hasOwnProperty.call(v3, $144)) {
                                              $143[$144] = v3[$144];
                                          };
                                      };
                                      $143.newFriend = "";
                                      ...
                                      return Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(UI_UIStatesKit.toggleLoading(".add-friend-button"));
                                  });
                              });
                          });
                      })())(function () {
          ...
          if (v instanceof InputFriend) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  $148.nameNoExist = false;
                  return $148;
              }))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                      var $151 = Network_Eth_Foundation.fiStrValidId(Data_String.toLower(v.value0)) || Data_String.length(v.value0) < 4;
                      if ($151) {
                          return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                              ...
                              $152.newFriend = Data_String.toLower(v.value0);
                              return $152;
                          });
                      };
                      return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
          ...
          if (v instanceof InputDebtDetails) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                  if (v.value0 instanceof Debt) {
                      return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                          var $161 = {};
                          for (var $162 in v1) {
                          ...
                          $161.newDebtInput = v.value1;
                          return $161;
                      });
                  };
                  if (v.value0 instanceof Credit) {
                      return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                          var $164 = {};
                          for (var $165 in v1) {
                          ...
                          $164.newCreditInput = v.value1;
                          return $164;
                      });
                  };
                  throw new Error("Failed pattern match at Debts line 202, column 7 - line 204, column 59: " + [ v.value0.constructor.name ]);
              })())(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value2);
              });
          };
          if (v instanceof AddDebt) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(FriendInDebt_Prelude.hLog(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Network_Eth_FriendInDebt_Types.showDebt)(v.value1))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(UI_UIStatesKit.toggleLoading(".create-debt-button")))(function () {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(FriendInDebt_Blockchain.handleTx(Control_Monad_Aff.monadEffAff)(Control_Monad_Aff_Class.monadAffAff)(NewTX.create)(v1)(new ScreenChange(FriendInDebt_Routes.BalancesScreen.value))(Network_Eth_FriendInDebt.newPendingDebt(v.value1)))(function () {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                                  var $171 = {};
                                  for (var $172 in v2) {
                                      if ({}.hasOwnProperty.call(v2, $172)) {
                                          $171[$172] = v2[$172];
                                      };
                                  };
                                  $171.newDebtInput = blankDebtInfo;
                                  $171.newCreditInput = blankDebtInfo;
                                  return $171;
                              }))(function () {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(UI_UIStatesKit.toggleLoading(".create-debt-button")))(function () {
                                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value2);
          ...
          if (v instanceof ConfirmPending) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(UI_UIStatesKit.toggleLoading(".confirm-pending-button")))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(FriendInDebt_Blockchain.handleTx(Control_Monad_Aff.monadEffAff)(Control_Monad_Aff_Class.monadAffAff)(NewTX.create)(v1)(new ScreenChange(FriendInDebt_Routes.BalancesScreen.value))(Network_Eth_FriendInDebt.confirmPendingDebt(v.value0)))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(UI_UIStatesKit.toggleLoading(".confirm-pending-button")))(function () {
                              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                          });
                      });
          ...
          if (v instanceof RejectPending) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(UI_UIStatesKit.toggleLoading(".reject-pending-button")))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(FriendInDebt_Blockchain.handleTx(Control_Monad_Aff.monadEffAff)(Control_Monad_Aff_Class.monadAffAff)(NewTX.create)(v1)(new ScreenChange(FriendInDebt_Routes.BalancesScreen.value))(Network_Eth_FriendInDebt.rejectPendingDebt(v.value0)))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(UI_UIStatesKit.toggleLoading(".reject-pending-button")))(function () {
                              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                          });
                      });
          ...
          if (v instanceof RefreshDebts) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(UI_UIStatesKit.toggleLoading(".page-container")))(function () {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                      return v1.errorBus;
                  }))(function (v1) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(loadFriendsAndDebts(Control_Monad_Aff.monadEffAff)(Control_Monad_Aff_Class.monadAffAff)(v1))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(UI_UIStatesKit.toggleLoading(".page-container")))(function () {
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v2) {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.raise(new NumPendingTodo(Data_Array.length(v2.pendingTodo))))(function () {
                                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.raise(new NumPendingFriends(Data_Array.length(v2.pendingFriendsTodo))))(function () {
                                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
                                      });
                                  });
                              });
          ...
          throw new Error("Failed pattern match at Debts line 137, column 10 - line 235, column 16: " + [ v.constructor.name ]);
      };
  ...
  exports["NewTX"] = NewTX;
  exports["NumPendingTodo"] = NumPendingTodo;
  exports["NumPendingFriends"] = NumPendingFriends;
  exports["LoadId"] = LoadId;
  exports["RefreshDebts"] = RefreshDebts;
  exports["HandleInput"] = HandleInput;
  exports["InputDebtDetails"] = InputDebtDetails;
  ...
  exports["InputFriend"] = InputFriend;
  exports["ShowItemizedDebtFor"] = ShowItemizedDebtFor;
  exports["NoOp"] = NoOp;
  exports["addFriendWidget"] = addFriendWidget;
  exports["blankDebtInfo"] = blankDebtInfo;
  exports["cancelButton"] = cancelButton;
  exports["cancelFriendshipButton"] = cancelFriendshipButton;
  ...
  exports["debtRelationshipSpan"] = debtRelationshipSpan;
  exports["descSpan"] = descSpan;
  exports["displayBalanceLi"] = displayBalanceLi;
  exports["displayFriendGroup"] = displayFriendGroup;
  exports["displayFriendLi"] = displayFriendLi;
  exports["displayItemizedDebtTimeline"] = displayItemizedDebtTimeline;
  exports["displaySentDebt"] = displaySentDebt;
  exports["displaySentDebtLi"] = displaySentDebtLi;
  exports["displaySentDebtsList"] = displaySentDebtsList;
  exports["displaySentFriend"] = displaySentFriend;
  exports["displaySentFriendLi"] = displaySentFriendLi;
  exports["displaySentFriendsList"] = displaySentFriendsList;
  exports["displayTodo"] = displayTodo;
  exports["displayTodoFriend"] = displayTodoFriend;
  exports["displayTodoFriendLi"] = displayTodoFriendLi;
  exports["displayTodoFriendsList"] = displayTodoFriendsList;
  exports["displayTodoLi"] = displayTodoLi;
  exports["displayTodoList"] = displayTodoList;
  exports["emptyBalance"] = emptyBalance;
  exports["findBalanceFor"] = findBalanceFor;
  exports["groupFriendLiByInitial"] = groupFriendLiByInitial;
  exports["idSpan"] = idSpan;
  exports["inputCredit"] = inputCredit;
  exports["inputDebt"] = inputDebt;
  exports["inputFDebt"] = inputFDebt;
  exports["itemizedDebt"] = itemizedDebt;
  exports["itemizedDebtLi"] = itemizedDebtLi;
  exports["loadFriendsAndDebts"] = loadFriendsAndDebts;
  ...
  exports["showDebtType"] = showDebtType;
})(PS["Debts"] = PS["Debts"] || {});
(function(exports) {
  // Generated by purs version 0.11.5
  "use strict";
  ...
  var web3Delay = 500;
  var networkId = "3";
  var checkTxInterval = 7000;
  var checkMMInterval = 800;
  exports["checkMMInterval"] = checkMMInterval;
  exports["checkTxInterval"] = checkTxInterval;
  exports["networkId"] = networkId;
  exports["web3Delay"] = web3Delay;
})(PS["FriendInDebt.Config"] = PS["FriendInDebt.Config"] || {});
(function(exports) {
  // Generated by purs version 0.11.5
  "use strict";
  var Control_Applicative = PS["Control.Applicative"];
...
(function(exports) {
  ...
  var Debts = PS["Debts"];
  var FriendInDebt_Blockchain = PS["FriendInDebt.Blockchain"];
  var FriendInDebt_Config = PS["FriendInDebt.Config"];
  var FriendInDebt_Prelude = PS["FriendInDebt.Prelude"];
  var FriendInDebt_Routes = PS["FriendInDebt.Routes"];
  var FriendInDebt_Types = PS["FriendInDebt.Types"];
  var Halogen = PS["Halogen"];
  ...
  var RefreshData = (function () {
      function RefreshData(value0) {
          this.value0 = value0;
      };
      RefreshData.create = function (value0) {
          return new RefreshData(value0);
      };
      return RefreshData;
  })();
  ...
  var DebtViewMsg = (function () {
      function DebtViewMsg(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      DebtViewMsg.create = function (value0) {
          return function (value1) {
              return new DebtViewMsg(value0, value1);
          };
      };
      return DebtViewMsg;
  })();
  var topBar = function (state) {
      ...
      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("row top-bar") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("col logo-section") ])([ Halogen_HTML_Elements.img([ Halogen_HTML_Properties.src("fid@1x.png") ]), Halogen_HTML_Core.text("Friend in Debt") ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("col go-back-section") ])([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href("#"), Halogen_HTML_Properties.class_("close-pop-button"), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(PreviousScreen.create)) ])([ Halogen_HTML_Elements.i([ Halogen_HTML_Properties.class_("fa fa-chevron-left") ])([  ]), Halogen_HTML_Core.text(" Back") ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(Halogen_HTML_Core.ClassName("col-5 align-self-end current-transactions" + (function () {
          if (processing) {
              return " processing";
          };
          return "";
      })())) ])([ Halogen_HTML_Elements.i([ Halogen_HTML_Properties.class_("transaction-spinner") ])([  ]), Halogen_HTML_Elements.span_([ Halogen_HTML_Core.text("Writing " + (Data_Show.show(Data_Show.showInt)(Data_Array.length(state.txs)) + (" " + (itemStr + "...")))) ]) ]), Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href("#"), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(RefreshData.create)), Halogen_HTML_Properties.class_(Halogen_HTML_Core.ClassName("col-5 align-self-end reload-button" + (function () {
          if (processing) {
              return "";
          };
          return " show-reload";
      })())) ])([ Halogen_HTML_Elements.i([ Halogen_HTML_Properties.class_("fa fa-refresh") ])([  ]) ]) ]);
  };
  var startCheckInterval = function (dictApplicative) {
      return function (dictBind) {
          return function (dictMonadEff) {
              return function (maybeBus) {
                  return function (mmInterval) {
                      return function (txInterval) {
                          var checkTxsEff = function (b) {
                              return function __do() {
                                  var v = Control_Monad_Aff.launchAff(Control_Monad_Aff_Bus.write(FriendInDebt_Types.CheckTxs.value)(b))();
                                  return Data_Unit.unit;
                              };
                          };
                          var checkMMEff = function (b) {
                              return function __do() {
                                  var v = Control_Monad_Aff.launchAff(Control_Monad_Aff_Bus.write(FriendInDebt_Types.CheckMetamask.value)(b))();
                                  return Data_Unit.unit;
                              };
                          };
                          ...
                          if (maybeBus instanceof Data_Maybe.Just) {
                              return Control_Bind.bind(dictBind)(Control_Monad_Eff_Class.liftEff(dictMonadEff)(Control_Monad_Eff_Timer.setInterval(mmInterval)(checkMMEff(maybeBus.value0))))(function (v) {
                                  return Control_Bind.bind(dictBind)(Control_Monad_Eff_Class.liftEff(dictMonadEff)(Control_Monad_Eff_Timer.setInterval(txInterval)(checkTxsEff(maybeBus.value0))))(function (v1) {
                                      return Control_Applicative.pure(dictApplicative)(Data_Unit.unit);
                                  });
                              });
                          };
                          throw new Error("Failed pattern match at Container line 278, column 3 - line 283, column 16: " + [ maybeBus.constructor.name ]);
                      };
                  };
              };
          };
  ...
  var refreshData = Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(UI_UIStatesKit.turnOnLoading(".container")))(function () {
      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(Network_Eth_Metamask.loggedIn))(function (v) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(Network_Eth_Metamask.currentUserAddress))(function (v1) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                  var $69 = {};
                  for (var $70 in v2) {
                  ...
                  $69.myAddr = new Data_Maybe.Just(v1);
                  return $69;
              }))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                      if (v) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query["query'"](Data_Either.eqEither(Data_Eq.eqUnit)(Data_Eq.eqVoid))(Halogen_Component_ChildPath.cp1)(Data_Unit.unit)(new Debts.RefreshDebts(Data_Unit.unit)))(function (v2) {
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(Network_Eth_Metamask.loggedIn))(function (v3) {
                                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v4) {
                                      return v4.errorToDisplay;
                                  }))(function (v4) {
                                      var errorToDisplay = (function () {
                                          if (v3) {
                                              if (v4 instanceof Data_Maybe.Just && v4.value0 instanceof FriendInDebt_Types.CheckMetamask) {
                                                  return Data_Maybe.Nothing.value;
                                              };
                                              return v4;
                                          };
                                      ...
                                      return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v5) {
                                          var $78 = {};
                                          for (var $79 in v5) {
                                              if ({}.hasOwnProperty.call(v5, $79)) {
                                                  $78[$79] = v5[$79];
                                              };
                                          };
                                          $78.loggedIn = v3;
                                          $78.errorToDisplay = errorToDisplay;
                                          return $78;
                                      });
                                  });
                              });
                      ...
                      return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                          ...
                          $81.loggedIn = false;
                          $81.errorToDisplay = new Data_Maybe.Just(FriendInDebt_Types.CheckMetamask.value);
                          return $81;
                      });
                  })())(function () {
                      return Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(UI_UIStatesKit.toggleLoading(".container"));
                  });
              });
          });
      });
      ...
      return function (state) {
          var menuText = (function () {
              if (screen instanceof FriendInDebt_Routes.SettingsScreen) {
                  return [ Halogen_HTML_Elements.i([ Halogen_HTML_Properties.class_("fa fa-user") ])([  ]), Halogen_HTML_Core.text(Data_Maybe.maybe("")(Data_Show.show(Network_Eth_Foundation.showFoundationId))(state.myId)) ];
              };
              if (screen instanceof FriendInDebt_Routes.PendingScreen) {
                  return Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Halogen_HTML_Core.text(FriendInDebt_Routes.getMenuNameFor(screen)) ])((function () {
                      var $85 = (state.numPendingTodo + state.numPendingFriends | 0) > 0;
                      if ($85) {
          ...
          return Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href("#"), Halogen_HTML_Properties.class_(Halogen_HTML_Core.ClassName("col-3 " + (function () {
              var $86 = Data_Eq.eq(FriendInDebt_Routes.eqScreen)(screen)(state.currentScreen);
              if ($86) {
                  return "active";
              };
              return "";
          })())), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(SetScreen.create(screen))) ])(menuText);
      };
  };
  var menu = function (state) {
      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("header-menu row") ])([ menuItem(FriendInDebt_Routes.BalancesScreen.value)(state), menuItem(FriendInDebt_Routes.FriendsScreen.value)(state), menuItem(FriendInDebt_Routes.PendingScreen.value)(state), menuItem(FriendInDebt_Routes.SettingsScreen.value)(state) ]);
  };
  var loadWeb3Loop = function (delayMs) {
      return function (numTriesLeft) {
          var $88 = numTriesLeft > 0;
          if ($88) {
          ...
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v) {
              ...
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                  ...
                  throw new Error("Failed pattern match at Container line 388, column 7 - line 390, column 58: " + [ v.constructor.name ]);
              })())(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
              });
          });
  ...
  var errorOverlay = function (state) {
      if (state.errorToDisplay instanceof Data_Maybe.Nothing) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.id_("no-errors") ])([  ]);
      };
      if (state.errorToDisplay instanceof Data_Maybe.Just && state.errorToDisplay.value0 instanceof FriendInDebt_Types.WrongEthNetwork) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.id_("errorOverlay") ])([ Halogen_HTML_Elements.h6_([ Halogen_HTML_Core.text("Connected to wrong Ethereum network. Please switch your client to use Ropsten Test Network.") ]), Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(RefreshData.create)), Halogen_HTML_Properties.class_("error-action") ])([ Halogen_HTML_Elements.i([ Halogen_HTML_Properties.class_("fa fa-refresh") ])([  ]) ]) ]);
      };
      if (state.errorToDisplay instanceof Data_Maybe.Just && state.errorToDisplay.value0 instanceof FriendInDebt_Types.CheckMetamask) {
      ...
      if (state.errorToDisplay instanceof Data_Maybe.Just && state.errorToDisplay.value0 instanceof FriendInDebt_Types.FIDError) {
          if (state.errorToDisplay.value0.value0 instanceof Network_Eth_FriendInDebt_Types.NoFoundationId) {
              return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.id_("errorOverlay") ])([ Halogen_HTML_Elements.h6_([ Halogen_HTML_Core.text("No Foundation Id Detected") ]), Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href("http://fmanager.io"), Halogen_HTML_Properties.class_("error-action") ])([ Halogen_HTML_Elements.i([ Halogen_HTML_Properties.class_("fa fa-user-plus") ])([  ]), Halogen_HTML_Core.text("Register") ]) ]);
          };
      ...
      throw new Error("Failed pattern match at Container line 207, column 3 - line 243, column 36: " + [ state.errorToDisplay.constructor.name ]);
  };
  var checkMetamask = function (loggedIn) {
      return function (mmStatus) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v) {
              ...
              var $105 = loggedIn && mmStatus;
              if ($105) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Data_Functor.map(Halogen_Query_HalogenM.functorHalogenM)(Data_Maybe.Just.create)(Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(Network_Eth_Metamask.currentUserAddress)))(function (v1) {
                      var $107 = Data_Maybe.isNothing(v) || Data_Eq.notEq(Data_Maybe.eqMaybe(Network_Eth.eqEthAddress))(v)(v1);
                      if ($107) {
                          return refreshData;
                      };
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
  ...
  var ui = (function () {
      var render = function (state) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.id_("container"), Halogen_HTML_Properties.class_(Halogen_HTML_Core.ClassName("container " + FriendInDebt_Routes.getRouteNameFor(state.currentScreen))) ])([ errorOverlay(state), topBar(state), menu(state), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("create-debt-bar") ])([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href("#"), Halogen_HTML_Properties.class_(""), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(SetScreen.create(FriendInDebt_Routes.CreateDebtScreen.value))) ])([ Halogen_HTML_Elements.i([ Halogen_HTML_Properties.class_("fa fa-plus") ])([  ]), Halogen_HTML_Core.text("Add New Debt") ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("add-friend-bar") ])([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href("#"), Halogen_HTML_Properties.class_(""), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(SetScreen.create(FriendInDebt_Routes.AddFriendScreen.value))) ])([ Halogen_HTML_Elements.i([ Halogen_HTML_Properties.class_("fa fa-plus") ])([  ]), Halogen_HTML_Core.text("Add New Friend") ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("row main-view") ])([ Halogen_HTML["slot'"](Halogen_Component_ChildPath.cp1)(Data_Unit.unit)(Debts.component)(state.errorBus)(Halogen_HTML_Events.input(DebtViewMsg.create)) ]) ]);
      };
      var initialState = {
          loggedIn: false, 
          myId: Data_Maybe.Nothing.value, 
          myAddr: Data_Maybe.Nothing.value, 
          errorBus: Data_Maybe.Nothing.value, 
          errorToDisplay: Data_Maybe.Nothing.value, 
          txs: [  ], 
          numPendingTodo: 0, 
          numPendingFriends: 0, 
          currentScreen: FriendInDebt_Routes.BalancesScreen.value, 
          history: [  ], 
          logText: [  ]
      };
      var $$eval = function (v) {
          if (v instanceof Init) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Network_Eth_Metamask.hasWeb3))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                      var $110 = !v1;
                      if ($110) {
                          return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                              ...
                              $111.errorToDisplay = new Data_Maybe.Just(FriendInDebt_Types.CheckMetamask.value);
                              return $111;
                          });
                      };
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(Network_Eth_Metamask.getNetwork))(function (v2) {
                          var $115 = v2 !== FriendInDebt_Config.networkId;
                          if ($115) {
                              return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                                  ...
                                  $116.errorToDisplay = new Data_Maybe.Just(FriendInDebt_Types.WrongEthNetwork.value);
                                  return $116;
                              });
                          };
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(Control_Monad_Aff_Bus.make))(function (v3) {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(UI_UIStatesKit.toggleLoading(".container")))(function () {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.subscribe(Halogen_Component_Utils.busEventSource(Control_Monad_Aff_Class.monadAffAff)(Data_Function.flip(HandleMsg.create)(Halogen_Query_EventSource.Listening.value))(v3)))(function () {
                                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v4) {
                                          var $120 = {};
                                          for (var $121 in v4) {
                                          ...
                                          $120.loggedIn = true;
                                          $120.errorBus = new Data_Maybe.Just(v3);
                                          return $120;
                                      }))(function () {
                                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(loadWeb3Loop(FriendInDebt_Config.web3Delay)(30))(function () {
                                              return startCheckInterval(Halogen_Query_HalogenM.applicativeHalogenM)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(new Data_Maybe.Just(v3))(FriendInDebt_Config.checkMMInterval)(FriendInDebt_Config.checkTxInterval);
                                          });
                                      });
                                  });
                              });
          ...
          if (v instanceof HandleMsg) {
              if (v.value0 instanceof FriendInDebt_Types.WrongEthNetwork) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                      var $125 = {};
                      for (var $126 in v1) {
                      ...
                      $125.errorToDisplay = new Data_Maybe.Just(FriendInDebt_Types.WrongEthNetwork.value);
                      return $125;
                  }))(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                  });
              ...
              if (v.value0 instanceof FriendInDebt_Types.NetworkError) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(FriendInDebt_Prelude.hLog(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(FriendInDebt_Types.showContainerMsg)(FriendInDebt_Types.NetworkError.value))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(UI_UIStatesKit.clearAllLoading(Data_Maybe.Nothing.value)))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                              var $128 = {};
                              for (var $129 in v1) {
                              ...
                              $128.loggedIn = false;
                              $128.errorToDisplay = new Data_Maybe.Just(FriendInDebt_Types.NetworkError.value);
                              return $128;
                          }))(function () {
                              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                          });
              ...
              if (v.value0 instanceof FriendInDebt_Types.FIDError) {
                  if (v.value0.value0 instanceof Network_Eth_FriendInDebt_Types.NoFoundationId) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                          ...
                          $132.myId = Data_Maybe.Nothing.value;
                          $132.errorToDisplay = new Data_Maybe.Just(new FriendInDebt_Types.FIDError(v.value0.value0));
                          return $132;
                      }))(function () {
                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                      });
                      ...
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(FriendInDebt_Prelude.hLog(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Network_Eth_FriendInDebt_Types.showError)(Network_Eth_FriendInDebt_Types.NetworkError.value))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(UI_UIStatesKit.clearAllLoading(Data_Maybe.Nothing.value)))(function () {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                                  ...
                                  $135.loggedIn = false;
                                  $135.errorToDisplay = new Data_Maybe.Just(new FriendInDebt_Types.FIDError(v.value0.value0));
                                  return $135;
                              }))(function () {
                                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                              });
                  ...
                  if (v.value0.value0 instanceof Network_Eth_FriendInDebt_Types.TxError) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(FriendInDebt_Prelude.hLog(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Data_Show.showString)("Transaction cancelled or error"))(function () {
                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                      });
                  };
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(FriendInDebt_Prelude.hLog(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Network_Eth_FriendInDebt_Types.showError)(v.value0.value0))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(refreshData)(function () {
                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                      });
                  });
              ...
              if (v.value0 instanceof FriendInDebt_Types.CheckMetamask) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(Network_Eth_Metamask.loggedIn))(function (v1) {
              ...
              if (v.value0 instanceof FriendInDebt_Types.CheckTxs) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                      return v1.txs;
                  }))(function (v1) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                          ...
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(Data_Traversable.sequence(Data_Traversable.traversableArray)(Control_Monad_Aff.applicativeAff)(Data_Functor.map(Data_Functor.functorArray)(Network_Eth_Metamask.checkTxStatus)(v1))))(function (v3) {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                                  var $144 = FriendInDebt_Blockchain.hasNetworkError(v3);
                                  if ($144) {
                                      if (v2 instanceof Data_Maybe.Nothing) {
                                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                                      };
                                      ...
                                      throw new Error("Failed pattern match at Container line 165, column 20 - line 167, column 63: " + [ v2.constructor.name ]);
                                  };
                                  var pending = Data_Array.filter(function (v4) {
                                      return Network_Eth.notDone(v4.value0);
                                  })(Data_Array.zip(v3)(v1));
                                  var $150 = Data_Array.length(pending) !== Data_Array.length(v1);
                                  if ($150) {
                                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v4) {
                                          var $154 = {};
                                          for (var $155 in v4) {
                                              if ({}.hasOwnProperty.call(v4, $155)) {
                                                  $154[$155] = v4[$155];
                                              };
                                          };
                                          $154.txs = Data_Functor.map(Data_Functor.functorArray)(function (v5) {
                                              return v5.value1;
                                          })(pending);
                                          return $154;
                                      }))(function () {
                                          var $157 = Data_Array.length(pending) === 0;
                                          if ($157) {
                                              return refreshData;
                                          };
                                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
              ...
              throw new Error("Failed pattern match at Container line 129, column 9 - line 175, column 22: " + [ v.value0.constructor.name ]);
          };
          ...
          if (v instanceof SetScreen) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                  var $161 = {};
                  for (var $162 in state) {
                      if ({}.hasOwnProperty.call(state, $162)) {
                          $161[$162] = state[$162];
                      };
                  };
                  $161.history = Data_Semigroup.append(Data_Semigroup.semigroupArray)([ state.currentScreen ])(state.history);
                  return $161;
              }))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                      var $164 = {};
              ...
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                  if (v.value0 instanceof Debts.ScreenChange) {
                      return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (s) {
                          var $170 = {};
                          for (var $171 in s) {
                              if ({}.hasOwnProperty.call(s, $171)) {
                                  $170[$171] = s[$171];
                              };
                          };
                          $170.history = Data_Semigroup.append(Data_Semigroup.semigroupArray)([ s.currentScreen ])(s.history);
                          $170.currentScreen = v.value0.value0;
                          return $170;
                      });
                  };
                  if (v.value0 instanceof Debts.NewTX) {
                      return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (s) {
                          ...
                          $174.txs = Data_Semigroup.append(Data_Semigroup.semigroupArray)(s.txs)([ v.value0.value0 ]);
                          return $174;
                      });
                  };
                  if (v.value0 instanceof Debts.NumPendingTodo) {
                      return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                          ...
                          $178.numPendingTodo = v.value0.value0;
                          return $178;
                      });
                  };
                  if (v.value0 instanceof Debts.NumPendingFriends) {
                      return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                          ...
                          $182.numPendingFriends = v.value0.value0;
                          return $182;
                      });
                  };
                  if (v.value0 instanceof Debts.LoadId) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                          return v1.errorToDisplay;
                      }))(function (v1) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                              var $187 = {};
                              for (var $188 in v2) {
                              ...
                              $187.myId = new Data_Maybe.Just(v.value0.value0);
                              return $187;
                          }))(function () {
                              if (v1 instanceof Data_Maybe.Just && (v1.value0 instanceof FriendInDebt_Types.FIDError && v1.value0.value0 instanceof Network_Eth_FriendInDebt_Types.NoFoundationId)) {
                                  return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                                      var $191 = {};
                                      for (var $192 in v2) {
                                          if ({}.hasOwnProperty.call(v2, $192)) {
                                              $191[$192] = v2[$192];
                                          };
                                      };
                                      $191.errorToDisplay = v1;
                                      return $191;
                                  });
                              };
                              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                  ...
                  throw new Error("Failed pattern match at Container line 184, column 9 - line 199, column 31: " + [ v.value0.constructor.name ]);
              })())(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
              });
          };
          if (v instanceof PreviousScreen) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                  var $199 = {};
                  for (var $200 in state) {
                      if ({}.hasOwnProperty.call(state, $200)) {
                          $199[$200] = state[$200];
                      };
                  };
                  $199.currentScreen = Data_Maybe.fromMaybe(FriendInDebt_Routes.BalancesScreen.value)(Data_Array.head(state.history));
                  $199.history = Data_Maybe.fromMaybe([  ])(Data_Array.tail(state.history));
                  return $199;
              }))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
              });
          };
          throw new Error("Failed pattern match at Container line 112, column 12 - line 203, column 18: " + [ v.constructor.name ]);
      };
  ...
  exports["DebtViewMsg"] = DebtViewMsg;
  exports["checkMetamask"] = checkMetamask;
  exports["errorOverlay"] = errorOverlay;
  exports["loadWeb3Loop"] = loadWeb3Loop;
  exports["menu"] = menu;
