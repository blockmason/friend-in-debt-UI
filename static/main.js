...
(function(exports) {
  ...
  var showDebtType = new Data_Show.Show(function (debtType) {
      ...
      throw new Error("Failed pattern match at Debts line 652, column 3 - line 656, column 1: " + [ debtType.constructor.name ]);
  });
                          ...
                          return function (strAmount) {
                              ...
                              var counterparty = function (debt) {
                                  return function (dType) {
                                      return function (v1) {
                                          ...
                                          throw new Error("Failed pattern match at Debts line 702, column 41 - line 704, column 59: " + [ dType.constructor.name ]);
                                      };
                                  };
                              };
                              ...
                              if (v1 instanceof Data_Maybe.Just) {
                                  ...
                                  var sendMsg = (function () {
                                      ...
                                      throw new Error("Failed pattern match at Debts line 667, column 22 - line 669, column 11: " + [ debtType.constructor.name ]);
                                  })();
                                  var d = (function () {
                                      if (debtType instanceof Debt) {
                                      ...
                                      throw new Error("Failed pattern match at Debts line 664, column 15 - line 666, column 81: " + [ debtType.constructor.name ]);
                                  })();
                              ...
                              throw new Error("Failed pattern match at Debts line 661, column 3 - line 699, column 11: " + [ v1.constructor.name ]);
                          };
                      };
                  };
              };
  ...
  var idSpan = function (me) {
      return function (idToDisplay) {
          ...
          throw new Error("Failed pattern match at Debts line 577, column 6 - line 579, column 167: " + [ isItMe.constructor.name ]);
      };
  };
  ...
  var displayItemizedDebtTimeline = function (friendToShow) {
      return function (debtsMap) {
          return function (curFriend) {
              ...
              throw new Error("Failed pattern match at Debts line 315, column 3 - line 325, column 37: " + [ friendToShow.constructor.name ]);
          };
      };
  };
      ...
      var $$eval = function (v) {
                  ...
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                      ...
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(FriendInDebt_Prelude.hLog(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Data_Maybe.showMaybe(Network_Eth_FriendInDebt_Types.showMoney))(Network_Eth_FriendInDebt_Types.moneyFromDecString(v1)(v.value1)))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                              ...
                              throw new Error("Failed pattern match at Debts line 191, column 7 - line 193, column 61: " + [ v.value0.constructor.name ]);
                          })())(function () {
          ...
          if (v instanceof InputDebtDetails) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                  ...
                  throw new Error("Failed pattern match at Debts line 196, column 7 - line 198, column 56: " + [ v.value0.constructor.name ]);
              })())(function () {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
          ...
          if (v instanceof AddDebt) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(FriendInDebt_Prelude.hLog(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Data_Maybe.showMaybe(Network_Eth_FriendInDebt_Types.showDebt))(v.value0))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                      ...
                      throw new Error("Failed pattern match at Debts line 205, column 7 - line 213, column 30: " + [ v.value0.constructor.name ]);
                  })())(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                  });
              });
          ...
          throw new Error("Failed pattern match at Debts line 139, column 10 - line 233, column 16: " + [ v.constructor.name ]);
      };
...
(function(exports) {
              ...
              return function (maybeBus) {
                  return function (mmInterval) {
                      return function (txInterval) {
                          ...
                          throw new Error("Failed pattern match at Container line 226, column 3 - line 231, column 16: " + [ maybeBus.constructor.name ]);
                      };
                  };
              };
          };
      ...
      return function (numTriesLeft) {
          ...
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v) {
              ...
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                  ...
                  throw new Error("Failed pattern match at Container line 363, column 7 - line 365, column 58: " + [ v.constructor.name ]);
              })())(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
              });
          });
  ...
  var ui = (function () {
      ...
      var $$eval = function (v) {
          ...
          throw new Error("Failed pattern match at Container line 112, column 12 - line 183, column 18: " + [ v.constructor.name ]);
      };
