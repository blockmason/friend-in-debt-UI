...
(function(exports) {
  ...
  var zeroDebt = function (cur) {
      return function (debtor) {
          return function (creditor) {
              return function (toConfirm) {
                  return mkDebt(debtor)(creditor)(toConfirm)(mkMoney(0.0)(cur))(NoDebtId.value)("");
              };
          };
      };
  };
  ...
  var debtCounterparty = function (myId) {
      return function (v) {
          var $125 = Data_Eq.eq(Network_Eth_Foundation.eqFoundationId)(v.debtor)(myId);
          if ($125) {
              return v.creditor;
          };
          return v.debtor;
      ...
      return function (rb) {
          var debtorCreditor = function (myId) {
              return function (cpId) {
                  return function (val) {
                      var $131 = val >= Data_Int.toNumber(0);
                      if ($131) {
  ...
  var conversionFactor = function ($149) {
      return $$Math.pow(10.0)(Data_Int.toNumber(cDecimals($149)));
  };
  ...
  exports["debtSetCreditor"] = debtSetCreditor;
  exports["debtSetDebtor"] = debtSetDebtor;
...
(function(exports) {
  ...
  var InputDebtAmount = (function () {
      function InputDebtAmount(value0, value1, value2) {
          this.value0 = value0;
          this.value1 = value1;
          this.value2 = value2;
      };
      InputDebtAmount.create = function (value0) {
          return function (value1) {
              return function (value2) {
                  return new InputDebtAmount(value0, value1, value2);
              };
          };
      };
      return InputDebtAmount;
  })();
  ...
  var AddDebt = (function () {
      function AddDebt(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      AddDebt.create = function (value0) {
          return function (value1) {
              return new AddDebt(value0, value1);
          };
      };
      return AddDebt;
  })();
                          ...
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(FriendInDebt_Blockchain.handleCall(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.monadEffHalogenM(dictMonadEff))(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(errorBus)(Network_Eth_FriendInDebt_Types.blankPendingDebts)(Network_Eth_FriendInDebt.pendingDebts))(function (v3) {
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(FriendInDebt_Blockchain.handleCall(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.monadEffHalogenM(dictMonadEff))(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(errorBus)([  ])(Network_Eth_FriendInDebt.debtBalances))(function (v4) {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v5) {
                                      ...
                                      $66.myId = v;
                                      $66.friends = v1;
                                      $66.pendingFriendsSent = Network_Eth_FriendInDebt_Types.pfGetSents(v2);
                                      $66.pendingFriendsTodo = Network_Eth_FriendInDebt_Types.pfGetTodos(v2);
                                      $66.pendingSent = Network_Eth_FriendInDebt_Types.pdGetSents(v3);
                                      $66.pendingTodo = Network_Eth_FriendInDebt_Types.pdGetTodos(v3);
                                      $66.balances = v4;
                                      return $66;
                                  }))(function () {
          ...
          return function (cur) {
              return function (myId) {
                  return function (friends) {
                      return function (maybeDebt) {
                          return function (strAmount) {
                              var setMoney = function (d) {
                                  return function (strA) {
                                      return Data_Functor.map(Data_Maybe.functorMaybe)(Network_Eth_FriendInDebt_Types.setDebtMoney(d))(Network_Eth_FriendInDebt_Types.moneyFromDecString(cur)(strA));
                                  };
                              };
                              var counterparty = function (debt) {
                                  return function (dType) {
                                      return function (v1) {
                                          if (dType instanceof Debt) {
                                              return Network_Eth_FriendInDebt_Types.debtSetCreditor(debt)(Network_Eth_Foundation.fiMkId(v1));
                                          };
                                          if (dType instanceof Credit) {
                                              return Network_Eth_FriendInDebt_Types.debtSetDebtor(debt)(Network_Eth_Foundation.fiMkId(v1));
                                          };
                                          throw new Error("Failed pattern match at Debts line 717, column 41 - line 719, column 59: " + [ dType.constructor.name ]);
                                      };
                                  };
                              };
                              var v1 = Data_Array.head(friends);
                              if (v1 instanceof Data_Maybe.Nothing) {
                                  return Halogen_HTML_Elements.div_([  ]);
                              };
                              if (v1 instanceof Data_Maybe.Just) {
                                  var showCents = (function () {
                                      var v2 = Network_Eth_FriendInDebt_Types.cDecimals(cur);
                                      if (v2 === 0) {
                                          return "";
                                      };
                                      return "show-cents";
                                  ...
                                  var sendMsg = (function () {
                                      ...
                                      throw new Error("Failed pattern match at Debts line 682, column 22 - line 684, column 11: " + [ debtType.constructor.name ]);
                                  })();
                                  var d = (function () {
                                      if (debtType instanceof Debt) {
                                          return Data_Maybe.fromMaybe(Network_Eth_FriendInDebt_Types.zeroDebt(cur)(myId)(v1.value0)(v1.value0))(maybeDebt);
                                      };
                                      if (debtType instanceof Credit) {
                                          return Data_Maybe.fromMaybe(Network_Eth_FriendInDebt_Types.zeroDebt(cur)(v1.value0)(myId)(v1.value0))(maybeDebt);
                                      };
                                      throw new Error("Failed pattern match at Debts line 679, column 15 - line 681, column 81: " + [ debtType.constructor.name ]);
                                  })();
                                  ...
                                  })) ]), Halogen_HTML_Elements.span_([ Halogen_HTML_Core.text(Network_Eth_FriendInDebt_Types.cIsoCode(cur)) ]) ]), Halogen_HTML_Elements.select([ Halogen_HTML_Events.onValueChange(Halogen_HTML_Events.input(function (v2) {
                                      return InputDebtDetails.create(debtType)(counterparty(d)(debtType)(v2));
                                  })) ])(Data_Functor.map(Data_Functor.functorArray)(function (f) {
                              ...
                              throw new Error("Failed pattern match at Debts line 676, column 3 - line 714, column 11: " + [ v1.constructor.name ]);
                          };
                      };
                  };
              };
  ...
  var debtRelationshipSpan = function (me) {
      return function (fd) {
          var relationship = (function () {
              var $88 = Data_Eq.eq(Network_Eth_Foundation.eqFoundationId)(Network_Eth_FriendInDebt_Types.debtDebtor(fd))(me);
              if ($88) {
                  return "owe";
              };
              return "owes";
  ...
  var itemizedDebtLi = function (fd) {
      return Halogen_HTML_Elements.li([ Halogen_HTML_Properties.class_("timeline-event") ])(itemizedDebt(fd));
  };
  ...
  var displayBalanceLi = function (state) {
      return function (bal) {
          ...
          var curFriend = (function () {
              var $95 = Data_Eq.eq(Network_Eth_Foundation.eqFoundationId)(creditor)(state.myId);
              if ($95) {
                  return debtor;
              };
              return creditor;
          ...
          var expandClass = Data_Functor.map(Data_Maybe.functorMaybe)(function (f) {
              var $96 = Data_Eq.eq(Network_Eth_Foundation.eqFoundationId)(f)(curFriend);
              if ($96) {
          ...
          var status = (function () {
              var $97 = Data_Eq.eq(Network_Eth_Foundation.eqFoundationId)(creditor)(state.myId);
              if ($97) {
                  return "Holds debts from:";
              };
              return "Is owing...";
          })();
  ...
  var component = (function () {
      ...
      var initialState = function (input) {
          return {
              ...
              newDebtAmount: "", 
              newCreditAmount: "", 
              newDebt: Data_Maybe.Nothing.value, 
              newCredit: Data_Maybe.Nothing.value, 
      ...
      var $$eval = function (v) {
          if (v instanceof ShowItemizedDebtFor) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.raise(new ScreenChange(FriendInDebt_Routes.ItemizedDebtsScreen.value)))(function () {
                  ...
                  if (v.value0 instanceof Data_Maybe.Just) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                              ...
                              $102.showItemizedDebtFor = v.value0;
                              return $102;
                          }))(function () {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(UI_UIStatesKit.toggleLoading(".itemized-debts")))(function () {
                                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(FriendInDebt_Blockchain.handleCall(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(v1.errorBus)([  ])(Network_Eth_FriendInDebt.itemizedDebts(v.value0.value0)))(function (v2) {
                                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                                          ...
                                          $106.itemizedDebts = Data_Map.insert(Network_Eth_Foundation.ordFoundationId)(v.value0.value0)(v2)(v1.itemizedDebts);
                                          return $106;
                                      }))(function () {
                                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(UI_UIStatesKit.toggleLoading(".itemized-debts")))(function () {
                                              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                  ...
                  throw new Error("Failed pattern match at Debts line 145, column 7 - line 156, column 20: " + [ v.value0.constructor.name ]);
              });
          };
          if (v instanceof HandleInput) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  ...
                  if (v2 === 0) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Data_Traversable.sequence(Data_Traversable.traversableArray)(Control_Monad_Eff.applicativeEff)(Data_Functor.map(Data_Functor.functorArray)(Data_Function["const"](UI_IconGenerator.randomGradient))(v1.friends))))(function (v3) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v4) {
                              var $115 = {};
                              for (var $116 in v4) {
                                  if ({}.hasOwnProperty.call(v4, $116)) {
                                      $115[$116] = v4[$116];
                                  };
                              };
                              $115.errorBus = v.value0;
                              $115.gradients = v3;
                              return $115;
                          }))(function () {
                              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                      var $118 = {};
                      for (var $119 in v3) {
                          if ({}.hasOwnProperty.call(v3, $119)) {
                              $118[$119] = v3[$119];
                          };
                      };
                      $118.errorBus = v.value0;
                      return $118;
                  }))(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                  });
                      ...
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                          if (v2) {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                                  ...
                                  return FriendInDebt_Prelude.hLog(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Data_Show.showString)(v.value0 + " is already in use.");
                              });
                          };
          ...
          if (v instanceof InputFriend) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                      var $143 = Network_Eth_Foundation.fiStrValidId(Data_String.toLower(v.value0)) || Data_String.length(v.value0) < 4;
                      if ($143) {
                          return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                              ...
                              $144.newFriend = Data_String.toLower(v.value0);
                              return $144;
                          });
                      };
                      return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
          ...
          if (v instanceof InputDebtAmount) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (s) {
                  ...
                  $152.inputChanged = !s.inputChanged;
                  return $152;
              }))(function () {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                      return v1.defaultCurrency;
                  }))(function (v1) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(FriendInDebt_Prelude.hLog(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Data_Maybe.showMaybe(Network_Eth_FriendInDebt_Types.showMoney))(Network_Eth_FriendInDebt_Types.moneyFromDecString(v1)(v.value1)))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                              ...
                              if (v.value0 instanceof Credit) {
                                  return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                                      ...
                                      $160.newCreditAmount = v.value1;
                                      return $160;
                                  });
                              };
                              throw new Error("Failed pattern match at Debts line 206, column 7 - line 208, column 61: " + [ v.value0.constructor.name ]);
                          })())(function () {
              ...
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                  if (v.value0 instanceof Debt) {
                      return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                          ...
                          $167.newDebt = new Data_Maybe.Just(v.value1);
                          return $167;
                      });
                  };
                  if (v.value0 instanceof Credit) {
                      return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                          ...
                          $170.newCredit = new Data_Maybe.Just(v.value1);
                          return $170;
                      });
                  };
                  throw new Error("Failed pattern match at Debts line 211, column 7 - line 213, column 56: " + [ v.value0.constructor.name ]);
              })())(function () {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                      ...
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (s) {
                          ...
                          $174.inputChanged = !s.inputChanged;
                          return $174;
                      }))(function () {
          ...
          if (v instanceof AddDebt) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(FriendInDebt_Prelude.hLog(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Data_Maybe.showMaybe(Network_Eth_FriendInDebt_Types.showDebt))(v.value0))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                      if (v.value0 instanceof Data_Maybe.Just) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                              var $181 = {};
                                  ...
                                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(FriendInDebt_Blockchain.handleTx(Control_Monad_Aff.monadEffAff)(Control_Monad_Aff_Class.monadAffAff)(NewTX.create)(v1)(new ScreenChange(FriendInDebt_Routes.BalancesScreen.value))(Network_Eth_FriendInDebt.newPendingDebt(v.value0.value0)))(function () {
                                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                                              var $185 = {};
                                              for (var $186 in v2) {
                                                  if ({}.hasOwnProperty.call(v2, $186)) {
                                                      $185[$186] = v2[$186];
                                                  };
                                              };
                                              $185.newDebt = Data_Maybe.Nothing.value;
                                              $185.newCredit = Data_Maybe.Nothing.value;
                                              return $185;
                                          }))(function () {
                                              return Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(UI_UIStatesKit.toggleLoading(".create-debt-button"));
                                          });
                                      });
                                  });
                              });
                      ...
                      throw new Error("Failed pattern match at Debts line 220, column 7 - line 228, column 30: " + [ v.value0.constructor.name ]);
                  })())(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                  });
              });
          ...
          throw new Error("Failed pattern match at Debts line 141, column 10 - line 248, column 16: " + [ v.constructor.name ]);
      };
  ...
  exports["InputDebtAmount"] = InputDebtAmount;
...
(function(exports) {
              ...
              return function (maybeBus) {
                  return function (mmInterval) {
                      return function (txInterval) {
                          ...
                          throw new Error("Failed pattern match at Container line 238, column 3 - line 243, column 16: " + [ maybeBus.constructor.name ]);
                      };
                  };
              };
          };
      ...
      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Network_Eth_Metamask.loggedIn))(function (v) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                      ...
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Network_Eth_Metamask.loggedIn))(function (v2) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                              ...
                              return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v4) {
                                  ...
                                  $79.loggedIn = v2;
                                  $79.errorToDisplay = errorToDisplay;
                                  return $79;
                              });
                          });
                      });
              ...
              return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  $82.loggedIn = false;
                  $82.errorToDisplay = new Data_Maybe.Just(FriendInDebt_Types.CheckMetamask.value);
                  return $82;
              });
          })())(function () {
  ...
  var menuItem = function (screen) {
      return function (state) {
          var menuText = (function () {
              ...
              if (screen instanceof FriendInDebt_Routes.PendingScreen) {
                  return Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Halogen_HTML_Core.text(FriendInDebt_Routes.getMenuNameFor(screen)) ])((function () {
                      var $86 = (state.numPendingTodo + state.numPendingFriends | 0) > 0;
                      if ($86) {
          ...
          return Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href("#"), Halogen_HTML_Properties.class_(Halogen_HTML_Core.ClassName("col-3 " + (function () {
              var $87 = Data_Eq.eq(FriendInDebt_Routes.eqScreen)(screen)(state.currentScreen);
              if ($87) {
                  return "active";
              };
              return "";
      ...
      return function (numTriesLeft) {
          ...
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v) {
              ...
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                  ...
                  throw new Error("Failed pattern match at Container line 374, column 7 - line 376, column 58: " + [ v.constructor.name ]);
              })())(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
              });
          });
  ...
  var errorOverlay = function (state) {
      ...
      if (state.errorToDisplay instanceof Data_Maybe.Just && state.errorToDisplay.value0 instanceof FriendInDebt_Types.CheckMetamask) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.id_("errorOverlay") ])([ Halogen_HTML_Elements.h6_([ Halogen_HTML_Core.text(Data_Show.show(FriendInDebt_Types.showContainerMsg)(FriendInDebt_Types.CheckMetamask.value)) ]), Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(RefreshData.create)), Halogen_HTML_Properties.class_("error-action") ])([ Halogen_HTML_Elements.i([ Halogen_HTML_Properties.class_("fa fa-refresh") ])([  ]) ]) ]);
      };
      ...
      throw new Error("Failed pattern match at Container line 188, column 3 - line 217, column 36: " + [ state.errorToDisplay.constructor.name ]);
  };
  var checkMetamask = function (loggedIn) {
      return function (mmStatus) {
          var $104 = loggedIn && mmStatus;
          if ($104) {
              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
          };
          return refreshData;
  ...
  var ui = (function () {
      ...
      var $$eval = function (v) {
                  ...
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(Control_Monad_Aff_Bus.make))(function (v1) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.subscribe(Halogen_Component_Utils.busEventSource(Control_Monad_Aff_Class.monadAffAff)(Data_Function.flip(HandleMsg.create)(Halogen_Query_EventSource.Listening.value))(v1)))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                              ...
                              $107.loggedIn = true;
                              $107.errorBus = new Data_Maybe.Just(v1);
                              return $107;
                          }))(function () {
          ...
          if (v instanceof HandleMsg) {
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(FriendInDebt_Prelude.hLog(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(FriendInDebt_Types.showContainerMsg)(FriendInDebt_Types.NetworkError.value))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(UI_UIStatesKit.clearAllLoading(Data_Maybe.Nothing.value)))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                              ...
                              $112.loggedIn = false;
                              $112.errorToDisplay = new Data_Maybe.Just(FriendInDebt_Types.NetworkError.value);
                              return $112;
                          }))(function () {
                              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                          });
              ...
              if (v.value0 instanceof FriendInDebt_Types.FIDError) {
                  if (v.value0.value0 instanceof Network_Eth_FriendInDebt_Types.NoFoundationId) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                          ...
                          $116.myId = Data_Maybe.Nothing.value;
                          $116.errorToDisplay = new Data_Maybe.Just(new FriendInDebt_Types.FIDError(v.value0.value0));
                          return $116;
                      }))(function () {
                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                      });
                      ...
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(FriendInDebt_Prelude.hLog(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Network_Eth_FriendInDebt_Types.showError)(Network_Eth_FriendInDebt_Types.NetworkError.value))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(UI_UIStatesKit.clearAllLoading(Data_Maybe.Nothing.value)))(function () {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                                  ...
                                  $119.loggedIn = false;
                                  $119.errorToDisplay = new Data_Maybe.Just(new FriendInDebt_Types.FIDError(v.value0.value0));
                                  return $119;
                              }))(function () {
                                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                              });
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(FriendInDebt_Prelude.hLog(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Data_Show.showString)("some FID problem"))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                          var $122 = {};
                          for (var $123 in v1) {
                          ...
                          $122.loggedIn = false;
                          $122.errorToDisplay = new Data_Maybe.Just(new FriendInDebt_Types.FIDError(v.value0.value0));
                          return $122;
                      }))(function () {
                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                      });
                  ...
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                      ...
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                          ...
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(Data_Traversable.sequence(Data_Traversable.traversableArray)(Control_Monad_Aff.applicativeAff)(Data_Functor.map(Data_Functor.functorArray)(Network_Eth_Metamask.checkTxStatus)(v1))))(function (v3) {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                                  var $131 = FriendInDebt_Blockchain.hasNetworkError(v3);
                                  if ($131) {
                                      if (v2 instanceof Data_Maybe.Nothing) {
                                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                                      };
                                  ...
                                  var $137 = Data_Array.length(pending) !== Data_Array.length(v1);
                                  if ($137) {
                                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v4) {
                                          var $141 = {};
                                          for (var $142 in v4) {
                                              if ({}.hasOwnProperty.call(v4, $142)) {
                                                  $141[$142] = v4[$142];
                                              };
                                          };
                                          $141.txs = Data_Functor.map(Data_Functor.functorArray)(function (v5) {
                                              return v5.value1;
                                          })(pending);
                                          return $141;
                                      }))(function () {
              ...
              throw new Error("Failed pattern match at Container line 120, column 9 - line 160, column 22: " + [ v.value0.constructor.name ]);
          };
          ...
          if (v instanceof SetScreen) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                  var $147 = {};
                  for (var $148 in state) {
                      if ({}.hasOwnProperty.call(state, $148)) {
                          $147[$148] = state[$148];
                      };
                  };
                  $147.history = Data_Semigroup.append(Data_Semigroup.semigroupArray)([ state.currentScreen ])(state.history);
                  return $147;
              }))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                      var $150 = {};
              ...
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                  if (v.value0 instanceof Debts.ScreenChange) {
                      return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (s) {
                          ...
                          $156.history = Data_Semigroup.append(Data_Semigroup.semigroupArray)([ s.currentScreen ])(s.history);
                          $156.currentScreen = v.value0.value0;
                          return $156;
                      });
                  };
                  if (v.value0 instanceof Debts.NewTX) {
                      return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (s) {
                          ...
                          $160.txs = Data_Semigroup.append(Data_Semigroup.semigroupArray)(s.txs)([ v.value0.value0 ]);
                          return $160;
                      });
                  };
                  if (v.value0 instanceof Debts.NumPendingTodo) {
                      return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                          ...
                          $164.numPendingTodo = v.value0.value0;
                          return $164;
                      });
                  };
                  if (v.value0 instanceof Debts.NumPendingFriends) {
                      return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                          ...
                          $168.numPendingFriends = v.value0.value0;
                          return $168;
                      });
                  };
                  if (v.value0 instanceof Debts.LoadId) {
                      return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                          ...
                          $172.myId = new Data_Maybe.Just(v.value0.value0);
                          return $172;
                      });
                  };
          ...
          if (v instanceof PreviousScreen) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                  var $178 = {};
                  for (var $179 in state) {
                      if ({}.hasOwnProperty.call(state, $179)) {
                          $178[$179] = state[$179];
                      };
                  };
                  $178.currentScreen = Data_Maybe.fromMaybe(FriendInDebt_Routes.BalancesScreen.value)(Data_Array.head(state.history));
                  $178.history = Data_Maybe.fromMaybe([  ])(Data_Array.tail(state.history));
                  return $178;
              }))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
              });
          };
          throw new Error("Failed pattern match at Container line 110, column 12 - line 184, column 18: " + [ v.constructor.name ]);
      };
