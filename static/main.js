...
(function(exports) {
  ...
  var debtCounterparty = function (myId) {
      return function (v) {
          var $99 = Data_Eq.eq(Network_Eth_Foundation.eqFoundationId)(v.debtor)(myId);
          if ($99) {
              return v.creditor;
          };
          return v.debtor;
...
(function(exports) {
  ...
  var InputDebtTarget = (function () {
      function InputDebtTarget(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      InputDebtTarget.create = function (value0) {
          return function (value1) {
              return new InputDebtTarget(value0, value1);
          };
      };
      return InputDebtTarget;
  })();
  var InputDebtDesc = (function () {
      function InputDebtDesc(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      InputDebtDesc.create = function (value0) {
          return function (value1) {
              return new InputDebtDesc(value0, value1);
          };
      };
      return InputDebtDesc;
  })();
  ...
  var inputDebt = function (nm) {
      return function (myId) {
          return function (maybeDebt) {
              return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("createDebt col row") ])([ Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputNumber.value), Halogen_HTML_Properties.class_("debt-amount col-2"), Halogen_HTML_Properties.value("0"), Halogen_HTML_Events.onValueInput(Halogen_HTML_Events.input(function (val) {
                  return InputDebtAmount.create(val);
              })), Halogen_HTML_Properties.min(Data_Int.toNumber(-1000000 | 0)), Halogen_HTML_Properties.max(Data_Int.toNumber(1000000)) ]), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputText.value), Halogen_HTML_Properties.class_("debt-description col "), Halogen_HTML_Properties.placeholder("debt description"), Halogen_HTML_Events.onValueInput(Halogen_HTML_Events.input(function (val) {
                  return InputDebtTarget.create(val);
              })), Halogen_HTML_Properties.value("") ]), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputText.value), Halogen_HTML_Properties.placeholder("debt description"), Halogen_HTML_Events.onValueInput(Halogen_HTML_Events.input(function (val) {
                  return InputDebtDesc.create(val);
              })), Halogen_HTML_Properties.value("") ]), Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(AddDebt.create(maybeDebt))), Halogen_HTML_Properties.class_("create-debt-button col-2") ])([ Halogen_HTML_Core.text("Debt " + Data_Show.show(Data_Maybe.showMaybe(Network_Eth_Foundation.showFoundationId))(Data_Functor.map(Data_Maybe.functorMaybe)(Network_Eth_FriendInDebt_Types.debtCounterparty(myId))(maybeDebt))) ]) ]);
          };
      };
  };
  var idSpan = function (me) {
      return function (idToDisplay) {
          ...
          throw new Error("Failed pattern match at Debts line 376, column 6 - line 378, column 125: " + [ isItMe.constructor.name ]);
      };
  };
                      ...
                      return function (fidAffCall) {
                          ...
                          if (errorBus instanceof Data_Maybe.Just) {
                              return Control_Bind.bind(dictBind)(Control_Monad_Aff_Class.liftAff(dictMonadAff)(Network_Eth_FriendInDebt.runMonadF(fidAffCall)))(function (v) {
                                  ...
                                  throw new Error("Failed pattern match at Debts line 493, column 7 - line 496, column 30: " + [ v.constructor.name ]);
                              });
                          };
                          throw new Error("Failed pattern match at Debts line 487, column 3 - line 496, column 30: " + [ errorBus.constructor.name ]);
                      };
                  };
              };
          };
                                  ...
                                  return Control_Bind.bind(dictBind)(handleFIDCall(dictBind)(dictMonadEff)(dictMonadAff)(errorBus)(Network_Eth_FriendInDebt_Types.blankPendingFriends)(Network_Eth_FriendInDebt.pendingFriends))(function (v2) {
                                      return Control_Bind.bind(dictBind)(handleFIDCall(dictBind)(dictMonadEff)(dictMonadAff)(errorBus)(Network_Eth_FriendInDebt_Types.blankPendingDebts)(Network_Eth_FriendInDebt.pendingDebts))(function (v3) {
                                          return Control_Monad_State_Class.modify(dictMonadState)(function (v4) {
                                              var $60 = {};
                                              for (var $61 in v4) {
                                                  if ({}.hasOwnProperty.call(v4, $61)) {
                                                      $60[$61] = v4[$61];
                                                  };
                                              };
                                              $60.myId = v;
                                              $60.friends = v1;
                                              $60.pendingFriendsSent = Network_Eth_FriendInDebt_Types.pfGetSents(v2);
                                              $60.pendingFriendsTodo = Network_Eth_FriendInDebt_Types.pfGetTodos(v2);
                                              $60.pendingSent = Network_Eth_FriendInDebt_Types.pdGetSents(v3);
                                              $60.pendingTodo = Network_Eth_FriendInDebt_Types.pdGetTodos(v3);
                                              $60.loading = false;
                                              $60.names = Data_Map.empty;
                                              return $60;
                                          });
                                      });
                                  });
  ...
  var component = (function () {
      var render = function (state) {
          ...
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("page-container col-12") ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("all-friends-container") ])([ Halogen_HTML_Elements.ul([ Halogen_HTML_Properties.class_("col") ])(Data_Functor.map(Data_Functor.functorArray)(function ($133) {
              ...
              return Halogen_HTML_Elements.li([ Halogen_HTML_Properties.class_("row create-debt-card") ])([ inputDebt(state.names)(state.myId)(state.newDebt) ]);
          })([ fakeFriend, fakeFriend ])) ]) ])(Data_Functor.map(Data_Functor.functorArray)(itemizedDebtsForFriendContainer(state.showItemizedDebtFor))(mockFriendNames)));
      };
      ...
      var $$eval = function (v) {
          if (v instanceof ShowItemizedDebtFor) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  $74.showItemizedDebtFor = v.value0;
                  return $74;
              }))(function () {
          ...
          if (v instanceof AddFriend) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(FriendInDebt_Prelude.hLog(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Data_Either.showEither(Data_Show.showString)(Network_Eth_Foundation.showFoundationId))(v.value0))(function () {
                      ...
                      throw new Error("Failed pattern match at Debts line 164, column 7 - line 169, column 20: " + [ v.value0.constructor.name ]);
                  });
              });
          };
          ...
          if (v instanceof InputDebtTarget) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  return v1.newDebt;
              }))(function (v1) {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
          ...
          throw new Error("Failed pattern match at Debts line 153, column 10 - line 205, column 16: " + [ v.constructor.name ]);
      };
  ...
  exports["InputDebtTarget"] = InputDebtTarget;
  exports["InputDebtDesc"] = InputDebtDesc;
