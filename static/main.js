...
(function(exports) {
  ...
  var debtCounterparty = function (myId) {
      return function (v) {
          var $118 = Data_Eq.eq(Network_Eth_Foundation.eqFoundationId)(v.debtor)(myId);
          if ($118) {
              return v.creditor;
          };
          return v.debtor;
  ...
  var debtAmount = function ($134) {
      return numAmount(debtMoney($134));
  };
      ...
      return function (rb) {
          var debtorCreditor = function (myId) {
              return function (cpId) {
                  return function (val) {
                      var $124 = val >= Data_Int.toNumber(0);
                      if ($124) {
  ...
  var conversionFactor = function ($135) {
      return $$Math.pow(10.0)(Data_Int.toNumber(cDecimals($135)));
  };
  var moneyFromDecString = function (val) {
      return function (c) {
...
(function(exports) {
  ...
  var InputDebt = (function () {
      function InputDebt(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      InputDebt.create = function (value0) {
          return function (value1) {
              return new InputDebt(value0, value1);
          };
      };
      return InputDebt;
  })();
  var InputCredit = (function () {
      function InputCredit(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      InputCredit.create = function (value0) {
          return function (value1) {
              return new InputCredit(value0, value1);
          };
      };
      return InputCredit;
  })();
  ...
  var showDebtType = new Data_Show.Show(function (debtType) {
      ...
      throw new Error("Failed pattern match at Debts line 575, column 3 - line 579, column 1: " + [ debtType.constructor.name ]);
  });
                                      ...
                                      return Control_Bind.bind(dictBind)(FriendInDebt_Blockchain.handleCall(dictBind)(dictMonadEff)(dictMonadAff)(errorBus)(Network_Eth_FriendInDebt_Types.blankPendingDebts)(Network_Eth_FriendInDebt.pendingDebts))(function (v3) {
                                          return Control_Bind.bind(dictBind)(FriendInDebt_Blockchain.handleCall(dictBind)(dictMonadEff)(dictMonadAff)(errorBus)([  ])(Network_Eth_FriendInDebt.debtBalances))(function (v4) {
                                              return Control_Monad_State_Class.modify(dictMonadState)(function (v5) {
                                                  var $55 = {};
                                                  for (var $56 in v5) {
                                                      if ({}.hasOwnProperty.call(v5, $56)) {
                                                          $55[$56] = v5[$56];
                                                      };
                                                  };
                                                  $55.myId = v;
                                                  $55.friends = v1;
                                                  $55.pendingFriendsSent = Network_Eth_FriendInDebt_Types.pfGetSents(v2);
                                                  $55.pendingFriendsTodo = Network_Eth_FriendInDebt_Types.pfGetTodos(v2);
                                                  $55.pendingSent = Network_Eth_FriendInDebt_Types.pdGetSents(v3);
                                                  $55.pendingTodo = Network_Eth_FriendInDebt_Types.pdGetTodos(v3);
                                                  $55.balances = v4;
                                                  $55.loading = false;
                                                  return $55;
                                              });
          ...
          return function (myId) {
              return function (friends) {
                  return function (maybeDebt) {
                      var noDecimals = Data_String.takeWhile(function (c) {
                          return c !== ".";
                      });
                      var counterparty = function (debt) {
                          return function (dType) {
                              return function (v) {
                                  ...
                                  throw new Error("Failed pattern match at Debts line 618, column 41 - line 620, column 59: " + [ dType.constructor.name ]);
                              };
                          };
                      };
                      var amount = function (debt) {
                          return function (v) {
                              return function (currency) {
                                  return Network_Eth_FriendInDebt_Types.setDebtMoney(debt)(Network_Eth_FriendInDebt_Types.moneyFromDecString(noDecimals(v))(currency));
                              };
                          };
                      };
                      ...
                      if (v instanceof Data_Maybe.Just) {
                          var handler = (function () {
                              if (debtType instanceof Debt) {
                                  return InputDebt.create;
                              };
                              if (debtType instanceof Credit) {
                                  return InputCredit.create;
                              };
                              throw new Error("Failed pattern match at Debts line 589, column 21 - line 590, column 58: " + [ debtType.constructor.name ]);
                          })();
                          var d = (function () {
                              if (debtType instanceof Debt) {
                              ...
                              throw new Error("Failed pattern match at Debts line 586, column 15 - line 588, column 81: " + [ debtType.constructor.name ]);
                          })();
                          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("create-debt col") ])([ Halogen_HTML_Elements.label([  ])([ Halogen_HTML_Core.text("Enter " + Data_Show.show(showDebtType)(debtType)) ]), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputNumber.value), Halogen_HTML_Properties.class_("debt-amount"), Halogen_HTML_Properties.value(noDecimals(Network_Eth_FriendInDebt_Types.formatMoney(Network_Eth_FriendInDebt_Types.debtMoney(d)))), Halogen_HTML_Events.onValueInput(Halogen_HTML_Events.input(function (val) {
                              return handler(amount(d)(val)(cur));
                          })), Halogen_HTML_Properties.min(Data_Int.toNumber(-1000000 | 0)), Halogen_HTML_Properties.max(Data_Int.toNumber(1000000)) ]), Halogen_HTML_Elements.select([ Halogen_HTML_Events.onValueChange(Halogen_HTML_Events.input(function (v1) {
                              return handler(counterparty(d)(debtType)(v1));
                      ...
                      throw new Error("Failed pattern match at Debts line 583, column 3 - line 614, column 11: " + [ v.constructor.name ]);
                  };
              };
          };
      };
  ...
  var idSpan = function (me) {
      return function (idToDisplay) {
          ...
          throw new Error("Failed pattern match at Debts line 505, column 6 - line 507, column 167: " + [ isItMe.constructor.name ]);
      };
  };
  ...
  var displayItemizedDebtTimeline = function (friendToShow) {
      return function (debtsMap) {
          return function (curFriend) {
              ...
              throw new Error("Failed pattern match at Debts line 273, column 3 - line 283, column 37: " + [ friendToShow.constructor.name ]);
          };
      };
  };
  var displayBalanceLi = function (state) {
      return function (v) {
          var status = (function () {
              var $84 = Data_Eq.eq(Network_Eth_Foundation.eqFoundationId)(v.creditor)(state.myId);
              if ($84) {
          ...
          var curFriend = (function () {
              var $85 = Data_Eq.eq(Network_Eth_Foundation.eqFoundationId)(v.creditor)(state.myId);
              if ($85) {
                  return v.debtor;
              };
              return v.creditor;
          ...
          var expandClass = Data_Functor.map(Data_Maybe.functorMaybe)(function (f) {
              var $86 = Data_Eq.eq(Network_Eth_Foundation.eqFoundationId)(f)(curFriend);
              if ($86) {
      ...
      var $$eval = function (v) {
                  ...
                  if (v.value0 instanceof Data_Maybe.Just) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                              ...
                              $90.loading = true;
                              $90.showItemizedDebtFor = v.value0;
                              return $90;
                          }))(function () {
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(FriendInDebt_Blockchain.handleCall(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(v1.errorBus)([  ])(Network_Eth_FriendInDebt.itemizedDebts(v.value0.value0)))(function (v2) {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                                      ...
                                      $94.loading = false;
                                      $94.itemizedDebts = Data_Map.insert(Network_Eth_Foundation.ordFoundationId)(v.value0.value0)(v2)(v1.itemizedDebts);
                                      return $94;
                                  }))(function () {
                                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                                  });
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(FriendInDebt_Prelude.hLog(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Data_Either.showEither(Data_Show.showString)(Network_Eth_Foundation.showFoundationId))(v.value0))(function () {
                      ...
                      if (v.value0 instanceof Data_Either.Right) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                              ...
                              $114.newFriend = new Data_Either.Left("");
                              return $114;
                          }))(function () {
                      ...
                      throw new Error("Failed pattern match at Debts line 155, column 7 - line 160, column 20: " + [ v.value0.constructor.name ]);
                  });
              });
          };
          if (v instanceof InputFriend) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                  var $120 = Data_String.length(v.value0) > 3;
                  if ($120) {
                      return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                          ...
                          $121.newFriend = Data_Either.Right.create(v.value0);
                          return $121;
                      });
                  };
                  return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                      ...
                      $124.newFriend = new Data_Either.Left(v.value0);
                      return $124;
                  });
              })())(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
          ...
          if (v instanceof InputDebt) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(FriendInDebt_Prelude.hLog(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Network_Eth_FriendInDebt_Types.showDebt)(v.value0))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                      ...
                      $129.newDebt = new Data_Maybe.Just(v.value0);
                      return $129;
                  }))(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                  });
          ...
          if (v instanceof InputCredit) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  $134.newCredit = new Data_Maybe.Just(v.value0);
                  return $134;
              }))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
              });
                  ...
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(FriendInDebt_Blockchain.handleTx(Control_Monad_Aff.monadEffAff)(Control_Monad_Aff_Class.monadAffAff)(NewTX.create)(v1)(Network_Eth_FriendInDebt.newPendingDebt(v.value0)))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                              ...
                              $140.newDebt = Data_Maybe.Nothing.value;
                              $140.newCredit = Data_Maybe.Nothing.value;
                              return $140;
                          }))(function () {
                              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                          });
          ...
          throw new Error("Failed pattern match at Debts line 127, column 10 - line 190, column 16: " + [ v.constructor.name ]);
      };
