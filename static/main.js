...
(function(exports) {
  ...
  var showCurrency = new Data_Show.Show(function (v) {
      ...
      throw new Error("Failed pattern match at Network.Eth.FriendInDebt.Types line 78, column 3 - line 78, column 69: " + [ v.constructor.name ]);
  });
...
(function(exports) {
                                      ...
                                      return Control_Bind.bind(dictBind)(FriendInDebt_Blockchain.handleCall(dictBind)(dictMonadEff)(dictMonadAff)(errorBus)(Network_Eth_FriendInDebt_Types.blankPendingDebts)(Network_Eth_FriendInDebt.pendingDebts))(function (v3) {
                                          return Control_Bind.bind(dictBind)(FriendInDebt_Blockchain.handleCall(dictBind)(dictMonadEff)(dictMonadAff)(errorBus)([  ])(Network_Eth_FriendInDebt.debtBalances))(function (v4) {
                                              return Control_Monad_State_Class.modify(dictMonadState)(function (v5) {
                                                  var $45 = {};
                                                  for (var $46 in v5) {
                                                      if ({}.hasOwnProperty.call(v5, $46)) {
                                                          $45[$46] = v5[$46];
                                                      };
                                                  };
                                                  $45.myId = v;
                                                  $45.friends = v1;
                                                  $45.pendingFriendsSent = Network_Eth_FriendInDebt_Types.pfGetSents(v2);
                                                  $45.pendingFriendsTodo = Network_Eth_FriendInDebt_Types.pfGetTodos(v2);
                                                  $45.pendingSent = Network_Eth_FriendInDebt_Types.pdGetSents(v3);
                                                  $45.pendingTodo = Network_Eth_FriendInDebt_Types.pdGetTodos(v3);
                                                  $45.balances = v4;
                                                  $45.loading = false;
                                                  return $45;
                                              });
                  ...
                  return function (maybeDebt) {
                      ...
                      var counterparty = function (debt) {
                          return function (dType) {
                              return function (v) {
                                  ...
                                  throw new Error("Failed pattern match at Debts line 488, column 41 - line 490, column 59: " + [ dType.constructor.name ]);
                              };
                          };
                      };
                      ...
                      if (v instanceof Data_Maybe.Just) {
                          var handler = (function () {
                              ...
                              throw new Error("Failed pattern match at Debts line 460, column 21 - line 461, column 58: " + [ debtType.constructor.name ]);
                          })();
                          var d = (function () {
                              if (debtType instanceof Debt) {
                              ...
                              throw new Error("Failed pattern match at Debts line 457, column 15 - line 459, column 81: " + [ debtType.constructor.name ]);
                          })();
                      ...
                      throw new Error("Failed pattern match at Debts line 454, column 3 - line 484, column 11: " + [ v.constructor.name ]);
                  };
              };
          };
      };
  ...
  var idSpan = function (me) {
      return function (idToDisplay) {
          ...
          throw new Error("Failed pattern match at Debts line 387, column 6 - line 389, column 125: " + [ isItMe.constructor.name ]);
      };
  };
          ...
          return function (curFriend) {
              if (friendToShow instanceof Data_Maybe.Just) {
                  return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(Halogen_HTML_Core.ClassName("itemized-debts-for-friend")), Halogen_HTML_Properties.attr("style")((function () {
                      var $61 = Data_Eq.eq(Network_Eth_Foundation.eqFoundationId)(curFriend)(friendToShow.value0);
                      if ($61) {
              ...
              throw new Error("Failed pattern match at Debts line 240, column 3 - line 246, column 37: " + [ friendToShow.constructor.name ]);
          };
      };
  };
  ...
  var component = (function () {
      ...
      var $$eval = function (v) {
          if (v instanceof ShowItemizedDebtFor) {
                      ...
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                          ...
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(FriendInDebt_Blockchain.handleCall(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(v1.errorBus)([  ])(Network_Eth_FriendInDebt.itemizedDebts(v.value0.value0)))(function (v2) {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                                  var $73 = {};
                                  for (var $74 in v3) {
                                      if ({}.hasOwnProperty.call(v3, $74)) {
                                          $73[$74] = v3[$74];
                                      };
                                  };
                                  $73.showItemizedDebtFor = v.value0;
                                  $73.loading = false;
                                  $73.itemizedDebts = Data_Map.insert(Network_Eth_Foundation.ordFoundationId)(v.value0.value0)(v2)(v1.itemizedDebts);
                                  return $73;
                              }))(function () {
              ...
              throw new Error("Failed pattern match at Debts line 163, column 7 - line 172, column 20: " + [ v.value0.constructor.name ]);
          };
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(FriendInDebt_Prelude.hLog(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Data_Either.showEither(Data_Show.showString)(Network_Eth_Foundation.showFoundationId))(v.value0))(function () {
                      ...
                      if (v.value0 instanceof Data_Either.Right) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                              ...
                              $87.newFriend = new Data_Either.Left("");
                              return $87;
                          }))(function () {
                      ...
                      throw new Error("Failed pattern match at Debts line 179, column 7 - line 184, column 20: " + [ v.value0.constructor.name ]);
                  });
              });
          };
          if (v instanceof InputFriend) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                  var $93 = Data_String.length(v.value0) > 3;
                  if ($93) {
                      return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                          ...
                          $94.newFriend = Data_Either.Right.create(v.value0);
                          return $94;
                      });
                  };
                  return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                      ...
                      $97.newFriend = new Data_Either.Left(v.value0);
                      return $97;
                  });
              })())(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
          ...
          if (v instanceof InputDebt) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(FriendInDebt_Prelude.hLog(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Network_Eth_FriendInDebt_Types.showDebt)(v.value0))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                      ...
                      $102.newDebt = new Data_Maybe.Just(v.value0);
                      return $102;
                  }))(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                  });
          ...
          if (v instanceof InputCredit) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  $107.newCredit = new Data_Maybe.Just(v.value0);
                  return $107;
              }))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
              });
                  ...
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(FriendInDebt_Blockchain.handleTx(Control_Monad_Aff.monadEffAff)(Control_Monad_Aff_Class.monadAffAff)(NewTX.create)(v1)(Network_Eth_FriendInDebt.newPendingDebt(v.value0)))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                              ...
                              $113.newDebt = Data_Maybe.Nothing.value;
                              $113.newCredit = Data_Maybe.Nothing.value;
                              return $113;
                          }))(function () {
                              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                          });
          ...
          throw new Error("Failed pattern match at Debts line 161, column 10 - line 214, column 16: " + [ v.constructor.name ]);
      };
