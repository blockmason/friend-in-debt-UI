...
(function(exports) {
  ...
  var showDebtType = new Data_Show.Show(function (debtType) {
      ...
      throw new Error("Failed pattern match at Debts line 601, column 3 - line 605, column 1: " + [ debtType.constructor.name ]);
  });
                  ...
                  return function (friends) {
                      return function (maybeDebt) {
                          return function (strAmount) {
                              var whole = function ($175) {
                                  return Network_Eth_FriendInDebt_Types.moneyWhole(Network_Eth_FriendInDebt_Types.debtMoney($175));
                              };
                              var decs = function ($176) {
                                  return Network_Eth_FriendInDebt_Types.moneyDecimals(Network_Eth_FriendInDebt_Types.debtMoney($176));
                              };
                              var counterparty = function (debt) {
                                  return function (dType) {
                                      return function (v1) {
                                          ...
                                          throw new Error("Failed pattern match at Debts line 651, column 41 - line 653, column 59: " + [ dType.constructor.name ]);
                                      };
                                  };
                              };
                              ...
                              if (v1 instanceof Data_Maybe.Just) {
                                  ...
                                  var sendMsg = (function () {
                                      ...
                                      throw new Error("Failed pattern match at Debts line 616, column 22 - line 618, column 11: " + [ debtType.constructor.name ]);
                                  })();
                                  var d = (function () {
                                      if (debtType instanceof Debt) {
                                      ...
                                      throw new Error("Failed pattern match at Debts line 613, column 15 - line 615, column 81: " + [ debtType.constructor.name ]);
                                  })();
                              ...
                              throw new Error("Failed pattern match at Debts line 610, column 3 - line 646, column 11: " + [ v1.constructor.name ]);
                          };
                      };
                  };
              };
  ...
  var idSpan = function (me) {
      return function (idToDisplay) {
          ...
          throw new Error("Failed pattern match at Debts line 531, column 6 - line 533, column 167: " + [ isItMe.constructor.name ]);
      };
  };
  ...
  var displayItemizedDebtTimeline = function (friendToShow) {
      return function (debtsMap) {
          return function (curFriend) {
              ...
              throw new Error("Failed pattern match at Debts line 289, column 3 - line 299, column 37: " + [ friendToShow.constructor.name ]);
          };
      };
  };
  ...
  var component = (function () {
      ...
      var $$eval = function (v) {
                      ...
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(FriendInDebt_Blockchain.handleTx(Control_Monad_Aff.monadEffAff)(Control_Monad_Aff_Class.monadAffAff)(NewTX.create)(v1)(new ScreenChange(FriendInDebt_Routes.BalancesScreen.value))(Network_Eth_FriendInDebt.newPendingDebt(v.value0)))(function () {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                                  ...
                                  $161.newDebt = Data_Maybe.Nothing.value;
                                  $161.newCredit = Data_Maybe.Nothing.value;
                                  return $161;
                              }))(function () {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.raise(new SetLoading(false)))(function () {
                                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
          ...
          throw new Error("Failed pattern match at Debts line 132, column 10 - line 206, column 16: " + [ v.constructor.name ]);
      };
